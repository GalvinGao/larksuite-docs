---
document_id: '7426640831766626310'
directory_id: '7182696786035851270'
title: web-meta
full_path: /uYjL24iN/uMTMuMTMuMTM/web-app-open-ability/web-meta
breadcrumb:
- Developer Guides
- Develop Web Apps
- Open Ability
...
updated_at: 2024-10-21T03:46:57Z
source_url: https://open.larksuite.com/document/uYjL24iN/uMTMuMTMuMTM/web-app-open-ability/web-meta
---

# web-meta

web-meta 是网页的元数据，用于定义网页特性。在Lark中运行的网页支持通过 web-meta 定制网页容器的表现，即使该网页不是一个网页应用。本文主要介绍 web-meta 所包含的属性，以及 web-meta 的两种能力：page-meta 和 view-meta。
...
- 需要在`<head>`中引入 JSSDK，并且 JSSDK 在所有`<meta>`标签之后，其中引入的 JSSDK 最新版本信息可参见[开发网页应用简介](/document/uYjL24iN/uMTMuMTMuMTM/introduction)。
