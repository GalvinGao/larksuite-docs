---
document_id: '7313853215446777862'
directory_id: '7182696786035851270'
title: 配置网页跳转浏览器打开
full_path: /uYjL24iN/uMTMuMTMuMTM/web-app-open-ability/configure-webpage-to-open-in-browser
breadcrumb:
- Developer Guides
- Develop Web Apps
- Open Ability
- Configure webpage to open in browser
document_type: GuideDocumentType
updated_at: 2024-01-09T02:20:36Z
source_url: https://open.larksuite.com/document/uYjL24iN/uMTMuMTMuMTM/web-app-open-ability/configure-webpage-to-open-in-browser
---
...
- 如果网页应用的大部分页面都需要在Lark内新标签页打开（可通过[开发者后台-网页应用-桌面端主页的打开方式=Lark内新标签页打开](/document/uYjL24iN/uMTMuMTMuMTM/development-guide/step1) 进行配置），但是其中某个页面B 必须依赖浏览器的插件才能使用，那么可以通过window.open 或 <a> 打开页面B，并且在页面B的URL中拼接参数`lk_jump_to_browser=true`时，页面B会跳转到浏览器中打开。
