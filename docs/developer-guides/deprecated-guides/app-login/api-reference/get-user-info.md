---
document_id: '7264784369457758213'
directory_id: '7346526017622605830'
title: 获取用户身份信息
full_path: /common-capabilities/sso/api/get-user-info
breadcrumb:
- Developer Guides
- Deprecated Guides
- App Login
...
updated_at: 2025-06-09T09:05:49Z
source_url: https://open.larksuite.com/document/common-capabilities/sso/api/get-user-info
---

# 获取用户信息
:::html
<md-alert type="error">
此版本为历史版本，已不推荐使用，新版请参考 [获取用户信息](/document/uAjLw4CM/ukTMukTMukTM/reference/authen-v1/user_info/get)
</md-alert>
:::

开发者获取 access_token 之后，可以通过 access_token 来调用Lark服务器来获取用户信息。

**请求方法** ：`GET`

**请求地址** ：`https://passport.larksuite.com/suite/passport/oauth/userinfo`
...
```json
{
    ...
    "name": "李雷",
    "picture": "https://www.larksuite.com/avatar",
