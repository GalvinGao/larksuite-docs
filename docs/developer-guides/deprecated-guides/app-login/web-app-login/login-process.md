---
document_id: '7264784369457709061'
directory_id: '7346526017622638598'
title: 登录流程
full_path: /common-capabilities/sso/web-application-sso/web-app-overview
breadcrumb:
- Developer Guides
- Deprecated Guides
- App Login
...
updated_at: 2024-03-18T08:31:10Z
source_url: https://open.larksuite.com/document/common-capabilities/sso/web-application-sso/web-app-overview
---

# 概述
:::html
<md-alert type="error">
此版本为历史版本，已不推荐使用，新版请参考 [登录流程概述](/document/uAjLw4CM/ukTMukTMukTM/reference/authen-v1/login-overview)
</md-alert>
:::
网页应用登录是基于 [OAuth 2.0](https://oauth.net/2/) 标准协议实现的，通过Lark账号授权登录第三方应用的能力。

:::note
**更新**：本接口请求不支持scope参数。用户无法授予应用明确的权限点位，生成的code和user_access_token也没有绑定相关scope，业务想接入更规范和合规的流程，请通过 [新登录流程](/document/uAjLw4CM/ukTMukTMukTM/reference/authen-v1/login-overview) 接入授权流程
:::
...
---
除了跳转至授权页，我们同时支持在应用的页面中嵌入Lark二维码进行扫码登录，详情参考[二维码 SDK 接入文档](/document/common-capabilities/sso/web-application-sso/qr-sdk-documentation)

### 第二步：获取 access_token
[接口文档：获取 access_token](/document/common-capabilities/sso/api/get-access_token)

### 第三步：获取用户身份信息
[接口文档：获取用户身份信息](/document/common-capabilities/sso/api/get-user-info)

### 第四步：刷新已过期的 access_token
[接口文档：刷新已过期的 access_token](/document/common-capabilities/sso/api/refresh-access_token)
