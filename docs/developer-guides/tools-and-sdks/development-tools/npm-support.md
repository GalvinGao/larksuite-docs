---
document_id: '7034327431302791174'
directory_id: '6907567269107613698'
title: npm 支持
full_path: /uYjL24iN/uEzMzUjLxMzM14SMzMTN/npm-support
breadcrumb:
- Developer Guides
- Tools and SDKs
- Development Tools
...
source_url: https://open.larksuite.com/document/uYjL24iN/uEzMzUjLxMzM14SMzMTN/npm-support
---
...
:::html
<div align="center">
  <img src="//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/b7e141c1f8b897b356f8468cc38b96f8_GukjKbhp6B.png" width="400" alt="图片名称" align=center />
</div>
:::
...
```
执行上述指令后，小程序目录下会出现 node_modules 文件夹。小程序源码目录默认是 miniprogramRoot；若开发者对[项目配置](/document/uYjL24iN/uEzMzUjLxMzM14SMzMTN/gadget-project-configuration)进行了修改，则以最终的 miniprogramRoot 字段取值为准。
...
> 你可以参考[自定义组件](/document/uYjL24iN/ugTOugTOugTO)来学习自定义组件相关的内容。
