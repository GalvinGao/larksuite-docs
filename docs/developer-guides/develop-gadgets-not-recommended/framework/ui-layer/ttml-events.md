---
document_id: '6965379541104443397'
directory_id: '6907567266536669185'
title: 事件系统
full_path: /uYjL24iN/uQDOuQDOuQDO
breadcrumb:
- Developer Guides
...
source_url: https://open.larksuite.com/document/uYjL24iN/uQDOuQDOuQDO
---
...
```html
<!-- index.ttml -->
<view id="tapTest" data-hi="Lark" bindtap="tapName"> Click me! </view>
```
...
自定义事件所携带的数据，如表单组件的提交事件会携带用户的输入，详见组件定义中各个事件的定义。<br>
