---
document_id: '7316818497710833669'
directory_id: '7072701762536570885'
title: VChart 图表组件
full_path: /uYjL24iN/uUTM5UjL1ETO14SNxkTN/extension/vcharts-component
breadcrumb:
- Developer Guides
...
updated_at: 2024-01-05T04:45:45Z
source_url: https://open.larksuite.com/document/uYjL24iN/uUTM5UjL1ETO14SNxkTN/extension/vcharts-component
---
...
:::note
- 后续开放平台会逐步停止对 ChartSpace 的维护，但是会继续提供 ChartSpace 的技术支持，如果你有任何 ChartSpace 的问题，可以通过Lark oncall 的方式提问，开放平台技术支持将会尽快回复。
- 针对新的图表需求建议你使用 VChart 进行开发，开放平台针对Lark小程序封装了对应的图表组件库：`@visactor/lark-vchart`，该组件库是开源的，你可以通过 `npm` 的方式安装使用。
:::
...
`@visactor/lark-vchart` 是 VChart 为Lark小程序封装的图表组件库，用于支持Lark小程序上的图表渲染。你可以在Lark小程序内，使用 `npm` 方式引入 `@visactor/lark-vchart`。具体的使用方式可参见 [npm 支持](/document/uYjL24iN/uEzMzUjLxMzM14SMzMTN/npm-support)。
