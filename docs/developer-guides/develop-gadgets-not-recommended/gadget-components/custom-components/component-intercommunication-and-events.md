---
document_id: '6965379543683055622'
directory_id: '6907567266540830722'
title: 组件间通信与事件
full_path: /uYjL24iN/uEDMx4SMwEjLxATM
breadcrumb:
- Developer Guides
- Develop Gadgets (Not Recommended)
- Gadget Components
- Custom Components
- Component Intercommunication and Events
document_type: GuideDocumentType
updated_at: 2022-09-16T10:01:47Z
source_url: https://open.larksuite.com/document/uYjL24iN/uEDMx4SMwEjLxATM
---
...
事件系统是组件间通信的主要方式之一。自定义组件可以触发任意的事件，引用组件的页面可以监听这些事件。关于事件的基本概念和用法，参见 [TTML-事件](/document/uYjL24iN/uQDOuQDOuQDO)。
...
关于冒泡和捕获阶段的概念，请阅读 [TTML-事件](/document/uYjL24iN/uQDOuQDOuQDO) 章节中的相关说明。
