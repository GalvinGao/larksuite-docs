---
document_id: '7520564386793897990'
directory_id: '7520163178001612806'
title: 配置卡片多语言
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/configure-multi-language-content
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T10:04:50Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/configure-multi-language-content
---
...
- 图标（icon）属性中的 img_key 属性
      ...
      <md-dt-td>图片资源的 Key。你可调用[上传图片](uAjLw4CM/ukTMukTMukTM/reference/im-v1/image/create)接口或在Lark卡片搭建工具中上传图片，获取图片的 key。</md-dt-td>
    </md-dt-tr>
  </md-dt-tbody>
</md-dt-table>
