---
document_id: '7395083902676975622'
directory_id: '7393222083608494086'
title: 备注
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/note
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:54:59Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/note
---
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/4ebb52dffa92f1e1815cfd28603052b1_epLOLnCQrG.png?height=175&lazyload=true&maxWidth=500&width=1051)

## 注意事项
[卡片 JSON 2.0 结构](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-structure)不再支持备注（note）组件。你可使用[普通文本](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/content-components/plain-text)组件配置 notation 字号、使用 grey 字体颜色和 icon 属性替代。
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/4ebb52dffa92f1e1815cfd28603052b1_HGJVGGS4ev.png?height=175&lazyload=true&maxWidth=500&width=1051)
```json
{
  "elements": [
    {
