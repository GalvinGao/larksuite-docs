---
document_id: '7395083902676844550'
directory_id: '7393222083608494086'
title: 表格
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/table
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:54:55Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/table
---
...
本文档介绍表格组件的 JSON 1.0 结构，要查看新版 JSON 2.0 结构，参考[表格](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/content-components/table)。



![20240704120326_rec_.gif](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/0b621b9ae52f1106965dcfb022ffcb4b_CPQQAR3e0e.gif?height=392&lazyload=true&maxWidth=434&width=772)

## 注意事项


- 表格组件支持Lark V7.4 及以上版本的客户端。在低于该版本的Lark客户端上，表格的内容将展示为一句“请升级客户端为最新版本后查看内容”的占位图。
...
<md-dt-tr>
  <md-dt-td><md-text type="field-name">text</md-text></md-dt-td>
    <md-dt-td>Lark v7.4 及以上  </md-dt-td>
  <md-dt-td>
...
示例：
```json
"business_domain_name": "Lark卡片"
```
  </md-dt-td>
</md-dt-tr>
<md-dt-tr>
  <md-dt-td><md-text type="field-name">lark_md</md-text></md-dt-td>
    <md-dt-td>Lark v7.10 及以上  </md-dt-td>
  <md-dt-td>
支持部分 markdown 格式的文本。详情参考[普通文本-lark_md 支持的 Markdown 语法](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/plain-text)。
  </md-dt-td>
  <md-dt-td>
结构：
```json
"name":"[文字链接](https://www.larksuite.com)"  // 不填或为空时展示空单元格，非字符串类型转换为字符串展示
```
示例：
```json
"customer_link": "[Lark科技_01](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/emojis-introduce)"
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/7dce9769aa1475bb36bada6533775403_nCnDT2EAmq.png?height=494&lazyload=true&width=1722)
  </md-dt-td>
  <md-dt-td>
结构：
```json
...
<md-dt-tr>
  <md-dt-td><md-text type="field-name">persons</md-text></md-dt-td>
    <md-dt-td>Lark v7.4 及以上  </md-dt-td>
  <md-dt-td>
人员列表。为用户名称+头像样式。支持传入用户 ID 指定人员，用户 ID 类型可以是 user_id、open_id、union_id和 lark_id。了解更多 ID 相关信息，参考[用户身份概述](/document/home/user-identity-introduction/introduction)。
...
<md-dt-tr>
  <md-dt-td><md-text type="field-name">date</md-text></md-dt-td>
    <md-dt-td>Lark v7.6 及以上  </md-dt-td>
  <md-dt-td>
日期时间。需输入 Unix 标准毫秒级时间戳，Lark客户端将按用户本地时区展示日期时间。
...
<md-dt-tr>
  <md-dt-td><md-text type="field-name">markdown</md-text></md-dt-td>
   <md-dt-td>Lark v7.14 及以上  </md-dt-td>
  <md-dt-td>
支持完整 Markdown 语法的文本内容。详情参考[富文本（Markdown）](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/rich-text)组件。
  </md-dt-td>
  <md-dt-td>
结构：<br>
```json
...
![20240704120326_rec_.gif](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/0b621b9ae52f1106965dcfb022ffcb4b_EI5Extg7gI.gif?height=392&lazyload=true&maxWidth=434&width=772)
