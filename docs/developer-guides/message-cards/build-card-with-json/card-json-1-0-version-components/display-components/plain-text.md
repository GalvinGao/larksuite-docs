---
document_id: '7395083902676746246'
directory_id: '7393222083608494086'
title: 普通文本
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/plain-text
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:54:23Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/plain-text
---
...
本文档介绍普通文本组件的 JSON 1.0 结构，要查看新版 JSON 2.0 结构，参考[普通文本](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/content-components/plain-text)。


![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/d44aee0423f960d0aeb0a309769e9cf1_oELkL3Rd0t.png?height=168&lazyload=true&maxWidth=400&width=559)
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/a6b7004b7b1bd27ffd79329ca2c78e4d_Hpe4dWz7hc.png?height=85&lazyload=true&maxWidth=400&width=559)
```json
{
  "i18n_elements": {
    "zh_cn": [
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/24de2acf3d2df6b0d9adfc1b62b199e8_quEsvQKuiE.png?height=400&lazyload=true&maxWidth=400&width=798)
```json
{
  "elements": [
    {
...
| @ 人 | &lt;at id=all&gt;<br>&lt;/at&gt;<br>&lt;at id={{open_id}}&gt;&lt;/at&gt;<br>&lt;at id={{user_id}}&gt;&lt;/at&gt;<br>&lt;at email=test@email.com&gt;&lt;/at&gt;<br>提示：了解如何获取 open_id 或 user_id，参考[如何获取不同的用户 ID](/document/home/user-identity-introduction/open-id)。 | @所有人<br>@test |
| 彩色文本 | &lt;font color=red&gt;红色&lt;/font&gt;<br>**提示**：要查看 color 枚举，参考[颜色枚举值](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/enumerations-for-fields-related-to-color)。 | <span style="color: red;">红色</span> |
| emoji | 😁😢🌞💼🏆❌✅<br>**提示**：直接复制表情即可。了解更多 emoji 表情，参考 [Emoji 表情符号大全](https://www.feishu.cn/docx/doxcnG6utI72jB4eHJF1s5IgVJf)。 | 😁😢🌞💼🏆❌✅ |
| Lark表情 | :OK:<br>**提示**：要查看表情枚举，参考[表情文案说明](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/emojis-introduce)。 | ![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/14a7a076d1d02dc352915bf678f3f785_igT4IyBu6v.png?height=44&lazyload=true&width=54) |
