---
document_id: '7395083758943485957'
directory_id: '7393222083608510470'
title: 折叠面板
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/containers/collapsible-panel
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:54:15Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/containers/collapsible-panel
---
...
本文档介绍折叠面板的 JSON 1.0 结构，要查看新版 JSON 2.0 结构，参考[折叠面板](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/containers/collapsible-panel)。


![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/a8b2044ee3ff261280c034b32b7e9848_kZfxdl7XMn.png?height=1118&lazyload=true&maxWidth=300&width=921)

## 注意事项

- 折叠面板仅支持通过撰写卡片 JSON 代码的方式使用，暂不支持在卡片搭建工具上构建使用。
- 折叠面板支持Lark V7.9 及以上版本的客户端。在低于该版本的Lark客户端上，折叠面板的内容将展示为“请升级至最新版本客户端，以查看内容”的占位图。
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/a8b2044ee3ff261280c034b32b7e9848_PfWtBx6CZX.png?height=1118&lazyload=true&maxWidth=300&width=921)
```json
{
  "header": {
    "template": "yellow",
