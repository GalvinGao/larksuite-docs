---
document_id: '7395083902676729862'
directory_id: '7393222083608526854'
title: 多图选择
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/image-picker
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:55:43Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/image-picker
---
...
本文档介绍多图选择组件的 JSON 1.0 结构，要查看新版 JSON 2.0 结构，参考[多图选择](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/image-picker)。
...
- 多图选择组件支持Lark V7.6 及以上版本的客户端。在低于该版本的Lark客户端上，多图选择的内容将展示为“请升级至最新版本客户端，以查看内容”的占位图。
...
| style | 否 | String | default | 图片加载等状态时的组件风格样式。可取值：<br>- default：默认灰色样式<br>- laser：彩色渐变样式，建议 AI 场景使用![示例图](http:////sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/0ae7b865c1aa37f29d8647f0ea329b38_usdAFosDoT.png?height=163&lazyload=true&width=433) |
