...
图片加载等状态时的组件风格样式。可取值：
- default：默认灰色样式
- laser：彩色渐变样式，建议 AI 场景使用![示例图](http:////sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/0ae7b865c1aa37f29d8647f0ea329b38_usdAFosDoT.png?height=163&lazyload=true&width=433)
</md-td>
</md-tr>
<md-tr>
