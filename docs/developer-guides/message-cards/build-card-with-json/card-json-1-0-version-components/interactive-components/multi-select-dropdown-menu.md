---
document_id: '7395083902676795398'
directory_id: '7393222083608526854'
title: 下拉选择-多选
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/multi-select-dropdown-menu
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:55:19Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/multi-select-dropdown-menu
---
...
本文档介绍下拉选择-多选组件的 JSON 1.0 结构，要查看新版 JSON 2.0 结构，参考[下拉选择-多选](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/multi-select-dropdown-menu)。
...
下拉选择-多选组件支持Lark V7.4 及以上版本的客户端。在低于该版本的Lark客户端上，下拉选择-多选组件的内容将展示为“请升级至最新版客户端以查看操作”。

## 嵌套规则

下拉选择-多选组件仅支持嵌入在表单容器中使用，通过表单容器的“提交”按钮提交选择的内容。了解表单容器及其交互配置，参考[表单容器](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/containers/form-container)。
...
当用户点击表单容器的提交按钮时，你在开发者后台配置的请求地址将会收到如下结构的回调数据。详情参考[表单容器](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/containers/form-container)和[卡片回传交互](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-callback-communication)。
