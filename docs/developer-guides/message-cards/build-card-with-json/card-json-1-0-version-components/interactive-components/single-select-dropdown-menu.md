---
document_id: '7395083758943600645'
directory_id: '7393222083608526854'
title: 下拉选择-单选
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/single-select-dropdown-menu
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:55:15Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/single-select-dropdown-menu
---
...
本文档介绍下拉选择-单选组件的 JSON 1.0 结构，要查看新版 JSON 2.0 结构，参考[下拉选择-单选](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/single-select-dropdown-menu)。
...
- 下拉选择-单选组件最低支持的Lark版本为 V3.7.0。如果低于该版本，用户使用该组件时会提示 **当前版本不支持查看此消息**。
- 在卡片 JSON 代码中，若下拉选择-单选组件直接位于卡片根节点，而非嵌套在其它组件中，你需将其 JSON 数据配置在[交互模块](/document/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/common-components-and-elements)（`"tag": "action"`）的 `actions` 字段中使用。
