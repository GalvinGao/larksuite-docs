---
document_id: '7395083758943420421'
directory_id: '7393222083608526854'
title: 折叠按钮组
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/overflow
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:55:11Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/overflow
---
...
本文档介绍折叠按钮组组件的 JSON 1.0 结构，要查看新版 JSON 2.0 结构，参考[折叠按钮组](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/overflow)。
...
- 在卡片 JSON 代码中，若折叠按钮组组件直接位于卡片根节点，而非嵌套在其它组件中，你需将其 JSON 数据配置在[交互模块](/document/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/common-components-and-elements)（`"tag": "action"`）的 `actions` 字段中使用。
...
```json
{
    ...
    "options": [
        ...
        { // 为按钮添加文本。
            ...
            "multi_url": { // 为按钮添加跳转链接。
                "url": "/ssl:ttdoc/home/index", // 兜底的跳转地址。
                "pc_url": "",
                "ios_url": "",
                "android_url": ""
            },
