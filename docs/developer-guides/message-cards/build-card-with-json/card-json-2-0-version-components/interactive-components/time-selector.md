---
document_id: '7520565507029008396'
directory_id: '7520163178001580038'
title: 时间选择器
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/time-selector
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:53:44Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/time-selector
---
...
:::html
<md-alert type="tip">
本文档介绍时间选择器组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[时间选择器](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/time-selector)。
</md-alert>
:::
