---
document_id: '7520565507028680716'
directory_id: '7520163178001580038'
title: 人员选择-多选
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/multi-select-user-picker
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:53:36Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/multi-select-user-picker
---
...
:::html
<md-alert type="tip">
本文档介绍人员选择-多选组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[人员选择-多选](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/multi-select-user-picker)。
</md-alert>
:::
...
人员选择-多选组件仅支持内嵌在表单容器中使用，通过表单容器的“提交”按钮提交选择的内容。了解表单容器及其交互配置，参考[表单容器](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/containers/form-container)。
...
:::html
<md-alert type="tip">
人员选择-多选组件包含多个选项，因此你需配置自定义回传参数，以区分用户提交的是哪个选项。详情参考[配置卡片交互](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/configuring-card-interactions)。
</md-alert>
:::
