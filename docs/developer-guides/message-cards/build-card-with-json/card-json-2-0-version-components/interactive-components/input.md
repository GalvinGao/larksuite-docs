---
document_id: '7520565507028811788'
directory_id: '7520163178001580038'
title: 输入框
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/input
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:53:12Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/input
---
...
:::html
<md-alert type="tip">
- 本文档介绍输入框组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[输入框](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/input)。

-  要结合使用输入框组件与[按钮](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/button)组件，你需将输入框组件与按钮组件内嵌于[表单容器](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/containers/form-container)中。
</md-alert>
:::
