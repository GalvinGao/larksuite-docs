---
document_id: '7520565167073509382'
directory_id: '7520163178001580038'
title: 人员选择-单选
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/single-select-user-picker
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:53:32Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/single-select-user-picker
---
...
:::html
<md-alert type="tip">
本文档介绍人员选择-单选组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[人员选择-单选](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/single-select-user-picker)。
</md-alert>
:::
...
:::html
<md-alert type="tip">
人员选择-单选组件一般包含多个选项，因此你需配置自定义回传参数，以区分用户提交的是哪个选项。详情参考[配置卡片交互](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/configuring-card-interactions)。
</md-alert>
:::
