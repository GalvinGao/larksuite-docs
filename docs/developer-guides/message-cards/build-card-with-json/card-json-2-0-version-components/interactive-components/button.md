---
document_id: '7520565507029073932'
directory_id: '7520163178001580038'
title: 按钮
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/button
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:53:16Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/button
---
...
:::html
<md-alert type="tip">
本文档介绍按钮组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[按钮](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/button)。
</md-alert>
:::
