---
document_id: '7520565507029106700'
directory_id: '7520163178001678342'
title: 折叠面板
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/containers/collapsible-panel
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:52:29Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/containers/collapsible-panel
---
...
本文档介绍折叠面板组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[折叠面板](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/containers/collapsible-panel)。
...
<strong>注意</strong>：如果你未设置此字段，则折叠面板的标题区域的背景色由 <code>background_color</code> 字段决定。
  ...
  <md-tr>
      ...
      <md-td>fill</md-td>
      <md-td>
标题元素的宽度。JSON 2.0 新增属性。支持Lark客户端 7.32 及以上版本。
- `fill`：标题和折叠面板等宽
- `auto`：标题自适应文本长度
