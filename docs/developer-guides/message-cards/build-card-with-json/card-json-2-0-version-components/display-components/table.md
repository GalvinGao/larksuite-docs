---
document_id: '7520565507028877324'
directory_id: '7520163178001563654'
title: 表格
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/content-components/table
breadcrumb:
- Developer Guides
- Message cards
...
updated_at: 2025-06-27T09:53:08Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/content-components/table
---
...
本文档介绍表格组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[表格](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/table)。
