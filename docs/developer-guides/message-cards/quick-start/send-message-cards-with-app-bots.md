---
document_id: '6967331173081120773'
directory_id: '7073444337254907909'
title: 使用应用机器人发送卡片消息
full_path: /ukTMukTMukTM/uAzMxEjLwMTMx4CMzETM
breadcrumb:
- Developer Guides
- Message cards
- Quick Start
...
updated_at: 2024-07-24T07:25:31Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uAzMxEjLwMTMx4CMzETM
---
...
你可以在 **卡片预览** 区域，点击卡片内容进行修改。关于卡片内容构造的相关说明，参见[消息卡片设计规范](/document/ukTMukTMukTM/ugDOwYjL4gDM24CO4AjN)、[卡片结构介绍](/document/ukTMukTMukTM/uEjNwUjLxYDM14SM2ATN)。
...
:::note
- Lark开放平台提供的 [API 调试台](/document/tools-and-resources/api-explorer-guide) 工具，用于高效测试开放平台接口功能。
...
3. 调用[获取用户或机器人所在的群列表](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat/list)接口。
...
5. 调用[发送消息](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/create)接口，向应用机器人推送消息卡片。
