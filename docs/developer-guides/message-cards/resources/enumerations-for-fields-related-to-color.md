---
document_id: '7395083758943633413'
directory_id: '7520509578237460486'
title: 颜色枚举值
full_path: /uAjLw4CM/ukzMukzMukzM/feishu-cards/enumerations-for-fields-related-to-color
breadcrumb:
- Developer Guides
- Message cards
- Resources
- Enumerations for fields related to color
document_type: GuideDocumentType
updated_at: 2025-06-27T10:05:02Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/enumerations-for-fields-related-to-color
---
...
:::html
<md-alert type="warn">
分栏中的列 `column` 的 `background_style` 属性支持的Lark客户端版本为 7.9 及以上。
</md-alert>
:::

- [富文本组件](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/rich-text)件中的 `font_color` 属性
- [普通文本组件](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/plain-text)中 `lark_md` 的文字颜色
- [普通文本组件](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/plain-text)的 `text_color` 属性
- `icon` 和 `ud_icon` 的 `color` 属性
- [分栏](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/containers/column-set) `column_set`和分栏中的列 `column` 的 `background_style` 属性
- [交互容器](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/containers/interactive-container) `interactive_container` 的 `background_style` 和 `border_color` 属性
- [表格组件](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/table) `table` 的 表头文字颜色
- [折叠面板](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/containers/collapsible-panel)中的 `background_color` 和 `border.color` 属性
