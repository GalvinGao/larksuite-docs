---
document_id: '6967331173081219077'
directory_id: '7394378222823014405'
title: 图片
full_path: /ukTMukTMukTM/uUjNwUjL1YDM14SN2ATN
breadcrumb:
- Developer Guides
- Message cards
- Component
...
updated_at: 2024-07-24T08:04:05Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUjNwUjL1YDM14SN2ATN
---
...
:::note
**图片资源 key** 是指图片的 image_key。你可以调用[上传图片](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/image/create)接口，上传一张用于发送消息的图片，获取返回值中的 image_key。
:::
