---
document_id: '7395110249088761862'
directory_id: '7394378222823030789'
title: 文本 + 列表选择器
full_path: /ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/combinations/text-option-picker
breadcrumb:
- Developer Guides
- Message cards
- Component
...
updated_at: 2024-07-24T08:04:39Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/combinations/text-option-picker
---
...
文本 + 列表选择器组合模块本质是一个内容模块（div），在内容模块中通过 `text` 参数设置文本组件、`extra` 参数设置列表选择器组件。关于内容模块的详细配置说明，可参见[内容模块](/document/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/common-components-and-elements#6bdb3f37)。
...
:::note
支持在 JSON 配置中调整内容模块所附加的列表选择器组件参数，此外列表选择器为交互组件，支持配置回传交互，详细说明可参见[列表选择器（selectMenu）](/document/ukTMukTMukTM/uIzNwUjLycDM14iM3ATN)。
:::
