---
document_id: '6967331173082234885'
directory_id: '7394378222823047173'
title: 日期选择器（datePicker）
full_path: /ukTMukTMukTM/uQzNwUjL0cDM14CN3ATN
breadcrumb:
- Developer Guides
- Message cards
- Component
...
updated_at: 2024-07-24T08:04:22Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uQzNwUjL0cDM14CN3ATN
---
...
- **提示文案**：选择器输入框中的提示文本内容。
- **配置回传交互**：配置回传参数的名称与值，后续当用户选择日期时间后，应用会向指定的消息卡片请求地址发送 HTTP POST 请求，请求中会包含已配置的回传参数数据。关于回传交互的详细配置说明，可参见[配置卡片交互](/document/ukTMukTMukTM/uYjNwUjL2YDM14iN2ATN)。
...
:::note
本章节仅提供日期选择器的交互流程概述。关于卡片交互详情、卡片回调数据参数说明的信息，可参见[配置卡片交互](/document/ukTMukTMukTM/uYjNwUjL2YDM14iN2ATN)。
:::
