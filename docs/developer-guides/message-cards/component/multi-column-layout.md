---
document_id: '7208445654144974854'
directory_id: '7394375283862126597'
title: 多列布局
full_path: /ukTMukTMukTM/ucTNwUjL3UDM14yN1ATN/column-set
breadcrumb:
- Developer Guides
- Message cards
- Component
...
updated_at: 2024-07-24T08:03:48Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/ucTNwUjL3UDM14yN1ATN/column-set
---
...
* 列（column）内目前支持添加的组件或模块包括：[文本](/document/ukTMukTMukTM/uUzNwUjL1cDM14SN3ATN)、[Markdown](/document/ukTMukTMukTM/uADOwUjLwgDM14CM4ATN)、[图片](/document/ukTMukTMukTM/uUjNwUjL1YDM14SN2ATN)、[分割线](/document/ukTMukTMukTM/uQjNwUjL0YDM14CN2ATN)、[备注](/document/ukTMukTMukTM/ucjNwUjL3YDM14yN2ATN)、[双列文本](/document/ukTMukTMukTM/uYzNwUjL2cDM14iN3ATN)、[文本 + 按钮](/document/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/combinations/text-button)、[文本 + 图片](/document/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/combinations/text-image)、[文本 + 列表选择器](/document/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/combinations/text-option-picker)、[文本 + 折叠按钮组](/document/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/combinations/text-overflow-button)、[文本 + 日期选择器](/document/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/combinations/text-date-picker)。
:::
...
- 配置布局样式
	...
	- **绑定循环变量**：可添加循环对象数组变量。关于变量的说明，可参见[配置卡片变量](/document/ukTMukTMukTM/ucTNwUjL3UDM14yN1ATN/configure-card-variables)。
