---
document_id: '7395083902676680710'
directory_id: '7394375283862126597'
title: 通用模块与元素
full_path: /ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/common-components-and-elements
breadcrumb:
- Developer Guides
- Message cards
- Component
- Common modules and elements
document_type: GuideDocumentType
updated_at: 2024-07-24T06:24:03Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/common-components-and-elements
---
...
- [按钮（button）](/document/ukTMukTMukTM/uEzNwUjLxcDM14SM3ATN) 组件的 `multi_url` 字段。
- [Markdown](/document/ukTMukTMukTM/uADOwUjLwgDM14CM4ATN) 组件的 `href` 字段。此外 `lark_md` 类型的[文本组件](/document/ukTMukTMukTM/uUzNwUjL1cDM14SN3ATN)也支持设置 `href` 字段。
