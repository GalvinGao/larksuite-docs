---
document_id: '7270779605446852614'
directory_id: '7270719284443545605'
title: 数据存储
full_path: /uAjLw4CM/uYjL24iN/docs-add-on/04-cloud-doc-block-data-storage/04-cloud-doc-block-data-storage
breadcrumb:
- Developer Guides
- Develop Docs Add-ons
- Cloud doc block data storage
document_type: GuideDocumentType
updated_at: 2023-08-24T06:58:24Z
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/docs-add-on/04-cloud-doc-block-data-storage/04-cloud-doc-block-data-storage
---
...
| 存储服务名称    | 文档数据                                                                                 | 互动数据                                                                                 |
| --------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| 对应 API    | [Record](/document/uAjLw4CM/uYjL24iN/docs-add-on/05-api-doc/basic-data-reference---base/Record.getRecord)               | [Interaction](/document/uAjLw4CM/uYjL24iN/docs-add-on/05-api-doc/basic-data-reference---base/Interaction.getData)          |
| 支持组件类型    | -   正文小组件&其附属视图 - [详见](/document/uAjLw4CM/uYjL24iN/docs-add-on/02-cloud-doc-block-noun-explanation) | -   正文小组件&其附属视图 - [详见](/document/uAjLw4CM/uYjL24iN/docs-add-on/02-cloud-doc-block-noun-explanation) |
| 数据体积      | 500KB                                                                                | 500KB                                                                                |
| 协同能力      | 支持                                                                                   | 支持                                                                                   |
| 冲突解决能力    | 支持                                                                                   | 支持                                                                                   |
