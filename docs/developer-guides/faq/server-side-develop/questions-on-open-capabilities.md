---
document_id: '7069302182251937797'
directory_id: '7069296428547686405'
title: 开放能力相关
full_path: /ugTN1YjL4UTN24CO1UjN/ugzN1YjL4cTN24CO3UjN
breadcrumb:
- Developer Guides
- FAQ
- Server-side develop
- Questions on open capabilities
document_type: GuideDocumentType
updated_at: 2022-03-04T11:13:33Z
source_url: https://open.larksuite.com/document/ugTN1YjL4UTN24CO1UjN/ugzN1YjL4cTN24CO3UjN
---
...
答：可以参考[获取单个审批实例详情](/document/ukTMukTMukTM/uEDNyUjLxQjM14SM0ITN)文档，根据返回的==task_list==获取审批节点的审批人信息。但由于未处理节点的任务还未被创建，无法获取未处理节点相关信息。
<br>
<br>
...
获取到正确的服务器出口IP后，可以参考[这篇文档](/document/ukTMukTMukTM/ucTMxYjL3ETM24yNxEjN)，修改你应用的IP白名单设置。
