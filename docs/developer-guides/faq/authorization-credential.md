---
document_id: '7069302182251986949'
directory_id: '7069296428547670021'
title: 授权凭证
full_path: /ugTN1YjL4UTN24CO1UjN/uEjN1YjLxYTN24SM2UjN
breadcrumb:
- Developer Guides
- FAQ
- Authorization credential
document_type: GuideDocumentType
updated_at: 2022-03-24T06:20:24Z
source_url: https://open.larksuite.com/document/ugTN1YjL4UTN24CO1UjN/uEjN1YjLxYTN24SM2UjN
---
...
**4. 如何更新 token？**
 ...
 答：
 1. ==app_access_token==和==tenant_access_token==需要重新获取，获取方式参见开放平台[相关文档](/document/ukTMukTMukTM/uMTNz4yM1MjLzUzM)。
 2. ==user_access_token==根据不同的登录方式，更新方式不同：
    - 通过网页扫码登录，使用[获取登录用户身份](/document/uAjLw4CM/ukTMukTMukTM/reference/authen-v1/authen/access_token)接口进行更新。
    - 通过小程序登录，需要在小程序内调用 [tt.login](/document/uYjL24iN/uYzMuYzMuYzM) 接口获取==code==，再调用[code2session](/document/uYjL24iN/ukjM04SOyQjL5IDN) 接口获取 ==access_token==。
