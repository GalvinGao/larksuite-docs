---
document_id: '7069302182251905029'
directory_id: '7069296428547670021'
title: 事件订阅
full_path: /ugTN1YjL4UTN24CO1UjN/ukzN1YjL5cTN24SO3UjN
breadcrumb:
- Developer Guides
- FAQ
- Event subscriptions
document_type: GuideDocumentType
updated_at: 2024-02-21T07:00:20Z
source_url: https://open.larksuite.com/document/ugTN1YjL4UTN24CO1UjN/ukzN1YjL5cTN24SO3UjN
---
...
答：会的。如果要只接收一种协议，建议把老的事件勾选去掉。这里要注意，老版本的事件用的是V1.0的schema，新版本事件用的是V2.0的schema，在返回处理时，需要区分两个版本，可参考：[事件数据格式](/document/ukTMukTMukTM/uUTNz4SN1MjL1UzM#8f960a4b)。
<br>
<br>
**7. 为什么我的请求超时了？**
...
答：可能是重推机制导致的。请参考[订阅事件概述](/document/ukTMukTMukTM/uUTNz4SN1MjL1UzM)，使用事件的==uuid==进行进行去重。
<br>
<br>
