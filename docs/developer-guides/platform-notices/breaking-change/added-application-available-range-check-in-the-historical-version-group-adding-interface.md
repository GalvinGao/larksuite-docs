---
document_id: '7428070294324068358'
directory_id: '7077912803110010885'
title: 历史版本拉用户进群接口增加应用可用范围校验
full_path: /uAjLw4CM/ugTN1YjL4UTN24CO1UjN/breaking-change/added-application-available-range-check-in-invitations
breadcrumb:
- Developer Guides
- Platform Notices
- Breaking change
- Added application available range check in the historical version group adding interface
document_type: GuideDocumentType
updated_at: 2024-10-24T06:45:29Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/breaking-change/added-application-available-range-check-in-invitations
---
...
- v4版本：`/open-apis/chat/v4/chatter/add`
...
### 解决方案
可在开发者后台中，将校验不通过的用户加入到**可用范围**中，以使其通过校验。配置方式请参考：[配置应用可用范围](/document/home/introduction-to-scope-and-authorization/availability)。
