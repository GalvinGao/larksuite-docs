---
document_id: '7347618113929691141'
directory_id: '7077912803110010885'
title: 通讯录成员与部门 OpenAPI 的不兼容变更
full_path: /uAjLw4CM/ugTN1YjL4UTN24CO1UjN/breaking-change/update-for-contact-members-and-departments
breadcrumb:
- Developer Guides
- Platform Notices
- Breaking change
- OpenAPI calling method update for Contact members and departments
document_type: GuideDocumentType
updated_at: 2024-03-19T07:02:55Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/breaking-change/update-for-contact-members-and-departments
---
...
你可通过 HTTP 请求地址判断。例如，通讯录 OpenAPI [创建用户](/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/create) 的 HTTP 请求地址为 `https://open.larksuite.com/open-apis/contact/v3/users`，其中的 v3 即标识 v3 版本。
</md-alert>
:::
