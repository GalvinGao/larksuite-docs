---
document_id: '7180269945547374597'
directory_id: '7179507279661989894'
title: Creator
full_path: /uAjLw4CM/uYjL24iN/block/block-frame/framework-interface/creator
breadcrumb:
- Developer Guides
...
updated_at: 2022-12-27T10:18:45Z
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/block-frame/framework-interface/creator
---
...
渲染层可以通过[TTML](/document/uAjLw4CM/uYjL24iN/block/block-frame/view-layer/ttml/data-binding)对数据进行绑定。示例代码如下：
...
| 参数                | 类型     | 说明                                                                                                                        |
| ----------------- | ------ | ------------------------------------------------------------------------------------------------------------------------- |
| host              | string | 宿主环境，Lark文档返回 docs_block                                                                                                    |
