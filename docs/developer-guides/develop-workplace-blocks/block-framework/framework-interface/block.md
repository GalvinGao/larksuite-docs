---
document_id: '7180270043522809862'
directory_id: '7179507279661989894'
title: Block
full_path: /uAjLw4CM/uYjL24iN/block/block-frame/framework-interface/block
breadcrumb:
- Developer Guides
...
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/block-frame/framework-interface/block
---
...
渲染层可以通过[TTML]([数据绑定](/document/uAjLw4CM/uYjL24iN/block/block-frame/view-layer/ttml/data-binding))对数据进行绑定。示例代码如下：
...
| 属性                   | 类型     | 说明                                                    |
| -------------------- | ------ | ----------------------------------------------------- |
| host                 | string | 宿主环境，飞比如书文档返回 docs_block                              |
