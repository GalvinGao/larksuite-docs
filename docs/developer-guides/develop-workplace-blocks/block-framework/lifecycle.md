---
document_id: '7180269945544245254'
directory_id: '7179507279661907974'
title: 生命周期
full_path: /uAjLw4CM/uYjL24iN/block/block-frame/logic-layer/lifecycle/lifecycle
breadcrumb:
- Developer Guides
...
updated_at: 2022-12-27T10:18:32Z
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/block-frame/logic-layer/lifecycle/lifecycle
---
...
目前支持的生命周期钩子如下表所示。
:::note
[Creator](/document/uAjLw4CM/uYjL24iN/block/guide/directory-structure) 和 Block 的生命周期有一定差异，具体请看下面表格中**支持类型**列的说明。
:::
...
- 仅 Block 支持激活、失活生命周期钩子，Creator 不会触发激活和失活。
:::
