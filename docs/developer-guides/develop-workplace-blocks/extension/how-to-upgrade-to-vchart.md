---
document_id: '7316818497710850053'
directory_id: '7180165099250827269'
title: 如何升级 VChart
full_path: /uAjLw4CM/uYjL24iN/block/component/extend/how-to-upgrade-to-vchart
breadcrumb:
- Developer Guides
- Develop Workplace Blocks
- Extension
- How to upgrade to VChart
document_type: GuideDocumentType
updated_at: 2024-01-05T04:45:41Z
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/component/extend/how-to-upgrade-to-vchart
---
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/567ff9b938a7be0efede8e290f787b64_satun1SYs8.png?height=570&lazyload=true&width=656)  
引入之后，我们可以将 `index.json` 文件中对于内置 ChartSpace 的引用声明删除（务必记得，防止包体积过大）。  

![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/81841ef8f06aef5189ad5f1e3a3a1445_kvyO8LEHdJ.png?height=398&lazyload=true&width=668)
...
<view class="vchart">
    ...
    <!-- 注意 canvas 顺序 -->
    <!-- line_hit_canvas 用于内部创建额外的 canvas 上下文 -->
    <canvas
      id="line_hit_canvas"
    ...
    >
     ...
     <!-- line_tooltip_canvas 用于绘制 tooltip -->
    <canvas
...
至此我们的修改基本已经完成了，你可以在Lark开发者工具上看到你的图表全部替换成了 VChart 渲染的图表，但是你会发现有一些样式的变化，这是因为 VChart 对图表配置属性做了一些命名和结构上的修改，你可以参照如下的修改列表进行配置上的调整。
...
至此，升级工作就全部结束了，如果有问题，可通过Lark oncall 技术支持寻求帮助。
  
以下是我们提供的 ChartSpace 示例按照以上步骤升级到 VChart 的 demo 示例。  

[block-vhart-demo](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/0a7a9a032c1c209dcef0db3d21d21b36_9E0Xme8MBm.zip)
...
[block-vhart-demo](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/976ea818fddd301cc6b6258012104cbf_SSeNeCOcpX.zip)
