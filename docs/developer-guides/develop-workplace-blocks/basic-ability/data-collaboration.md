---
document_id: '7180270043523039238'
directory_id: '7180165099250876421'
title: 数据协同
full_path: /uAjLw4CM/uYjL24iN/block/service/collaborative
breadcrumb:
- Developer Guides
...
updated_at: 2022-12-27T10:18:57Z
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/service/collaborative
---
...
![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/a13d71d56421c9ce569b867f4814f3a6_C5tC71ek9L.png?lazyload=true&width=1640&height=576)

:::note

开发者服务端需要映射业务 id 与 blockID 关系，因为变更推送是以 blockID 为主键。
具体绑定方式为：在[服务端创建流程](/document/uAjLw4CM/uYjL24iN/block/service/create)中，开发者服务端将业务数据发送至开放平台，开放平台返回 blockID，从而开发者服务端可以将业务 id 与 blockID 实现绑定。
:::
...
示例代码如下。详细代码可以参考[Block](/document/uAjLw4CM/uYjL24iN/block/block-frame/framework-interface/block)。
...
具体调用接口请参考[更新 BlockEntity](/document/uAjLw4CM/ukTMukTMukTM/block-v2/entity/update)。
...
![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/24cd58e9a0b1c660421c4961154ab0fa_4aDNofxC4E.png?lazyload=true&width=1640&height=662)
:::note
...
具体调用接口[Block消息推送](/document/uAjLw4CM/ukTMukTMukTM/block-v2/message/create)。
