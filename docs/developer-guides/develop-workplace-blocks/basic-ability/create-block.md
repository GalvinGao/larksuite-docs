---
document_id: '7180270043522383878'
directory_id: '7180165099250876421'
title: 创建 Block
full_path: /uAjLw4CM/uYjL24iN/block/service/create
breadcrumb:
- Developer Guides
...
updated_at: 2022-12-27T10:18:51Z
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/service/create
---

# 创建 Block
## 基本概念
- BlockEntity：一串标准的数据结构。包括 BlockID、SourceMeta、SourceData 等信息。存储在开放平台服务端上。Block 需要使用 BlockEntity 数据实现渲染。
- [Creator](/document/uAjLw4CM/uYjL24iN/block/block-frame/logic-layer/register-creator)  ：结构类似 Block，用于创建 BlockEntity。
- 宿主：渲染 Block 的容器。
...
![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/0f7fa230819177f6a2b1088a989c75f9_7fi1gavMX4.png?lazyload=true&width=1640&height=830)
...
![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/5a3532d19e16db8a1db43ce6cfbc1b20_o8BOq8DFJh.png?lazyload=true&width=1640&height=696)
...
开发者前端（creator）收集到足够的信息之后，调用开发者服务端的创建接口，开发者服务服务端调用平台所提供的 [创建 BlockEntity](/document/uAjLw4CM/ukTMukTMukTM/block-v2/entity/create) 完成 Block 实例的创建。
...
![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/77a5e9b14c8717c7fe74932f07013cf8_auVkPcrtPs.png?lazyload=true&width=1640&height=680)
#### 示例代码
...
具体参考[服务端创建接口](/document/uAjLw4CM/ukTMukTMukTM/block-v2/entity/create)。
