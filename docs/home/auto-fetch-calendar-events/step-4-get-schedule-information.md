---
document_id: '7156039415051026437'
directory_id: '7083440791243243525'
title: 步骤四：获取日程信息
full_path: /home/calendar-event-sync/event-sync
breadcrumb:
- Home
- Auto-fetch Calendar Events
- 'Step 4: Get schedule information'
document_type: GuideDocumentType
updated_at: 2024-12-10T11:29:18Z
source_url: https://open.larksuite.com/document/home/calendar-event-sync/event-sync
---

# 步骤四：获取日程信息

在本步骤中，你将使用[步骤二](/document/home/calendar-event-sync/subscribe-to-events)中获取到的 user_access_token 和 calendar_id，获取日程信息。

## 获取存量日程信息

使用[获取日程列表](/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event/list)接口获取存量日程。
...
1. 通过Lark客户端，或者调用[创建日程](/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event/create)接口，在当前登录用户的主日历中增加一个日程。
...
3. 使用[获取日程列表](/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event/list)接口，获取增量日程数据。
