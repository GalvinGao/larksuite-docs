---
document_id: '7295682588634939397'
directory_id: '7294197569669185541'
title: 简介
full_path: /home/quickly-build-a-feishu-calendar-schedule/introduction
breadcrumb:
- Home
- Quickly Build Calendar Events
- Introduction
document_type: GuideDocumentType
updated_at: 2023-10-31T08:32:36Z
source_url: https://open.larksuite.com/document/home/quickly-build-a-feishu-calendar-schedule/introduction
---
...
基于上述问题，Lark日历可以帮助你构建企业的统一日程入口。你可以通过日历服务以及开放能力（OpenAPI）将企业三方系统的日程数据同步到Lark日历中。成员通过Lark日历日程清晰洞察工作安排，同时，成员之间根据彼此的日程排期，可以更好的组织会议、协同办公。

## 基本概念

Lark日历和日程为包含关系，你可以自行创建一个或多个日历匹配企业的多个系统，在每个日历中均可添加指定日程进行工作安排。在阅读本教程前，建议你先了解有关Lark的日历类型、日程公开范围的相关概念。
...
本教程通过 [API 调试台工具](/document/tools-and-resources/api-explorer-guide) 介绍如何使用日历服务的开放 API 在Lark内构建日历日程，调用流程如下。在实际使用过程中，你可以结合企业内三方系统的日程安排，构建匹配的Lark日历日程。例如，为招聘系统创建一个招聘日历，并根据系统内已有的日程数据，构建相匹配的Lark日程。

:::html
<!-- 原图：
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/c3a1e09b8367589de128cefc2a3522ec_TMMqkKBZMC.png?height=664&lazyload=true&maxWidth=750&width=1013) -->
:::


![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/31e87fea951a0dd7523b74a15bfcc936_igiB3l4e78.png?height=555&lazyload=true&maxWidth=750&width=1013)

:::note
Outlook 以及 Google 日历同步功能可直接在Lark日历中配置，详见[Outlook 日历同步](https://www.larksuite.com/hc/zh-CN/articles/958114534113)及[Google 日历同步](https://www.larksuite.com/hc/zh-CN/articles/442685222383)。
:::
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/84bf087c79a8e820c3218b1e8e99b078_VMVpaOiXW4.png?lazyload=true&width=1874&height=1216)
