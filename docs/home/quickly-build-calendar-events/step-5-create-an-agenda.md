---
document_id: '7295682588634890245'
directory_id: '7294197569669185541'
title: 步骤五：创建日程
full_path: /home/quickly-build-a-feishu-calendar-schedule/step-5-create-an-agenda
breadcrumb:
- Home
- Quickly Build Calendar Events
- 'Step 5: Create an Agenda'
document_type: GuideDocumentType
updated_at: 2023-10-31T08:32:55Z
source_url: https://open.larksuite.com/document/home/quickly-build-a-feishu-calendar-schedule/step-5-create-an-agenda
---

# 步骤五：创建日程

在确认指定时间段内用户或者会议室空闲后，即可调用[创建日程](/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event/create)接口，在日历内创建日程。
...
2. 在左侧 **API 列表** 中，选择 **日历** > **日程管理** > **创建日程**。
    ...
    ![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/efbdbebc67be92c94d7a986d2dd6955f_uO6nNCzS9m.png?height=1364&lazyload=true&maxWidth=600&width=2882)
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/c0e6a0f64a4712acf77b89b1d958c32c_scIG0Lx2b2.png?height=1078&lazyload=true&maxWidth=600&width=2242)
