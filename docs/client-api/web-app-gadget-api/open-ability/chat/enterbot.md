...
| --- | --- | --- | --- | --- |
| 小程序 | <md-version>V2.7.0+</md-version> | <md-version>V2.7.0+</md-version> | <md-version>V2.7.0+</md-version> | <md-preview-app type="gadget" disable="true" fontSize="14">预览</md-preview-app> |
| 网页应用 | **X** | **X** | **X** | / |
