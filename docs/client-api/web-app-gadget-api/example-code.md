---
document_id: '6967240092650307590'
directory_id: '6907567266540847106'
title: 示例代码
full_path: /uYjL24iN/uYDM04iNwQjL2ADN
breadcrumb:
- Client API
- Web app/Gadget API
- Example Code
document_type: GuideDocumentType
updated_at: 2024-05-06T09:55:34Z
source_url: https://open.larksuite.com/document/uYjL24iN/uYDM04iNwQjL2ADN
---
...
| 名称 |代码包下载 |使用说明
| - | - | - |- |
| 小程序（API与组件）|[microapp-demo.zip](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/c73e19d3c910e185c0b76831e8773004_PP9jXkOARb.zip)| [使用说明](/document/uYjL24iN/uYDM04iNwQjL2ADN)
| 网页应用（API） | [h5-sdk-demo.zip](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/93323479bf225067f9c709511af36651_rZ8ypRWcmS.zip)| [使用说明](/document/uYjL24iN/uYDM04iNwQjL2ADN#1757f090)

## 小程序示例代码包 使用说明
1. 点击小程序-“代码包下载”，下载压缩包，并解压文件
2. 下载[Lark开发者工具](/document/uYjL24iN/ucDOzYjL3gzM24yN4MjN)并完成安装；
...
6. 创建Lark应用，参见 [快速开发小程序](/document/home/develop-a-gadget-in-5-minutes/create-a-custom-app) 中的“创建应用”步骤
...
9. 如需快速了解小程序示例代码包中文件的含义、结构，如何调用小程序的组件和API、如何调试与发布小程序，推荐查看入门教程 [快速开发小程序](/document/home/develop-a-gadget-in-5-minutes/create-a-custom-app)

## 网页应用示例代码包 使用说明
1. 点击网页应用-“代码包下载”，下载压缩包，并解压文件
2. 暂不支持在[Lark开发者工具](/document/uYjL24iN/ucDOzYjL3gzM24yN4MjN)中导入网页应用项目，因此需要将文件导入任一的编译器内查看。
3. 使用[Lark开发者工具](/document/uYjL24iN/ucDOzYjL3gzM24yN4MjN)编写你的网页应用。如需快速了解如何开发网页应用，推荐查看入门教程 [快速集成网页应用](/document/home/integrating-web-apps-in-5-minutes/create-app-and-configuration)
