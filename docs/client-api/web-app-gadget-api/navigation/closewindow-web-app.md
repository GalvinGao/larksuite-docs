...
| --- | --- | --- | --- | --- |
| 小程序 | **X** | **X** | **X** | / |
| 网页应用 | <md-version>V5.14.0+</md-version> | <md-version>V5.14.0+</md-version> | <md-version>V5.14.0+</md-version> | <md-preview-app type="webApp" disable="true" fontSize="14">预览</md-preview-app> |
