...
| 名称 | 数据类型 | 描述 |
| --- | --- | --- |
| data | string｜arraybuffer | 服务器返回的消息<br><md-alert type="tip" icon="none"><br>iOS 端：Lark[V5.2.0](/document/uYjL24iN/uAjMuAjMuAjM/version-compatibility)及以上版本支持arraybuffer<br></md-alert> |
