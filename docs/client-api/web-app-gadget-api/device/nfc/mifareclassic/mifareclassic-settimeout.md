---
document_id: '6971043590354124805'
directory_id: '6907567266540470274'
title: MifareClassic.setTimeout
full_path: /uYjL24iN/uYTN4YjL2UDO24iN1gjN
breadcrumb:
- Client API
- Web app/Gadget API
- Device
...
updated_at: 2024-03-07T08:42:16Z
source_url: https://open.larksuite.com/document/uYjL24iN/uYTN4YjL2UDO24iN1gjN
---
      ...
      (res) => {
           ...
           nfc.setTimeout({
              'timeout': 1000,
               ...
               fail(err) {
               	console.log(`MifareClassic.setTimeout fail: ${JSON.stringify(res)}`)
               }
           });
      }
);
