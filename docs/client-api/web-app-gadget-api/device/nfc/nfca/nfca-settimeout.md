---
document_id: '6971043590354108421'
directory_id: '6907567266536505345'
title: NfcA.setTimeout
full_path: /uYjL24iN/uETN4YjLxUDO24SM1gjN
breadcrumb:
- Client API
- Web app/Gadget API
- Device
...
updated_at: 2024-03-07T08:41:37Z
source_url: https://open.larksuite.com/document/uYjL24iN/uETN4YjLxUDO24SM1gjN
---
      ...
      (res) => {
           ...
           nfcA.setTimeout({
              'timeout': 1000,
               ...
               fail(err) {
               	console.log(`NfcA.setTimeout fail: ${JSON.stringify(res)}`)
               }
           });
      }
);
