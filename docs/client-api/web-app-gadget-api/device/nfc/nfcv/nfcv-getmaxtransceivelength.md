---
document_id: '7143913324618055685'
directory_id: '7124599404677513222'
title: NfcV.getMaxTransceiveLength
full_path: /uYjL24iN/uQzM4YjL0MDO24CNzgjN/NfcV/getmaxtransceivelength
breadcrumb:
- Client API
- Web app/Gadget API
- Device
...
updated_at: 2024-03-07T08:41:52Z
source_url: https://open.larksuite.com/document/uYjL24iN/uQzM4YjL0MDO24CNzgjN/NfcV/getmaxtransceivelength
---
...
adapter.onDiscovered(
      (res) => {
           ...
           nfcV.getMaxTransceiveLength({
               ...
               fail(err) {
               	console.log(`NfcV.getMaxTransceiveLength fail: ${JSON.stringify(res)}`)
               }
           });
      }
);
