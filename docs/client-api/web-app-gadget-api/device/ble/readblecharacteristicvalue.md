---
document_id: '7330180313525747718'
directory_id: '6907567266537799681'
title: readBLECharacteristicValue
full_path: /uYjL24iN/uYTOxYjL2kTM24iN5EjN
breadcrumb:
- Client API
- Web app/Gadget API
- Device
...
updated_at: 2024-01-31T08:44:07Z
source_url: https://open.larksuite.com/document/uYjL24iN/uYTOxYjL2kTM24iN5EjN
---
...
- 如果读取超时，错误码 10015，tt.onBLECharacteristicValueChange 接口之后可能返回数据，需要接入方酌情处理。</md-alert>
:::
...
| &emsp;<br><span style="color: #8F959E"><br>∟<br></span><br>&nbsp;<br><md-text type="field-name"><br>value<br></md-text> | hex string | 蓝牙设备特征值的value |
