...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>**✓**</md-td>
      <md-td>**✓**</md-td>
      <md-td> <md-preview-app type="gadget" appId="cli_9dff7f6ae02ad104" path="page/API/pages/set-navigation-bar-title/set-navigation-bar-title" fontSize="14">预览</md-preview-app>
</md-td>
</md-tr>
