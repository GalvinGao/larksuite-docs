---
document_id: '7270779700748976133'
directory_id: '7270719284443660293'
title: BlockType
full_path: /uAjLw4CM/uYjL24iN/docs-add-on/05-api-doc/basic-data-reference---base/BlockType
breadcrumb:
- Client API
- Docs Add-ons
- Data Structure
...
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/docs-add-on/05-api-doc/basic-data-reference---base/BlockType
---
...
| TEXT            | text            | **已支持**    | 文本                                                                                                                              |
| VIEW            | view            | **不支持**    | 视图，该 Block 可以作为文本内联对象，见[InlineBlock](/document/uAjLw4CM/uYjL24iN/docs-add-on/05-api-doc/basic-data-reference---base/InlineBlock)
