---
document_id: '6965379541104902149'
directory_id: '6907567266541862914'
title: image
full_path: /uYjL24iN/uUzNuUzNuUzN
breadcrumb:
- Client API
...
source_url: https://open.larksuite.com/document/uYjL24iN/uUzNuUzNuUzN
---
...
|lazy-load|Boolean|false|图片懒加载。只针对 page 与 scroll-view 下的 img 有效|
...
<md-code page="page/component/pages/image/image">
