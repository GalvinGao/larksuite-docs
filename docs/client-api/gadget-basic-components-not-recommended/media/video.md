---
document_id: '6965379541105033221'
directory_id: '6907567266541862914'
title: video
full_path: /uYjL24iN/uYzNuYzNuYzN
breadcrumb:
- Client API
...
updated_at: 2023-05-22T07:36:11Z
source_url: https://open.larksuite.com/document/uYjL24iN/uYzNuYzNuYzN
---
...
|autoplay|Boolean|false|否|是|是否自动播放。Lark PC 端 3.41 版本开始自动播放需要设置 muted 属性为 true 才生效|
...
|direction|Number||否|是|设置全屏时视频的方向，不指定则根据视频源宽高比自动判断|移动端 6.1|
...
:::html
<md-alert>
**为了更好地遵从 Chrome 安全隐私策略，Lark PC 端内核已在 3.41 实现升级，video 组件 autoplay 属性必须与 muted = true 一起使用才生效。**
</md-alert>
<md-alert>
...
<md-code page="page/component/pages/video/video">
