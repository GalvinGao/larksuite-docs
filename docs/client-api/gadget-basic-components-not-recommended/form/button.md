---
document_id: '6965379541105016837'
directory_id: '6907567266536931329'
title: button
full_path: /uYjL24iN/uIjNuIjNuIjN
breadcrumb:
- Client API
...
updated_at: 2022-06-21T08:33:22Z
source_url: https://open.larksuite.com/document/uYjL24iN/uIjNuIjNuIjN
---
...
|值|说明|
|--|---|
|share|触发用户转发, 分享内容到Lark。**移动端2.9版本，PC端3.11版本开始支持**|
...
<md-code page="page/component/pages/button/button">
...
目前，`<button>` 组件的边框不是通过 border 属性来控制的，而是有个 `:after` 伪类，所以如果需要修改边框样式，请对改伪类元素设置样式。
...
```
<br>
![图片名称](https://sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/ark/8789f644354f464d469b9789abaac4b8.png?lazyload=true&width=1880&height=1036)
<br>
