---
document_id: '6965379543683727366'
directory_id: '6907567266536931329'
title: customized-input
full_path: /uYjL24iN/uETM4UjLxEDO14SMxgTN
breadcrumb:
- Client API
...
source_url: https://open.larksuite.com/document/uYjL24iN/uETM4UjLxEDO14SMxgTN
---
...
|reminderSuggestions|Array<reminderSuggestion>||输入@时所展示的自定义推荐reminder的信息列表。Lark4.0 版本支持。
