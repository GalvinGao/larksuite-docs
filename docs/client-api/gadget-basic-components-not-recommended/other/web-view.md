---
document_id: '6965379543684038662'
directory_id: '6907567269107335170'
title: web-view
full_path: /uYjL24iN/ukzNukzNukzN
breadcrumb:
- Client API
...
source_url: https://open.larksuite.com/document/uYjL24iN/ukzNukzNukzN
---
...
:::note
注意事项：
- web-view可信域名配置与校验已于2021年11月30日上线，V5.1.0 以上Lark客户端将支持该功能。开发者可以在开发者后台完成配置，详见下文「可信域名配置」。
- **不建议** 在web-view中打开Lark云文档，为保障更好的打开体验，建议使用 [openDocument](/document/uYjL24iN/ukTN24SO1YjL5UjN) 或 [openSchema](/document/uYjL24iN/ukzN4IjL5cDOy4SO3gjM) 打开云文档。
:::

|属性名|类型|默认值|说明|
|-----|---|-----|---|
|src|String|N/A|webview 指向网页的链接。需登录[开发者后台](https://open.larksuite.com/app)，进行小程序web-view可信域名配置。|
...
<md-code page="page/component/pages/web-view/web-view">
...
:::note 
* web-view 组件的 sdk 与[网页应用 JSSDK](/document/uYjL24iN/uITO4IjLykDOy4iM5gjM)不同，请注意不要误用。
* PC 端暂不支持以上 API。
:::
...
支持版本 5.1+
:::
1. 打开[开发者后台](https://open.larksuite.com/app) > 应用详情 > 安全设置，在“Web-view 可信域名”模块中填写符合规范的链接；
2. 在[开发者后台](https://open.larksuite.com/app)  > 应用详情 > 版本管理与发布，完成小程序的版本发布；
3. 在[Lark开发者工具](/document/uYjL24iN/ucDOzYjL3gzM24yN4MjN)（需升级为 V2.7.1）中调试并校验链接，确认链接可正常跳转。

![后台中文版.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/3d82af75e21bdfacbaf46fb9d5012dbc_7et9khdnVW.png)
