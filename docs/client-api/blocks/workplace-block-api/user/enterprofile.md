---
document_id: '7180270043523252230'
directory_id: '7180165099250991109'
title: enterProfile
full_path: /uAjLw4CM/uYjL24iN/block/api/user/enterprofile
breadcrumb:
- Client API
- Blocks
- Workplace Block API
...
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/api/user/enterprofile
---
...
| **名称** | **数据类型** | **是否必填** | **默认值** | **描述**                                                                          |
| ------ | ------ | ------- | ------ | ------------------------------------------------------------------------------- | ---------- | 
| openid | string | 是      | --      | 用户的 [OpenID](/document/ukTMukTMukTM/uUTO5UjL1kTO14SN5kTN)，有关 OpenID 解释可以参考[名词解释](/document/ukTMukTMukTM/uYTM5UjL2ETO14iNxkTN/terminology)| PC 端 1.0.3 |
