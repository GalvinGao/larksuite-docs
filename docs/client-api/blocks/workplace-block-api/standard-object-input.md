---
document_id: '7180269945547128837'
directory_id: '7180165099251122181'
title: 标准对象输入
full_path: /uAjLw4CM/uYjL24iN/block/api/standard-object-input
breadcrumb:
- Client API
- Blocks
- Workplace Block API
...
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/api/standard-object-input
---
...
为了帮助您更好的阅读接下来的文档，我们以「[login](/document/uAjLw4CM/uYjL24iN/block/api/user/login)」这个 API 为例子来说明。
