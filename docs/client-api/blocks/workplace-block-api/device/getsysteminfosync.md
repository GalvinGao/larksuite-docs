---
document_id: '7180269945548505093'
directory_id: '7180165099250860037'
title: getSystemInfoSync
full_path: /uAjLw4CM/uYjL24iN/block/api/device/getsysteminfosync
breadcrumb:
- Client API
- Blocks
- Workplace Block API
...
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/api/device/getsysteminfosync
---
...
详情请参考[getSystemInfo](/document/uAjLw4CM/uYjL24iN/block/api/device/getsysteminfo)。
