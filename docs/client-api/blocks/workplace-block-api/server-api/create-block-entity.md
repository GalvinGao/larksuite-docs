...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/block/v2/entities |
| HTTP Method | POST |
| 支持的应用类型 | <md-app-support types="custom,isv"></md-app-support> |
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="block:entity" desc="变更BlockEntity内容" support_app_types="custom,isv" tags="">变更BlockEntity内容</md-perm> |
