---
document_id: '7180269945548390405'
directory_id: '7180165099250958341'
title: 创建 BlockEntity
full_path: /uAjLw4CM/ukTMukTMukTM/block-v2/entity/create
breadcrumb:
- Client API
- Blocks
- Workplace Block API
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/block-v2/entity/create
---

# 创建 BlockEntity

开发者可以通过该接口将部分或全部数据存放于 BlockEntity。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=block&version=v2&resource=entity&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/block/v2/entities</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="block:entity" desc="变更BlockEntity内容" support_app_types="custom,isv" tags="">变更BlockEntity内容</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >source_data</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >source_meta</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >source_link</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >i18n_summary</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >i18n_preview</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >i18n_summay</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>检查tenant-access-token是否有该block权限</md-td>
</md-tr>
