---
document_id: '7180270043522826246'
directory_id: '7180165099248222213'
title: 基础组件
full_path: /uAjLw4CM/uYjL24iN/block/component/basic-components
breadcrumb:
- Client API
- Blocks
- Component
...
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/component/basic-components
---
...
|bind* catch*|EventHandler|组件的[事件](/document/uYjL24iN/uQDOuQDOuQDO)回调|部分组件不支持 catch，以组件文档中的描述为准|
