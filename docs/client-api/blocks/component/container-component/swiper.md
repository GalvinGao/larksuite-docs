---
document_id: '7180269945547243525'
directory_id: '7180165099250843653'
title: swiper
full_path: /uAjLw4CM/uYjL24iN/block/component/container-component/swiper
breadcrumb:
- Client API
- Blocks
- Component
...
updated_at: 2022-12-27T10:19:03Z
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/component/container-component/swiper
---
...
| **名称**      | **类型**                      | **默认值** | **是否必填** | **说明**     |
| ----------- | --------------------------- | ------- | ------ | ---------- | ---------- |
| indicator-dots         | boolean      | false       | 否  | 是否显示面板指示点                                                                 | PC 端 1.0.0 |
| indicator-color        | string       | rgba(0,0,0,.3) | 否 |  指示点颜色                                                                      | PC 端 1.0.0 |
| indicator-active-color | string       | rgba(0,0,0,0)  | 否|  当前选中的指示点颜色                                                                 | PC 端 1.0.0 |
| autoplay               | boolean      | false         | 否 | 是否自动切换                                                                     | PC 端 1.0.0 |
| current                | number       | 0             | 否 | 当前选中滑块的index                                                               | PC 端 1.0.0 |
| current-item-id        | string       | ''             |否 | 当前选中滑块的组件id，不能与current属性同时指定                                               | PC 端 1.0.0 |
| interval               | number       | 5000          | 否 | 自动切换时间间隔                                                                   | PC 端 1.0.0 |
| duration               | number       | 500           | 否 | 滑动动画时长（单位ms）                                                                    | PC 端 1.0.0 |
| circular               | boolean      | false         | 否 | 是否循环播放（首尾衔接）                                                               | PC 端 1.0.0 |
| touchable              | boolean      | true          | 否 | 是否监听用户的触摸事件                                                                | PC 端 1.0.0 |
| vertical             | boolean| false            | 否 | 滑块放置方向是否为竖直（移动端暂不支持该属性） | PC 端 1.0.0 |
| bindchange             | (e: ChangeEvent) => void | -             |否 | current 改变时会触发 change 事件 | PC 端 1.0.0 |
...
.resize-api-container .m-json-content {
  ...
  width: 150px;
  align-self: center;
  background-image: url('https://sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/ark/889245c8a2b3df29c6dc68679fda59b2.png');
}
...
.m-picker-arrow {
  ...
  height: 16px;
  flex-grow: 0;
  background: url('https://sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/ark/894161cbe1dd2f014a15f45a52a4e3b8.png') no-repeat center;
...
.plus {
  width: 16px;
  height: 16px;
  background: url('https://sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/ark/966dece98ce1c91ca00797a10d4db475.png');
  background-size: 100% 100%;
}
...
.minus {
  width: 16px;
  height: 16px;
  background: url('https://sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/ark/92c9feadf70f3ff4a909744adcb4ce90.png');
  background-size: 100% 100%;
}
...
.dark-plus {
  width: 16px;
  height: 16px;
  background: url('https://sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/ark/c61ec95ffb8f5a6521fba9f3c0bb8ef3.png');
  background-size: 100% 100%;
}
...
.dark-minus {
  width: 16px;
  height: 16px;
  background: url('https://sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/ark/06acea4344e04c4caa191e3666bebed4.png');
  background-size: 100% 100%;
}
