---
document_id: '7180269945547800581'
directory_id: '7180165099251105797'
title: image
full_path: /uAjLw4CM/uYjL24iN/block/component/image
breadcrumb:
- Client API
- Blocks
- Component
...
updated_at: 2022-12-27T10:19:12Z
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/block/component/image
---
...
继承自 [BaseEvent](/document/uAjLw4CM/uYjL24iN/block/block-frame/view-layer/event-system)，以下为扩展属性。
...
- 移动端模式下，image 无默认宽高，因此业务必须手动设置宽高。
...
Block({
  data:{
    commonData: {
      url: 'https://sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/ark/4788e761425c502c0c1302a95ceb920f.png',
