---
document_id: '7260082411118362629'
directory_id: '7258197168736714758'
title: IAddFieldConfig
full_path: /uAjLw4CM/uYjL24iN/base-extensions/base-view-extensions/data-type/iaddfieldconfig
breadcrumb:
- Client API
- Base Extension
...
source_url: https://open.larksuite.com/document/uAjLw4CM/uYjL24iN/base-extensions/base-view-extensions/data-type/iaddfieldconfig
---

# IAddFieldConfig
相关api：[table.addField](/document/uAjLw4CM/uYjL24iN/base-extensions/base-view-extensions/api/table/table_addfield)。<br>
新增字段相关类型，为以下类型之一:
