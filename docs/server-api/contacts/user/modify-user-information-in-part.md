...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/contact/v3/users/:user_id</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="contact:user.base" desc="更新用户基本信息" support_app_types="custom,isv" tags="">更新用户基本信息</md-perm>
...
<md-tr>
  ...
  <md-td>用户的联系方式属于两个不同的Lark账号，添加失败。建议用户换其它的手机号或邮箱，或是先注销手机号或邮箱对应的帐号，然后再创建或更新，具体注销的流程见[帮助中心](https://www.feishu.cn/hc/zh-CN/articles/360049067831)
