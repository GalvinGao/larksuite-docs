---
document_id: '7441231145319120908'
directory_id: '6920532209305042945'
title: 更新用户 ID
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/update_user_id
breadcrumb:
- Server API
- Contacts
- User
...
updated_at: 2024-11-26T06:41:08Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/update_user_id
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/contact/v3/users/:user_id/update_user_id</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>无用户权限。当前操作的用户需在应用的通讯录权限范围内。通讯录权限范围的介绍与设置方式，参见[权限范围资源介绍](/document/ukTMukTMukTM/uETNz4SM1MjLxUzM/v3/guides/scope_authority)。</md-td>
</md-tr>
