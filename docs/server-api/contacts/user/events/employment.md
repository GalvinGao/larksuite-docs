---
document_id: '6965400907878154245'
directory_id: '6937939330288893980'
title: 员工入职
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/events/created
breadcrumb:
- Server API
- Contacts
- User
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/events/created
---
...
:::html
<md-alert type="tip">
只有当应用拥有被改动字段的数据权限时，才会接收到事件。具体的数据权限与字段的关系请参考[应用权限](/document/ukTMukTMukTM/uQjN3QjL0YzN04CN2cDN)，或查看事件体参数列表的字段描述。
</md-alert>
:::
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	用户的open_id [用户相关的 ID 概念](/document/home/user-identity-introduction/introduction)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	用户的union_id [用户相关的 ID 概念](/document/home/user-identity-introduction/introduction)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	租户内用户的唯一标识 [用户相关的 ID 概念](/document/home/user-identity-introduction/introduction)
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	用户的直接主管的用户open_id [用户相关的 ID 概念](/document/home/user-identity-introduction/introduction)
...
**字段权限要求**：
<md-perm name="contact:user.dotted_line_leader_info.read" desc="获取用户虚线上级ID" support_app_types="custom,isv" tags="">获取用户虚线上级ID</md-perm>
	</md-dt-td>
</md-dt-tr>
