---
document_id: '7055272807039614982'
directory_id: '7050040770682830854'
title: 查询用户组列表
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/group/simplelist
breadcrumb:
- Server API
- Contacts
- User group
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/group/simplelist
---

# 查询用户组列表

通过该接口可查询企业的用户组列表，可分别查询普通用户组或动态用户组。如果应用的通讯录权限范围是“全部员工”，则可获取企业全部用户组列表。如果应用的通讯录权限范围不是“全部员工”，则仅可获取通讯录权限范围内的用户组。[点击了解通讯录权限范围](/document/ukTMukTMukTM/uETNz4SM1MjLxUzM/v3/guides/scope_authority)。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=group&method=simplelist)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/contact/v3/group/simplelist</md-td>
    </md-tr>
    <md-tr>
