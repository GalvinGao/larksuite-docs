---
document_id: '7055272807039631366'
directory_id: '7050040770682830854'
title: 查询用户组
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/group/get
breadcrumb:
- Server API
- Contacts
- User group
...
updated_at: 2022-08-30T10:15:48Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/group/get
---

# 查询用户组

根据用户组 ID 查询某个用户组的基本信息，支持查询普通用户组和动态用户组。请确保应用的通讯录权限范围里包括该用户组或者是“全部员工”，[点击了解通讯录权限范围](/document/ukTMukTMukTM/uETNz4SM1MjLxUzM/v3/guides/scope_authority)。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=group&method=get)
