---
document_id: '6965400907878055941'
directory_id: '6927521875715244034'
title: 获取单个部门信息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/get
breadcrumb:
- Server API
- Contacts
- Department
...
updated_at: 2022-12-15T02:59:40Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/get
---

# 获取单个部门信息

该接口用于向通讯录获取单个部门信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=department&method=get)
