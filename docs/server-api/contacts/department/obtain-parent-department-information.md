---
document_id: '6965400907875024902'
directory_id: '6927521875715244034'
title: 获取父部门信息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/parent
breadcrumb:
- Server API
- Contacts
- Department
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/parent
---

# 获取父部门信息

该接口用来递归获取部门父部门的信息，并按照由子到父的顺序返回有权限的父部门信息列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=department&method=parent)
