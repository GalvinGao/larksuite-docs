---
document_id: '7055272807039467526'
directory_id: '6927521875715244034'
title: 获取子部门列表
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/children
breadcrumb:
- Server API
- Contacts
- Department
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/children
---

# 获取子部门列表

通过部门ID获取部门的子部门列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=department&method=children)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/contact/v3/departments/:department_id/children</md-td>
    </md-tr>
    <md-tr>
...
department_id的获取方式参见 [部门ID说明](/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/field-overview#23857fe0)
