---
document_id: '7072915016361508870'
directory_id: '6927521875715244034'
title: 部门群转为普通群
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/unbind_department_chat
breadcrumb:
- Server API
- Contacts
- Department
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/unbind_department_chat
---

# 部门群转为普通群

使用此接口可以将部门群转为普通群。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=department&method=unbind_department_chat)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/contact/v3/departments/unbind_department_chat</md-td>
    </md-tr>
    <md-tr>
