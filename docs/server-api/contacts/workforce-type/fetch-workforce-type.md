---
document_id: '6986535352107761670'
directory_id: '6986153129993945093'
title: 查询人员类型
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/employee_type_enum/list
breadcrumb:
- Server API
- Contacts
- Workforce type
- Fetch Workforce Type
document_type: ReferenceDocumentType
updated_at: 2022-03-09T02:02:32Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/employee_type_enum/list
---

# 查询人员类型

该接口用于获取员工的人员类型{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=employee_type_enum&method=list)
