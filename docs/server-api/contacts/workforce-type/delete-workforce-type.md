---
document_id: '6986535352107859974'
directory_id: '6986153129993945093'
title: 删除人员类型
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/employee_type_enum/delete
breadcrumb:
- Server API
- Contacts
- Workforce type
- Delete Workforce Type
document_type: ReferenceDocumentType
updated_at: 2022-09-15T05:59:37Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/employee_type_enum/delete
---

# 删除人员类型

删除自定义人员类型{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=employee_type_enum&method=delete)
