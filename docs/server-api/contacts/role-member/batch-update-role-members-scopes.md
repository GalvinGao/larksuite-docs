---
document_id: '7233350748972875781'
directory_id: '7233243677127229446'
title: 批量设置角色成员管理范围
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/scopes
breadcrumb:
- Server API
- Contacts
- role member
- Batch update role members scopes
document_type: ReferenceDocumentType
updated_at: 2023-05-31T13:18:17Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/scopes
---

# 批量设置角色成员管理范围

通过该接口可设置本租户下角色成员的管理范围，以便在审批等场景中应用。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=functional_role.member&method=scopes)
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/contact/v3/functional_roles/:role_id/members/scopes |
| HTTP Method | PATCH |
| 接口频率限制 | [100 次/分钟](/document/ukTMukTMukTM/uUzN04SN3QjL1cDN) |
| 支持的应用类型 | <md-app-support types="custom"></md-app-support> |
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="contact:functional_role" desc="查看、创建、修改、删除角色及角色成员" support_app_types="custom" tags="">查看、创建、修改、删除角色及角色成员</md-perm> |
...
<md-enum-item key="2" >用户ID无效</md-enum-item>
<md-enum-item key="3" >用户ID无权限</md-enum-item>
<md-enum-item key="4" >用户已存在在该角色中</md-enum-item>
<md-enum-item key="5" >用户不存在在该角色中</md-enum-item>
<md-enum-item key="6" >对该角色内该用户旧的管理范围无权限</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
| HTTP状态码 | 错误码 | 描述 | 排查建议 |
| --- | --- | --- | --- |
| 404 | 41202 | role id is not exist | roleID 不存在 |
| 400 | 41210 | dept id is invalid | 部门ID无效 |
| 400 | 41211 | dept id is not has perm | 部门ID无权限 |
