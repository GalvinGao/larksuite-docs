---
document_id: '7233350748972974085'
directory_id: '7233243677127229446'
title: 批量添加角色成员
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/batch_create
breadcrumb:
- Server API
- Contacts
- role member
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/batch_create
---

# 批量添加角色成员

通过”批量添加角色成员“接口可批量添加成员，成员信息同步展示至租户的管理后台-角色管理模块。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=functional_role.member&method=batch_create)
...
| 400 | 41209 | tenant role is not more 1000 | 租户内单个角色的成员不可超过1000 |
