---
document_id: '7233350748972892165'
directory_id: '7233243677127229446'
title: 查询角色下某个成员的管理范围
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/get
breadcrumb:
- Server API
- Contacts
- role member
...
updated_at: 2023-05-15T10:15:10Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/get
---

# 查询角色下某个成员的管理范围

通过本接口可以查询某个成员的管理范围{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=functional_role.member&method=get)
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="contact:functional_role" desc="查看、创建、修改、删除角色及角色成员" support_app_types="custom" tags="">查看、创建、修改、删除角色及角色成员</md-perm><br><md-perm name="contact:functional_role:readonly" desc="查询角色信息、角色下的成员信息" support_app_types="custom" tags="">查询角色信息、角色下的成员信息</md-perm> |
...
**可选值有**：
<md-enum>
<md-enum-item key="All" >管理范围是全部</md-enum-item>
<md-enum-item key="Part" >管理范围是部分</md-enum-item>
<md-enum-item key="None" >管理范围为空</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
| 404 | 41203 | member id is not exist | 成员ID不存在 |
