---
document_id: '7233350748972859397'
directory_id: '7233243677127229446'
title: 删除角色下的成员
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/batch_delete
breadcrumb:
- Server API
- Contacts
- role member
- Delete members from roles
document_type: ReferenceDocumentType
updated_at: 2023-05-31T13:18:17Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/batch_delete
---

# 删除角色下的成员

通过本接口可以删除角色下的某个/些成员{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=functional_role.member&method=batch_delete)
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/contact/v3/functional_roles/:role_id/members/batch_delete |
| HTTP Method | PATCH |
