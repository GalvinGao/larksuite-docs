---
document_id: '7233350748972990469'
directory_id: '7233243677127229446'
title: 查询角色下的所有成员信息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/list
breadcrumb:
- Server API
- Contacts
- role member
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/list
---

# 查询角色下的所有成员信息

通过本接口可以查询角色ID下的成员信息（含成员ID及其管理范围）{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=functional_role.member&method=list)
