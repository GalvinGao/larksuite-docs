---
document_id: '7309011377695424518'
directory_id: '7308578767201468422'
title: 创建应用消息流卡片
full_path: /uAjLw4CM/ukTMukTMukTM/group/im-v2/app_feed_card/create
breadcrumb:
- Server API
- Feed
- Apps
...
updated_at: 2024-05-31T02:09:50Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/group/im-v2/app_feed_card/create
---

# 创建应用消息流卡片

应用消息流卡片是Lark为应用提供的消息触达能力，让应用可以直接在消息流发送消息，重要消息能更快触达用户。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v2&resource=app_feed_card&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/im/v2/app_feed_card</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	头像 key。可通过调用
[上传图片](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/image/create)接口获取
