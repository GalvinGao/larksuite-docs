---
document_id: '7309011377695391750'
directory_id: '7346424474142736389'
title: 即时提醒
full_path: /uAjLw4CM/ukTMukTMukTM/group/im-v2/feed_card/patch
breadcrumb:
- Server API
- Feed
- Groups & Bots
...
updated_at: 2024-04-01T08:09:04Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/group/im-v2/feed_card/patch
---

# 即时提醒

即时提醒能力是Lark在消息列表中提供的强提醒能力，当有重要通知或任务需要及时触达用户，可将群组或机器人对话在消息列表中置顶展示，打开Lark首页即可处理重要任务。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v2&resource=feed_card&method=patch)
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="im:datasync.feed_card.time_sensitive:write" desc="调用即时提醒能力" support_app_types="custom,isv" tags="">调用即时提醒能力</md-perm> |
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	用户id 列表，支持OpenID，UnionID, UserID  
