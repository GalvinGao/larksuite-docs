---
document_id: '7071201301615771654'
directory_id: '7071067639175741446'
title: 删除消息表情回复
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/events/deleted
breadcrumb:
- Server API
- Messaging
- Message reaction
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/events/deleted
---
...
注意事项：
- 如果操作人类型是"user"，则会返回 ==user_id==
- 如果操作人类型是"app"，则会返回 ==app_id==
	</md-dt-td>
</md-dt-tr>
