---
document_id: '7050314353535598598'
directory_id: '7047337547797905414'
title: 获取消息表情回复
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/list
breadcrumb:
- Server API
- Messaging
- Message reaction
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/list
---

# 获取消息表情回复

获取指定消息的特定类型表情回复列表（reaction即表情回复，本文档统一用“reaction”代称）。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=message.reaction&method=list)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	待获取reaction的消息ID，详情参见[消息ID说明](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/intro#ac79c1c2)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	待查询消息reaction的类型[emoji类型列举](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/emojis-introduce)
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	emoji类型 [emoji类型列举](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/emojis-introduce)
	</md-dt-td>
</md-dt-tr>
