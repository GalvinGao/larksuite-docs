---
document_id: '7138319837503569925'
directory_id: '7137982153342402566'
title: 获取群内 Pin 消息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/pin/list
breadcrumb:
- Server API
- Messaging
- Pin
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/pin/list
---

# 获取群内 Pin 消息

获取所在群内指定时间范围内的所有 Pin 消息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=pin&method=list)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	待获取Pin消息的Chat ID，详情参见[群ID 说明](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-id-description)
