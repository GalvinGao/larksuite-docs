---
document_id: '7138319837503553541'
directory_id: '7137982153342402566'
title: 移除 Pin 消息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/pin/delete
breadcrumb:
- Server API
- Messaging
- Pin
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/pin/delete
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/im/v1/pins/:message_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	待移除Pin的消息ID，详情参见[消息ID说明](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/intro#ac79c1c2)
