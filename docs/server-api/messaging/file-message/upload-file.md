---
document_id: '7026663896463343621'
directory_id: '7002892512470777862'
title: 上传文件
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/file/create
breadcrumb:
- Server API
- Messaging
- File message
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/file/create
---

# 上传文件

上传文件，可以上传视频，音频和常见的文件类型。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=file&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/im/v1/files</md-td>
    </md-tr>
    <md-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="opus" >上传opus音频文件；
其他格式的音频文件，请转为opus格式后上传，转换方式可参考：`ffmpeg -i  SourceFile.mp3 -acodec libopus -ac 1 -ar 16000 TargetFile.opus`</md-enum-item>
<md-enum-item key="mp4" >上传mp4视频文件</md-enum-item>
<md-enum-item key="pdf" >上传pdf格式文件</md-enum-item>
<md-enum-item key="doc" >上传doc格式文件</md-enum-item>
<md-enum-item key="xls" >上传xls格式文件</md-enum-item>
<md-enum-item key="ppt" >上传ppt格式文件</md-enum-item>
<md-enum-item key="stream" >上传stream格式文件。若上传文件不属于以上类型，可以使用stream格式</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
