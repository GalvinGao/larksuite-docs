...
<md-tr>
	...
	<md-td>
	消息类型 包括：text、post、image、file、audio、media、sticker、interactive、share_chat、share_user等，类型定义请参考：[发送消息Content](/document/uAjLw4CM/ukTMukTMukTM/im-v1/message/create_json)
	</md-td>
</md-tr>
...
<md-tr>
	...
	<md-td>
	该字段标识发送者的id类型，如`app_id`、`open_id`
	</md-td>
</md-tr>
...
<md-tr>
	...
	<md-td>
	消息内容，json结构，不同msg_type对应不同内容。消息类型 包括：text、post、image、file、audio、media、sticker、interactive、share_chat、share_user等，具体格式说明参考：[发送消息Content](/document/uAjLw4CM/ukTMukTMukTM/im-v1/message/create_json)
	</md-td>
</md-tr>
...
<md-tr>
	...
	<md-td>
	被@的用户或机器人 id 类型，如`open_id` ([什么是 Open ID？](/document/home/user-identity-introduction/open-id))
	</md-td>
</md-tr>
...
<md-tr>
	...
	<md-td>
		消息所属的话题 ID（不返回说明该消息非话题消息），可通过该 ID 实现转发话题、获取话题中的所有消息等，请参见：[话题介绍](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/thread-introduction)
	</md-td>
</md-tr>
