...
<md-tr>
  ...
  <md-td>暂不支持在外部群中编辑消息、以用户身份编辑消息。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>该消息类型不支持本操作，仅支持文本、富文本消息。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>该消息已超出可编辑的时间，不能编辑；消息可编辑的时间范围请咨询本租户管理员。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>消息所在的群组已被解散，无法编辑该消息。</md-td>
</md-tr>
