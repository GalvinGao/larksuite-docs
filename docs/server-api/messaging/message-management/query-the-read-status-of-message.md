---
document_id: '7026663896463507461'
directory_id: '7002892512470597638'
title: 查询消息已读信息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/read_users
breadcrumb:
- Server API
- Messaging
- Message management
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/read_users
---

# 查询消息已读信息

查询消息的已读信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=message&method=read_users)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/im/v1/messages/:message_id/read_users</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="im:message:basic" desc="获取消息的基础信息V2" support_app_types="custom,isv" tags="history">获取消息的基础信息V2</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	待查询的消息的ID，说明参见：[消息ID说明](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/intro#ac79c1c2)
...
--header 'Authorization: Bearer t-211ff21caf9e0929e8b659fc048a2ae6e751809'
```
...
<md-tr>
  ...
  <md-td>查询消息读取情况只能在发送消息后的7天内。</md-td>
</md-tr>
