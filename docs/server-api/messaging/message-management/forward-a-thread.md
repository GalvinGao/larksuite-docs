---
document_id: '7376928275937492998'
directory_id: '7002892512470597638'
title: 转发话题
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/thread/forward
breadcrumb:
- Server API
- Messaging
- Message management
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/thread/forward
---

# 转发话题

向用户、群聊或话题转发一个话题。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=thread&method=forward)
...
- 向用户转发话题，需要机器人对用户有[可用性](/document/home/introduction-to-scope-and-authorization/availability)
- 向群组中转发话题，需要机器人在群组中
- 转发话题生成的新消息的消息内容为固定值==Merged and Forwarded Message==，其子消息可以使用[获取指定消息的内容](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/get)接口获取
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	要转发的话题ID，详见：[话题介绍](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/thread-introduction)
</md-enum-item>
