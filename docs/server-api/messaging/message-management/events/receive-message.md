---
document_id: '7026663890609192966'
directory_id: '7002892512470663174'
title: 接收消息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/events/receive
breadcrumb:
- Server API
- Messaging
- Message management
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/events/receive
---
...
<md-alert type="tip">
注意事项:
- 需要开启[机器人能力](/document/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/trouble-shooting/how-to-enable-bot-ability)，并订阅 ==消息与群组== 分类下的 ==接收消息v2.0== 事件才可接收推送
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	tenant key，为租户在Lark上的唯一标识，用来换取对应的tenant_access_token，也可以用作租户在应用里面的唯一标识
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	消息的open_message_id，说明参见：[消息ID说明](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/intro#ac79c1c2)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	消息内容, JSON 格式 
[各类型消息Content](/document/uAjLw4CM/ukTMukTMukTM/im-v1/message/events/message_content)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	用户代理数据，仅在接收事件的机器人具备==获取客户端用户代理信息==权限时返回
	</md-dt-td>
</md-dt-tr>
