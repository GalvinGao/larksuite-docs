---
document_id: '7026663890609324038'
directory_id: '7002892512470663174'
title: 消息已读
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/events/message_read
breadcrumb:
- Server API
- Messaging
- Message management
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/events/message_read
---
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	租户key，为租户在Lark上的唯一标识，用来换取对应的tenant_access_token，也可以用作租户在应用里面的唯一标识
	</md-dt-td>
</md-dt-tr>
