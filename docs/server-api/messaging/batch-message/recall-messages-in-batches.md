---
document_id: '7035816914552406022'
directory_id: '7021842990278148101'
title: 批量撤回消息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/batch_message/delete
breadcrumb:
- Server API
- Messaging
- Batch message
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/batch_message/delete
---

# 批量撤回消息

批量撤回通过[批量发送消息](/document/ukTMukTMukTM/ucDO1EjL3gTNx4yN4UTM)接口发送的消息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=batch_message&method=delete)
...
- 撤回单条发送的消息请使用[撤回消息](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/delete)接口
- 不支持撤回发出时间超过1天的消息
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/im/v1/batch_messages/:batch_message_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	待撤回的批量消息任务 ID，为[批量发送消息](/document/ukTMukTMukTM/ucDO1EjL3gTNx4yN4UTM)接口返回值中的`message_id`字段，用于标识一次批量发送消息请求。
...
<md-tr>
  ...
  <md-td>消息发出时间过长（1天），不能执行当前操作。</md-td>
</md-tr>
