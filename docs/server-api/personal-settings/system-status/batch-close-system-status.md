---
document_id: '7184305756149252101'
directory_id: '7182701055624822790'
title: 批量关闭系统状态
full_path: /uAjLw4CM/ukTMukTMukTM/personal_settings-v1/system_status/batch_close
breadcrumb:
- Server API
- Personal Settings
- System status
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/personal_settings-v1/system_status/batch_close
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/personal_settings/v1/system_statuses/:system_status_id/batch_close</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	用户ID列表，传入的ID类型由user_id_type决定，推荐使用 OpenID，获取方式可参考文档[如何获取 Open ID](/document/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/trouble-shooting/how-to-obtain-openid)。
