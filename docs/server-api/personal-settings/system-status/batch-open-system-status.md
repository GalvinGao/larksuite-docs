---
document_id: '7184305756149235717'
directory_id: '7182701055624822790'
title: 批量开启系统状态
full_path: /uAjLw4CM/ukTMukTMukTM/personal_settings-v1/system_status/batch_open
breadcrumb:
- Server API
- Personal Settings
- System status
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/personal_settings-v1/system_status/batch_open
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="personal_settings:status:system_status_operate" desc="开启或关闭用户系统状态" support_app_types="custom" tags="">开启或关闭用户系统状态</md-perm> |
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	用户ID，传入的ID类型由user_id_type决定，推荐使用 OpenID，获取方式可参考文档[如何获取 Open ID](/document/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/trouble-shooting/how-to-obtain-openid)。
