---
document_id: '7026247042947317766'
directory_id: '7021712771402711046'
title: 首次启用应用
full_path: /uAjLw4CM/ukTMukTMukTM/application-v6/event/app-first-enabled
breadcrumb:
- Server API
- App Information
- Event
...
updated_at: 2022-03-08T06:13:51Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/application-v6/event/app-first-enabled
---
...
{ 
    ...
    "event": { 
        ...
        "installer": {	// 当应用被管理员安装时，返回此字段。如果是自动安装或由普通成员获取时，没有此字段
             "open_id":"xxx" ,  // 用户对此应用的唯一标识，同一用户对不同应用的open_id不同
        },
        "installer_employee": {  // 当应用被普通成员安装时，返回此字段
             "open_id":"xxx" ,  // 用户对此应用的唯一标识，同一用户对不同应用的open_id不同
		}
    } 
}
