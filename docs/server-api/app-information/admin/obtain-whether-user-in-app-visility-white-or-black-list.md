---
document_id: '7226630790280085509'
directory_id: '6907567266537291777'
title: 查询用户或部门是否在应用的可用或禁用名单
full_path: /uAjLw4CM/ukTMukTMukTM/application-v6/application-visibility/check_white_black_list
breadcrumb:
- Server API
- App Information
- Admin
- Obtain whether user in app visility white or black list
document_type: ReferenceDocumentType
updated_at: 2023-04-27T08:21:05Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/application-v6/application-visibility/check_white_black_list
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/application/v6/applications/:app_id/visibility/check_white_black_list</md-td>
    </md-tr>
    <md-tr>
...
可以调用[获取部门直属用户列表](/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/find_by_department)接口获取。
...
可以[调用获取子部门列表](/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/children)接口获取。
...
可以调用[查询用户组列表](/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/group/simplelist)接口获取。
