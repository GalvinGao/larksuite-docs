...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="application:application.contacts_range:write" desc="更新应用通讯录权限范围" support_app_types="custom" tags="">更新应用通讯录权限范围</md-perm> |
...
| 200 | 210006 | can not modify cantact of special app or official app | 检查应用是否为Lark官方应用或者其他在企业管理后台无法修改通讯录范围的应用 |
