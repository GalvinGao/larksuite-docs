---
document_id: '7278988143918497798'
directory_id: '6907567266537291777'
title: 更新应用通讯录权限范围配置
full_path: /uAjLw4CM/ukTMukTMukTM/application-v6/application-contacts_range/patch
breadcrumb:
- Server API
- App Information
- Admin
...
updated_at: 2023-09-18T09:26:05Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/application-v6/application-contacts_range/patch
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/application/v6/applications/:app_id/contacts_range</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>检查应用是否为Lark官方应用或者其他在企业管理后台无法修改通讯录范围的应用</md-td>
</md-tr>
