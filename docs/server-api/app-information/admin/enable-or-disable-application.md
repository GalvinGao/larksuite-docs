---
document_id: '7328229481431269382'
directory_id: '6907567266537291777'
title: 启停用应用
full_path: /uAjLw4CM/ukTMukTMukTM/application-v6/application-management/update
breadcrumb:
- Server API
- App Information
- Admin
...
updated_at: 2024-01-26T02:55:33Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/application-v6/application-management/update
---

# 启停用应用

可自动停用或启用企业内已安装的自建应用与商店应用。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=application&version=v6&resource=application.management&method=update)
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="admin:app.enable:write" desc="启停用应用" support_app_types="custom" tags="">启停用应用</md-perm> |
