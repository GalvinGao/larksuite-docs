---
document_id: '7223714459746893830'
directory_id: '6907567266537291777'
title: 获取应用通讯录权限范围配置
full_path: /uAjLw4CM/ukTMukTMukTM/application-v6/application/contacts_range_configuration
breadcrumb:
- Server API
- App Information
- Admin
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/application-v6/application/contacts_range_configuration
---
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	应用的 app_id，可以在[开发者后台](https://open.larksuite.com/app) > 凭证与基础信息页查看。
...
| HTTP状态码 | 错误码 | 描述 | 排查建议 |
| --- | --- | --- | --- |
| 400 | 210500 | invalid app_id | 请检查请求路径中的 app_id 是否合法 |
| 400 | 210501 | no such app in tenant | 请检查被查询应用与当前调用接口应用是否在同一企业内 |
| 400 | 210503 | target app not a custom app | 请检查被查询应用是否是自建应用 |
| 400 | 210504 | no such app | 请检查请求路径中的 app_id 是否存在 |
| 400 | 210505 | invalid page_token | page_token 在应用间不互通，请检查该 page_token 是否由调用接口的应用获取到 |
| 400 | 210506 | page_token does not exist or has expired | 请检查 page_token 是否合法，page_token 过期时间为 2h，若超过 2h 请重新获取 |
