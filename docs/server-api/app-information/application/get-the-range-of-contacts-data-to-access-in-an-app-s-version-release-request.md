---
document_id: '7223714459746877446'
directory_id: '7069596583364526085'
title: 获取应用版本中开发者申请的通讯录权限范围
full_path: /uAjLw4CM/ukTMukTMukTM/application-v6/application-app_version/contacts_range_suggest
breadcrumb:
- Server API
- App Information
- Application
...
updated_at: 2023-04-28T02:09:53Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/application-v6/application-app_version/contacts_range_suggest
---
...
:::html
<md-alert type="tip">
由于通讯录权限范围需要提交发布新的应用版本，并且企业管理员审核通过后才会生效，因此该权限范围可能与实际生效的权限范围有差别，如需获取线上实际生效的通讯录权限范围，可通过[获取应用通讯录权限范围配置](/document/uAjLw4CM/ukTMukTMukTM/application-v6/application/contacts_range_configuration) 获取。
</md-alert>
:::
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="application:application:self_manage" desc="管理应用自身资源" support_app_types="custom,isv" tags="">管理应用自身资源</md-perm><br><md-perm name="application:application.app_version:readonly" desc="获取应用版本信息" support_app_types="custom" tags="">获取应用版本信息</md-perm> |
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	应用的 AppID，可以在[开发者后台](https://open.larksuite.com/app) > **凭证与基础信息**页查看。<br>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	唯一标识应用版本的 ID，可以调用[获取应用版本列表](/document/uAjLw4CM/ukTMukTMukTM/application-v6/application-app_version/list)接口获取。
...
**可选值有**：
<md-enum>
<md-enum-item key="equal_to_availability" >与应用可用范围一致，可通过[获取应用在企业内的可用范围](/document/ukTMukTMukTM/uIjM3UjLyIzN14iMycTN)接口查询具体人员</md-enum-item>
