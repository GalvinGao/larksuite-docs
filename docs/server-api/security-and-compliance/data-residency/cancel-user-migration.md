...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/security_and_compliance/v1/user_migrations/cancel</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>500</md-td>
  <md-td>1783001</md-td>
  <md-td>用户迁移无法取消</md-td>
  <md-td>用户已被迁移至目标地理位置，如确需取消请寻求客服帮助</md-td>
</md-tr>
