---
document_id: '7202139792681975814'
directory_id: '7202139961926336517'
title: 批量获取用户迁移状态
full_path: /uAjLw4CM/ukTMukTMukTM/security_and_compliance-v1/user_migration/search
breadcrumb:
- Server API
- security_and_compliance
- Data Residency
- Get user migration status in batches
document_type: ReferenceDocumentType
updated_at: 2025-07-17T06:48:56Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/security_and_compliance-v1/user_migration/search
---

# 批量获取用户迁移状态

传入用户 ID 列表，批量获取用户迁移状态{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=security_and_compliance&version=v1&resource=user_migration&method=search)
