...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/security_and_compliance/v1/user_migrations</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1781004</md-td>
  <md-td>目标地理位置不可用</md-td>
  <md-td>使用 Open API 获取地理位置列表</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1781005</md-td>
  <md-td>用户已经在目标地理位置</md-td>
  <md-td>使用 Open API 查询对应用户的地理位置</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>1781006</md-td>
  <md-td>用户在迁移中</md-td>
  <md-td>使用 Open API 获取当前用户迁移状态</md-td>
</md-tr>
...
<md-tr>
  <md-td>500</md-td>
  <md-td>1782004</md-td>
  <md-td>系统或其他用户正在对请求中指定的用户进行操作</md-td>
  <md-td>请稍后重试</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1782005</md-td>
  <md-td>调用失败，迁移人数超过数据驻留服务席位限制</md-td>
  <md-td>请联系客服，按需增购席位后重新调用</md-td>
</md-tr>
