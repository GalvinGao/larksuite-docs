---
document_id: '7291504938512809989'
directory_id: '7289368200171503622'
title: 枚举值列表
full_path: /ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix
breadcrumb:
- Server API
...
updated_at: 2025-01-24T08:26:20Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix
---
...
|space_delete_doc | 删除云文档 | 1|
|space_edit_doc | 编辑云文档 | 1|
...
|space_create_spacecopy|创建知识空间副本 | 1|
...
|im_open_link | 对话内打开链接 | 2|
|im_start_external_chat | 对陌生人发起单聊 | 2|
|im_load_file_to_local | 服务端文件加载到本地（第一次点击下载会触发，相当于缓存到了本地） | 2|
|im_forward_file | 转发文件 | 2|
|im_create_chat | 创建群组 | 2|
|im_delete_chat | 解散群组 | 2|
|im_join_chat | 加入群组 | 2|
|im_quit_chat | 退出群组 | 2|
|im_add_chatadmin|添加群组的群管理员| 2|
|im_addtochat|添加群组成员| 2|
|im_admin_no_restrict_ctrl|管理员免受群聊保密模式限制成员| 2|
|im_chat_editimage|编辑图片| 2|
|im_chat_previewfile|在线预览非图片或视频文件| 2|
|im_chat_uploadfile|上传文件| 2|
|im_chat_withdraw|撤回| 2|
|im_delete_chatadmin|删除群组的群管理员| 2|
...
|im_snaphot|即时消息截图| 2|
|im_copy_image | 复制图片 | 2|
|im_read_doc | 访问聊天窗口中的文档 | 2|
|im_download_file | 下载聊天窗口中的文档 | 2|
|im_open_with_3rdApp | 用第三方应用打开聊天窗口中的预览文件 | 2|
...
|vc_create_video_meeting | 创建音视频通话 |  5|
|vc_finish_video_meeting | 结束音视频通话 | 5|
|vc_quit_video_meeting | 退出音视频通话 | 5|
|vc_join_video_meeting | 加入音视频通话 | 5|
| vc_changerange | 修改入会权限 | 5| 
| vc_invite_video_meeting | 邀请其他用户进入视频会议 | 5| 
| vc_share_video_meeting | 分享视频会议 | 5| 
| vc_sharescreen_video_meeting | 共享屏幕/文档 | 5| 
| vc_createclip | 创建妙记片段 | 5| 
| vc_deleteclip | 删除妙记片段 | 5| 
| vc_deletemeta | 将某篇妙记移入回收站 | 5| 
| vc_deletemetafromtrash | 永久删除某篇妙记 | 5| 
| vc_drivebatchtranscribe | 通过导入Lark云端文件生成妙记 | 5| 
...
| vc_viewclip | 访问某篇片段妙记 | 5| 
| vc_viewmeta | 访问某篇妙记 | 5| 
|vc_start_transcript	|会议转录开始| 5| 
|vc_stop_transcript	|停止会议转录| 5| 
|vc_request_transcript	|申请会议转录| 5| 
|vc_access_transcript	|同意会议转录| 5| 
|vc_refuse_transcript	|拒绝会议转录| 5| 
|vc_access_local_record	|同意本地录制| 5| 
|vc_refuse_local_record|	拒绝本地录制| 5| 
|vc_refuse_record	|拒绝会议录制| 5| 
|vc_access_record	|同意会议录制| 5| 
|vc_stop_record	|会议录制结束| 5| 
|vc_request_record	|申请会议录制| 5| 
|vc_start_local_record	|开始本地录制| 5| 
|vc_stop_local_record|	停止本地录制| 5| 
|vc_request_local_record	|请求本地录制| 5| 
|vc_manage_stop_local_record|	停止参会人的本地录制| 5| 
|vc_start_record	|会议录制开始| 5| 
...
| device_screen_recording | 录屏 | 8| 
| device_screenshot | 截屏 | 8| 
...
|cal_delete_calendar	|新建日历| 21| 
|cal_create_calendar	|删除日历| 21| 
...
| ccm_share_type                           | space_share                                                                                                                                                                                                                                                                               | 分享渠道        | share_wechat：微信；<br>share_lark：Lark；<br>share_encrypted_link：加密链接；<br>copy_link：复制链接；<br>share_qrcode：二维码；                                                                                                                      |
...
| exportType                               | vc_exportmeta                                                                                                                                                                                                                                                                             | 导出文件类型      | LarkDOC：Lark文档； <br>TXT：文本； <br>SRT：SRT文件；                                                                                                                                                                          |
...
| space_share_to_3rdApp                   | space_share_to_3rdApp                                                                                                                                                                                                                                                                    | 分享渠道        | share_wechat：微信；<br>share_lark：Lark；<br>share_encrypted_link：加密链接；<br>copy_link：复制链接；<br>share_qrcode：二维码；                                                                                                                      |
