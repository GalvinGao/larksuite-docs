---
document_id: '7291504938512826373'
directory_id: '7289368200171503622'
title: 获取行为审计日志数据
full_path: /ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/audit_data_get
breadcrumb:
- Server API
- security_and_compliance
- Behavior audit log
- Get behavior audit log
document_type: GuideDocumentType
updated_at: 2024-08-09T06:57:48Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/audit_data_get
---
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	行为审计的事件名称，可选事件名称见[枚举值列表](/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	行为审计的事件模块，可选事件模块见[枚举值列表](/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix)
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	事件名称，字段详情见[枚举值列表](/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	事件模块，字段详情见[枚举值列表](/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	操作对象类型，字段详情见[枚举值列表](/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	操作对象扩展字段，字段详情见[枚举值列表](/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	返回ios的环境信息，字段详情见[枚举值列表](/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	返回pc的环境信息，字段详情见[枚举值列表](/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	返回web的环境信息，字段详情见[枚举值列表](/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	返回android的环境信息，字段详情见[枚举值列表](/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	事件扩展字段，字段详情见[枚举值列表](/document/ukTMukTMukTM/uQjM5YjL0ITO24CNykjN/audit_log/appendix)
	</md-dt-td>
</md-dt-tr>
