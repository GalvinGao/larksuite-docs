...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/security_and_compliance/v2/device_apply_records/:device_apply_record_id |
| HTTP Method | PUT |
| 接口频率限制 | [10 次/秒](/document/ukTMukTMukTM/uUzN04SN3QjL1cDN) |
| 支持的应用类型 | <md-app-support types="custom"></md-app-support> |
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="security_and_compliance:device_apply_record:write" desc="审核自主申报申请" support_app_types="custom" tags="">审核自主申报申请</md-perm> |
