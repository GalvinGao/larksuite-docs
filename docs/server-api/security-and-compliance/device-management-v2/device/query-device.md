...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="security_and_compliance:device_record:read" desc="获取设备信息" support_app_types="custom" tags="">获取设备信息</md-perm> |
