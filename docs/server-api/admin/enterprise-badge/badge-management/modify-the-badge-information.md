---
document_id: '7242548239428321285'
directory_id: '7241898543983099909'
title: 修改勋章信息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/admin-v1/badge/update
breadcrumb:
- Server API
- Admin
- Enterprise badge
- Badge management
- Modify the badge information
document_type: ReferenceDocumentType
updated_at: 2023-06-09T05:06:07Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/admin-v1/badge/update
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/admin/v1/badges/:badge_id</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="admin:badge" desc="查看、创建、编辑勋章信息和上传勋章图片" support_app_types="custom" tags="">查看、创建、编辑勋章信息和上传勋章图片</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
