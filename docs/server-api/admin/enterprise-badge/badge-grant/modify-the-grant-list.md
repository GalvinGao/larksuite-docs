---
document_id: '7242548239428255749'
directory_id: '7241898543983067141'
title: 修改授予名单
full_path: /uAjLw4CM/ukTMukTMukTM/reference/admin-v1/badge-grant/update
breadcrumb:
- Server API
- Admin
- Enterprise badge
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/admin-v1/badge-grant/update
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/admin/v1/badges/:badge_id/grants/:grant_id</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="admin:badge.grant" desc="查看、创建、编辑、删除勋章授予名单" support_app_types="custom" tags="">查看、创建、编辑、删除勋章授予名单</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
