---
document_id: '6967261482951671813'
directory_id: '7376928275938541574'
title: 获取用户维度的用户活跃和功能使用数据
full_path: /uAjLw4CM/ukTMukTMukTM/reference/admin-v1/admin_user_stat/list
breadcrumb:
- Server API
- Admin
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="admin:admin_user_stat:readonly" desc="获取用户维度的用户活跃和功能使用数据" support_app_types="custom" tags="">获取用户维度的用户活跃和功能使用数据</md-perm> |
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	用户活跃状态，用户在Lark套件任意应用登陆，即为活跃。包括Lark即时消息，文档，日历，会议，开放平台等
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	综搜次数（在Lark主端搜索框的综合搜索发起过搜索请求的会话数）
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	垂搜次数（在Lark主端搜索框的垂类搜索tab（例如消息tab、云文档tab）发起过搜索请求的会话数）
	</md-dt-td>
</md-dt-tr>
