---
document_id: '7070902815602671622'
directory_id: '7070770034936086533'
title: 创建或修改考勤组
full_path: /uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/group/create
breadcrumb:
- Server API
- Attendance
- Attendance Group
- Create or modify an Attendance Group
document_type: ReferenceDocumentType
updated_at: 2023-10-25T09:21:46Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/group/create
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/attendance/v1/groups</md-td>
    </md-tr>
    <md-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="employee_id" >员工employeeId</md-enum-item>
<md-enum-item key="employee_no" >员工工号</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="open_id" >开放openID</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1220003</md-td>
  <md-td>employee_type 不存在</md-td>
  <md-td>employee_type，employee_id：员工的 employeeId，employee_no：员工工号</md-td>
</md-tr>
