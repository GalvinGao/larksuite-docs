---
document_id: '6975751842354511877'
directory_id: '6975751873563574278'
title: 获取班次详情
full_path: /uAjLw4CM/ukTMukTMukTM/Attendance//shift_by_id
breadcrumb:
- Server API
- Attendance
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/Attendance//shift_by_id
---

# 获取班次详情
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/shift/get)
</md-alert>
:::
