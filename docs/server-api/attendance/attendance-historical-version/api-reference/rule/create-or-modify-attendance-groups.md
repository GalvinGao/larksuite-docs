---
document_id: '6975751842354593797'
directory_id: '6975751873563574278'
title: 创建或者修改考勤组
full_path: /uAjLw4CM/ukTMukTMukTM/Attendance//group_create_update
breadcrumb:
- Server API
- Attendance
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/Attendance//group_create_update
---

# 创建或者修改考勤组
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/group/create)
</md-alert>
:::
...
|&emsp;∟bind_dept_ids|string\[\]|否|绑定的部门 ID|
|&emsp;∟except_dept_ids|string\[\]|否|排除的部门 ID|
|&emsp;∟bind_user_ids|string\[\]|否|绑定的用户 ID|
|&emsp;∟except_user_ids|string\[\]|否|排除的用户 ID |
|&emsp;∟group_leader_ids|string\[\]|是|考勤负责人 ID 列表，需至少存在一名考勤负责人|
|&emsp;∟punch_type|int|否|考勤方式，0：考勤组人员可在任意地点、任意网络环境下打卡，1：GPS 打卡，2：Wi-Fi 打卡，4：考勤机打卡，8：IP 打卡。位运算，累加可支持多种考勤方式，比如，3：支持 GPS 打卡和 Wi-Fi 打卡，7：支持 GPS 打卡、Wi-Fi 打卡和考勤机打卡|
...
|&emsp;∟remedy_period_type|int|否|补卡次数周期类型，0：自然月，1：自定义周期|
|&emsp;∟remedy_period_custom_date|int|否|补卡自定义周期每月起始日|
...
|&emsp;&emsp;∟gps_range|int|否|GPS 打卡的有效范围（默认300m）|
...
|&emsp;&emsp;∟punch_day|int|是|打卡时间：7 位数字，从左到右依次代表周一到周日，0 为不上班，1 为上班。例如：周一到周五上班 1111100|
...
|&emsp;&emsp;∟punch_type|int|考勤方式，0：考勤组人员可在任意地点、任意网络环境下打卡，1：GPS 打卡，2：Wi-Fi 打卡，4：考勤机打卡，8：IP 打卡。位运算，累加可支持多种考勤方式，比如，3：支持 GPS 打卡和 Wi-Fi 打卡，7：支持 GPS 打卡、Wi-Fi 打卡和考勤机打卡|
...
|&emsp;&emsp;∟remedy_period_type|int|补卡次数周期类型，0：自然月，1：自定义周期|
|&emsp;&emsp;∟remedy_period_custom_date|int|补卡自定义周期每月起始日|
...
|&emsp;&emsp;∟gps_range|int|GPS 打卡的有效范围（不建议使用）|
...
|&emsp;&emsp;&emsp;∟gps_range|int|GPS 打卡的有效范围（默认300m）|
...
|&emsp;&emsp;&emsp;∟punch_day|int|打卡时间：7 位数字，从左到右依次代表周一到周日，0 为不上班，1 为上班。例如：周一到周五上班 1111100|
...
|400|1220004|用户不存在|请检查用户 ID 是否正确|
