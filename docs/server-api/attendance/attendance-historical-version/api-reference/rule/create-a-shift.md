---
document_id: '6975751842354626565'
directory_id: '6975751873563574278'
title: 创建班次
full_path: /uAjLw4CM/ukTMukTMukTM/Attendance//shift_create
breadcrumb:
- Server API
- Attendance
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/Attendance//shift_create
---

# 创建班次
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/shift/create)
</md-alert>
:::
...
|&emsp;∟on_time|string|是|上班时间，示例参数：“09:00”|
