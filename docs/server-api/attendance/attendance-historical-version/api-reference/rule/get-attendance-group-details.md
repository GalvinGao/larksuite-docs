---
document_id: '6975751842354610181'
directory_id: '6975751873563574278'
title: 获取考勤组详情
full_path: /uAjLw4CM/ukTMukTMukTM/Attendance//group
breadcrumb:
- Server API
- Attendance
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/Attendance//group
---

# 获取考勤组详情
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/group/get)
</md-alert>
:::
...
|名称|类型|必填|描述|
|---|---|---|---|
|employee_type|string|是|用户 ID 的类型，可用值：【employee_id（员工的 employeeId），employee_no（员工工号）】
|dept_type|string|是|部门 ID 的类型，可用值：【open_id（暂时只支持部门的 openid）】，示例值：“od-fcb45c28a45311afd441b8869541ece8”|
## 响应
### 响应体
|名称|类型|描述|
|---|---|---|
...
|&emsp;&emsp;&emsp;∟gps_range|int|GPS 打卡的有效范围|
...
|&emsp;&emsp;&emsp;∟punch_day|int|打卡日期，格式 20190101|
|&emsp;&emsp;&emsp;∟shift_id|string|班次 ID|
|&emsp;&emsp;∟work_day_no_punch_as_lack|boolean|自由班制下，工作日不打卡是否记为缺卡|
### 响应体示例
```json
{
    "code": 0,
