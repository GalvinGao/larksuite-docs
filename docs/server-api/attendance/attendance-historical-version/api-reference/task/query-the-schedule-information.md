---
document_id: '6975751842354577413'
directory_id: '6975751873563557894'
title: 查询班表信息
full_path: /uAjLw4CM/ukTMukTMukTM/Attendance//task/GetScheduledShifts
breadcrumb:
- Server API
- Attendance
...
- API Reference
- Task
- Query the Schedule Information
document_type: GuideDocumentType
updated_at: 2022-03-03T15:54:29Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/Attendance//task/GetScheduledShifts
---

# 查询班表信息
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/user_daily_shift/query)
</md-alert>
:::
