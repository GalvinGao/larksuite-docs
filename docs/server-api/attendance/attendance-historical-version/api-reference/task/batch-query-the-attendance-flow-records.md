---
document_id: '6975751842354429957'
directory_id: '6975751873563557894'
title: 批量查询打卡流水记录
full_path: /uAjLw4CM/ukTMukTMukTM/Attendance//BatchQueryCheckinFlowHistory
breadcrumb:
- Server API
- Attendance
...
- API Reference
- Task
- Batch Query the Attendance Flow Records
document_type: GuideDocumentType
updated_at: 2022-03-03T15:54:29Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/Attendance//BatchQueryCheckinFlowHistory
---

# 批量查询打卡流水记录
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/user_flow/query)
</md-alert>
:::
...
|名称|类型|必填|描述|
|---|---|---|---|
|user_ids|string\[\]|是|employee_no 或 employee_id 列表，长度不超过50|
...
|&emsp;&emsp;∟type|int|记录生成方式，可用值：【0（用户自己打卡），1（管理员修改），2（用户补卡），3（系统自动生成），4（下班免打卡），5（考勤机打卡），6（极速打卡），7（考勤开放平台导入），8（Lark自研考勤机），9（Lark门禁考勤机）】|
