---
document_id: '6975751842354462725'
directory_id: '6975751873563557894'
title: 创建或者修改班表
full_path: /uAjLw4CM/ukTMukTMukTM/Attendance//CreateandEditShifts
breadcrumb:
- Server API
- Attendance
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/Attendance//CreateandEditShifts
---

# 创建或修改班表
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/user_daily_shift/batch_create)
</md-alert>
:::
...
|名称|类型|必填|描述|
|---|---|---|---|
|employee_type|string|是|请求体中的 user_id 的员工工号类型可用值：【employee_id（员工的 employeeId），employee_no（员工工号）】，示例值："employee_id"|
### 请求体
|名称|类型|必填|描述|
|---|---|---|---|
|user_daily_shifts|user_daily_shift\[\]|是|班表信息列表|
|&emsp;∟group_id|string|是|考勤组 ID|
|&emsp;∟shift_id|string|是|班次 ID，休息为 0|
|&emsp;∟month|int|是|月份|
|&emsp;∟user_id|string|是|用户|
|&emsp;∟day_no|int|是|日期|
### 请求体示例
```json
{
    "user_daily_shifts": [
