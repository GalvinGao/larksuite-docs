---
document_id: '6975751842354495493'
directory_id: '6975751873563557894'
title: 审批结果写入
full_path: /uAjLw4CM/ukTMukTMukTM/Attendance//AddApprovalsInLarkAttendance
breadcrumb:
- Server API
- Attendance
...
updated_at: 2024-02-19T02:57:06Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/Attendance//AddApprovalsInLarkAttendance
---

# 审批结果写入
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/user_approval/add-approved-data-in-feishu-attendance2)
</md-alert>
:::
