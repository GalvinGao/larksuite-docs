---
document_id: '7070902815602638854'
directory_id: '7070770034936070149'
title: 通知审批状态更新
full_path: /uAjLw4CM/ukTMukTMukTM/Attendance//task/notify-approval-status-update2
breadcrumb:
- Server API
- Attendance
- Attendance Approval
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/Attendance//task/notify-approval-status-update2
---
...
| 名称            | 类型     | 必填 | 描述                                                 |
| ------------- | ------ | -- | -------------------------------------------------- |
| approval_id   | string | 是  | 审批实例 ID，获取方式：1）[获取审批通过数据](/document/uAjLw4CM/ukTMukTMukTM/Attendance//task/get-user-attendance-data2) 2）[写入审批结果](/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/user_approval/add-approved-data-in-feishu-attendance2) 3）[通知补卡审批发起（补卡情况下）](/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/user_task_remedy/create)                                            |
