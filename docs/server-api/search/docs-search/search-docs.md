---
document_id: '7616351345914154422'
directory_id: '7616339064719347124'
title: 搜索文档
full_path: /uAjLw4CM/ukTMukTMukTM/search-v2/doc_wiki/search
breadcrumb:
- Server API
- Search
- docs search
...
updated_at: 2026-03-12T13:50:29Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/search-v2/doc_wiki/search
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="search:docs:read" desc="搜索云文档" support_app_types="custom,isv" tags="">搜索云文档</md-perm> |
...
<md-enum-item key="ENTITY_CREATE_TIME_ASC" >实体创建时间升序（已废弃）</md-enum-item>
<md-enum-item key="ENTITY_CREATE_TIME_DESC" >实体创建时间降序（已废弃）</md-enum-item>
...
<md-code-json>
{
    ...
    "data": {
        ...
        "res_units": [
            {
                "title_highlighted": "<h>Lark文档</h>使用指南",
                "summary_highlighted": "本文介绍<h>Lark文档</h>的创建、编辑与分享功能",
                "entity_type": "DOC",
                "result_meta": {
                    "doc_types": "SHORTCUT",
