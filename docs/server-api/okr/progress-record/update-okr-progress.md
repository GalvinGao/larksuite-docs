---
document_id: '7169462098089771014'
directory_id: '7168700436169523206'
title: 更新OKR进展记录
full_path: /uAjLw4CM/ukTMukTMukTM/reference/okr-v1/progress_record/update
breadcrumb:
- Server API
- OKR
- progress record
...
updated_at: 2023-10-11T08:58:41Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/okr-v1/progress_record/update
---

# 更新OKR进展记录

根据OKR进展记录ID更新进展详情{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=okr&version=v1&resource=progress_record&method=update)
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="okr:okr" desc="更新 OKR 信息" support_app_types="custom" tags="">更新 OKR 信息</md-perm> |
