---
document_id: '7169462098089787398'
directory_id: '7168700436169523206'
title: 创建OKR进展记录
full_path: /uAjLw4CM/ukTMukTMukTM/reference/okr-v1/progress_record/create
breadcrumb:
- Server API
- OKR
- progress record
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/okr-v1/progress_record/create
---

# 创建OKR进展记录

创建OKR进展记录{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=okr&version=v1&resource=progress_record&method=create)
