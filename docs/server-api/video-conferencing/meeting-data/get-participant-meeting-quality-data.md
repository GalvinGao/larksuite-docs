---
document_id: '7245184492770492422'
directory_id: '7244811844195221510'
title: 查询参会人会议质量数据
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/participant_quality_list/get
breadcrumb:
- Server API
- Video Conferencing
- Meeting data
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/participant_quality_list/get
---

# 查询参会人会议质量数据

查询参会人会议质量数据。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=participant_quality_list&method=get)
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="vc:room:readonly" desc="获取视频会议室信息" support_app_types="custom,isv" tags="">获取视频会议室信息</md-perm> |
