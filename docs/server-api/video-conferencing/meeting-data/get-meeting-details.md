---
document_id: '7245184492318851078'
directory_id: '7244811844195221510'
title: 查询会议明细
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting_list/get
breadcrumb:
- Server API
- Video Conferencing
- Meeting data
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting_list/get
---

# 查询会议明细

查询会议明细。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=meeting_list&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/vc/v1/meeting_list</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>126008</md-td>
  <md-td>userID and roomID and meeting number should be set only one</md-td>
