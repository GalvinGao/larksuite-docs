---
document_id: '7085933590580510726'
directory_id: '7081519902443864070'
title: 预约会议
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve/apply
breadcrumb:
- Server API
- Video Conferencing
- Meeting reservation
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve/apply
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="vc:reserve" desc="更新会议预约信息" support_app_types="custom,isv" tags="">更新会议预约信息</md-perm> |
