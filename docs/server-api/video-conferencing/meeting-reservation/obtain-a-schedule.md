---
document_id: '7085933590580461574'
directory_id: '7081519902443864070'
title: 获取预约
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve/get
breadcrumb:
- Server API
- Video Conferencing
- Meeting reservation
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve/get
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="vc:reserve:readonly" desc="获取会议预约信息" support_app_types="custom,isv" tags="">获取会议预约信息</md-perm> |
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	APPLink用于唤起LarkAPP入会。"{?}"为占位符，用于配置入会参数，使用时需替换具体值：0表示关闭，1表示打开。preview为入会前的设置页，mic为麦克风，speaker为扬声器，camera为摄像头
	</md-dt-td>
</md-dt-tr>
