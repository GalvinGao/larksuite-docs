---
document_id: '7245184492318736390'
directory_id: '7244811844195139590'
title: 搜索会议室
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room/search
breadcrumb:
- Server API
- Video Conferencing
...
updated_at: 2023-07-14T09:16:06Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room/search
---

# 搜索会议室

该接口可以用来搜索会议室，支持使用关键词进行搜索，也支持使用自定义会议室 ID 进行查询。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room&method=search)
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/vc/v1/rooms/search |
| HTTP Method | POST |
| 接口频率限制 | [1000 次/分钟、50 次/秒](/document/ukTMukTMukTM/uUzN04SN3QjL1cDN) |
| 支持的应用类型 | <md-app-support types="custom,isv"></md-app-support> |
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="vc:room" desc="更新视频会议室信息" support_app_types="custom,isv" tags="">更新视频会议室信息</md-perm><br><md-perm name="vc:room:readonly" desc="获取视频会议室信息" support_app_types="custom,isv" tags="">获取视频会议室信息</md-perm> |
