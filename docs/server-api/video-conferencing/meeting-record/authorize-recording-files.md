---
document_id: '7085933590580838406'
directory_id: '7081519902443798534'
title: 授权录制文件
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting-recording/set_permission
breadcrumb:
- Server API
- Video Conferencing
- Meeting record
...
updated_at: 2023-04-03T09:33:28Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting-recording/set_permission
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="vc:record" desc="更新会议录制信息" support_app_types="custom,isv" tags="">更新会议录制信息</md-perm> |
