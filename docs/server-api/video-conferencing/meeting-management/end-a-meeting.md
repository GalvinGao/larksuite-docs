---
document_id: '7085933590580543494'
directory_id: '7081519902443831302'
title: 结束会议
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/end
breadcrumb:
- Server API
- Video Conferencing
- Meeting management
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/end
---
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/vc/v1/meetings/:meeting_id/end |
| HTTP Method | PATCH |
| 接口频率限制 | [1000 次/分钟、50 次/秒](/document/ukTMukTMukTM/uUzN04SN3QjL1cDN) |
| 支持的应用类型 | <md-app-support types="custom,isv"></md-app-support> |
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="vc:meeting" desc="更新会议信息" support_app_types="custom,isv" tags="">更新会议信息</md-perm> |
