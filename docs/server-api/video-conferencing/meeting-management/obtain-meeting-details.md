---
document_id: '7085933590580477958'
directory_id: '7081519902443831302'
title: 获取会议详情
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/get
breadcrumb:
- Server API
- Video Conferencing
- Meeting management
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/get
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="vc:meeting:readonly" desc="获取会议信息" support_app_types="custom,isv" tags="">获取会议信息</md-perm> |
