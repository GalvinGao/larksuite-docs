---
document_id: '7085933590580707334'
directory_id: '7081519902443782150'
title: 会议开始
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/events/meeting_started
breadcrumb:
- Server API
- Video Conferencing
- Meeting management
...
updated_at: 2023-08-23T10:41:55Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/events/meeting_started
---

# 会议开始

发生在会议开始时，目前仅提供预约会议的相关事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=meeting&event=meeting_started)
...
| 权限要求<br><md-tooltip type="info">订阅该事件所需的权限，开启其中任意一项权限即可订阅</md-tooltip> | <md-perm name="vc:meeting:readonly" desc="获取会议信息" support_app_types="custom,isv" tags="">获取会议信息</md-perm> |
