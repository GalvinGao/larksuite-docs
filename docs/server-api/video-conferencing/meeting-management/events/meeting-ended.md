---
document_id: '7085933590580936710'
directory_id: '7081519902443782150'
title: 会议结束
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/events/meeting_ended
breadcrumb:
- Server API
- Video Conferencing
- Meeting management
...
updated_at: 2025-02-08T11:16:35Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/events/meeting_ended
---

# 会议结束

发生在会议结束时，目前仅提供预约会议的相关事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=meeting&event=meeting_ended)
