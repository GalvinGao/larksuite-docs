---
document_id: '7245184492318801926'
directory_id: '7244811844195205126'
title: 查询会议室配置
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/scope_config/get
breadcrumb:
- Server API
- Video Conferencing
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/scope_config/get
---
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	在会议结束n分钟后开始播放，取值1~720（仅对Lark会议室数字标牌生效）
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	在日程会议开始前n分钟停止播放，取值1~720（仅对Lark会议室数字标牌生效）
	</md-dt-td>
</md-dt-tr>
