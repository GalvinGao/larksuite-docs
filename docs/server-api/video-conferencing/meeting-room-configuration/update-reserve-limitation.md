---
document_id: '7152073124698652677'
directory_id: '7244811844195205126'
title: 更新会议室预定限制
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve_config/patch
breadcrumb:
- Server API
- Video Conferencing
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve_config/patch
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/vc/v1/reserve_configs/:reserve_config_id</md-td>
    </md-tr>
    <md-tr>
...
<md-alert type="tip">
注意提示<br>
1.  如果更新层级的配置，则覆盖所有子层级及会议室的配置。
2.  更新时， 
 approval_config、 
 time_config、reserve_scope_config 可更新其中任意一个，或两个或全部。
</md-alert>
:::
