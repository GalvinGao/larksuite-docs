---
document_id: '7245184492318556166'
directory_id: '7244811844195205126'
title: 更新会议室预定管理员
full_path: /uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve_config-admin/patch
breadcrumb:
- Server API
- Video Conferencing
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve_config-admin/patch
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/vc/v1/reserve_configs/:reserve_config_id/admin</md-td>
    </md-tr>
    <md-tr>
