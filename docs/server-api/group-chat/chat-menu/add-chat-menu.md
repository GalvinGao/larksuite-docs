---
document_id: '7197676707037659142'
directory_id: '7186934204960391174'
title: 添加群菜单
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_tree/create
breadcrumb:
- Server API
- Group Chat
- Chat menu
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_tree/create
---

# 添加群菜单

该接口用于向群组中添加群菜单。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.menu_tree&method=create)
