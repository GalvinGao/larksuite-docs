---
document_id: '7197676707037691910'
directory_id: '7186934204960391174'
title: 修改群菜单元信息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_item/patch
breadcrumb:
- Server API
- Group Chat
- Chat menu
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_item/patch
---

# 修改群菜单元信息

修改某个一级菜单或者二级菜单的元信息，包括群菜单的图标、名称、国际化名称和跳转链接。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.menu_item&method=patch)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	一级或二级菜单ID，通过 [获取群菜单](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_tree/get) 接口通过群ID获取菜单ID。
