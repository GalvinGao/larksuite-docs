---
document_id: '7197676707037675526'
directory_id: '7186934204960391174'
title: 删除群菜单
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_tree/delete
breadcrumb:
- Server API
- Group Chat
- Chat menu
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_tree/delete
---

# 删除群菜单

该接口用于删除群内已经添加的群菜单。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.menu_tree&method=delete)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	群内要删除的一级菜单ID。通过 [获取群菜单](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_tree/get) 接口获取群内菜单详情。
