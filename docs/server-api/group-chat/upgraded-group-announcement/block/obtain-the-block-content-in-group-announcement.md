---
document_id: '7472964047861301254'
directory_id: '7472308035420651526'
title: 获取群公告块的内容
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/chat-announcement-block/get
breadcrumb:
- Server API
- Group Chat
- Upgraded Group announcement
- Block
- Obtain the block content in group announcement
document_type: ReferenceDocumentType
updated_at: 2025-02-19T03:17:09Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/chat-announcement-block/get
---
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/docx/v1/chats/:chat_id/announcement/blocks/:block_id |
| HTTP Method | GET |
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	Block 的唯一标识。你可通过调用[获取群公告所有块](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/chat-announcement-block/list)接口获取块的 block_id。
