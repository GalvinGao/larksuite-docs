---
document_id: '7472964047861202950'
directory_id: '7472308035420651526'
title: 删除群公告中的块
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/chat-announcement-block-children/batch_delete
breadcrumb:
- Server API
- Group Chat
...
updated_at: 2025-02-19T03:17:15Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/chat-announcement-block-children/batch_delete
---
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	父 Block 的唯一标识。你可通过调用[获取群公告所有块](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/chat-announcement-block/list)接口获取块的 block_id。

**注意**：

- 此接口不支持删除表格（Table）的行列和删除分栏（Grid）的分栏列。你需通过[批量更新块的内容](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/chat-announcement-block/batch_update)接口完成相关操作。
