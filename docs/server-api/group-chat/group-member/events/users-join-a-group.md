---
document_id: '7026663890609111046'
directory_id: '7012181176438276101'
title: 用户进群
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-member-user/events/added
breadcrumb:
- Server API
- Group Chat
- Group member
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-member-user/events/added
---

# 用户进群

新用户进群（包含话题群）触发此事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.member.user&event=added)
