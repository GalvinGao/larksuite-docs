---
document_id: '7026663890609078278'
directory_id: '7002892512470745094'
title: 获取群成员列表
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-members/get
breadcrumb:
- Server API
- Group Chat
- Group member
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-members/get
---

# 获取群成员列表

获取用户/机器人所在群的群成员列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.members&method=get)
...
**可选值有**：
<md-enum>
<md-enum-item key="open_id" >以 open_id 来识别成员</md-enum-item>

**当值为 `user_id`，字段权限要求**：
<md-perm name="contact:user.employee_id:readonly" desc="获取用户 user ID" support_app_types="custom" tags="">获取用户 user ID</md-perm>
	</md-td>
</md-tr></md-enum-item>
<md-enum-item key="union_id" >以 union_id 来识别成员</md-enum-item>
<md-enum-item key="user_id" >以 user_id 来识别成员</md-enum-item>
</md-enum>
