---
document_id: '7026663890609455110'
directory_id: '7002892512470745094'
title: 判断用户或机器人是否在群里
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-members/is_in_chat
breadcrumb:
- Server API
- Group Chat
- Group member
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-members/is_in_chat
---

# 判断用户或机器人是否在群里

根据使用的access_token判断对应的用户或者机器人是否在群里。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.members&method=is_in_chat)
