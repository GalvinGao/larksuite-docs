---
document_id: '7026663890609438726'
directory_id: '7012181176438226949'
title: 群解散
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat/events/disbanded
breadcrumb:
- Server API
- Group Chat
- Group management
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat/events/disbanded
---
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	操作者的租户 Key，为租户在Lark上的唯一标识，用来换取对应的tenant_access_token，也可以用作租户在应用中的唯一标识
	</md-dt-td>
</md-dt-tr>
