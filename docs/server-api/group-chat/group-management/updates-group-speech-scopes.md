...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="im:chat" desc="获取与更新群组信息" support_app_types="custom,isv" tags="">获取与更新群组信息</md-perm><br><md-perm name="im:chat:moderation:write_only" desc="操作群发言权限" support_app_types="custom,isv" tags="">操作群发言权限</md-perm> |
...
| 400 | 232015 | Your request specifies a member_id_type which is NOT supported. | 无效的 user_id_type/member_id_type。 |
...
| 400 | 232060 | This chat is banned. | 群聊被禁言，请咨询[技术支持](https://applink.larksuite.com/TLJsX982)。 |
| 400 | 232092 | Meeting in progress. Unable to modify group posting permissions. | 会议进行过程中无法修改群发言权限。 |
