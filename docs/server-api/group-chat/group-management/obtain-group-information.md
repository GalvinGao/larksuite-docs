---
document_id: '7026663890609569798'
directory_id: '7136113559830396933'
title: 获取群信息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat/get
breadcrumb:
- Server API
- Group Chat
- Group management
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat/get
---

# 获取群信息

获取群名称、群描述、群头像、群主 ID 等群基本信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat&method=get)
