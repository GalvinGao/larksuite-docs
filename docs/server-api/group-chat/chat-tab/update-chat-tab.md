---
document_id: '7134990230498689029'
directory_id: '7130513101061423109'
title: 更新会话标签页
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/update_tabs
breadcrumb:
- Server API
- Group Chat
- Chat tab
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/update_tabs
---

# 更新会话标签页

更新会话标签页。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.tab&method=update_tabs)
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/im/v1/chats/:chat_id/chat_tabs/update_tabs |
| HTTP Method | POST |
...
| 400 | 232049 | The chat tab content is illegal. | 更新或者删除操作仅支持doc或者url类型的会话标签页。 |
