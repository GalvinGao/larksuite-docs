---
document_id: '7134990230498656261'
directory_id: '7130513101061423109'
title: 删除会话标签页
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/delete_tabs
breadcrumb:
- Server API
- Group Chat
- Chat tab
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/delete_tabs
---

# 删除会话标签页

删除会话标签页。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.tab&method=delete_tabs)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/im/v1/chats/:chat_id/chat_tabs/delete_tabs</md-td>
    </md-tr>
    <md-tr>
