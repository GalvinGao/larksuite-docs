---
document_id: '7026663890609471494'
directory_id: '7012181176438243333'
title: 获取群公告信息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-announcement/get
breadcrumb:
- Server API
- Group Chat
- Group announcement
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-announcement/get
---

# 获取群公告信息

获取会话中的群公告信息，公告信息格式与[旧版云文档](/document/ukTMukTMukTM/uAzM5YjLwMTO24CMzkjN)格式相同。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.announcement&method=get)
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="im:chat" desc="获取与更新群组信息" support_app_types="custom,isv" tags="">获取与更新群组信息</md-perm><br><md-perm name="im:chat.announcement:read" desc="查看群公告信息" support_app_types="custom,isv" tags="">查看群公告信息</md-perm><br><md-perm name="im:chat:readonly" desc="获取群组信息" support_app_types="custom,isv" tags="">获取群组信息</md-perm> |
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	待获取公告的群 ID，详情参见[群ID 说明](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-id-description)
...
- 如果所有者是用户，则与查询参数中的user_id_type 相同；取值为`open_id` `user_id` `union_id` 其中之一，不同 ID 的说明参见 [用户相关的 ID 概念](/document/home/user-identity-introduction/introduction)
- 如果所有者是机器人，为机器人应用的 `app_id`，详情参见  [获取应用身份访问凭证](/document/ukTMukTMukTM/ukDNz4SO0MjL5QzM/g)

**可选值有**：
<md-enum>
<md-enum-item key="user_id" >以 user_id 来识别用户</md-enum-item>
<md-enum-item key="union_id" >以 union_id 来识别用户</md-enum-item>
<md-enum-item key="open_id" >以 open_id 来识别用户</md-enum-item>
<md-enum-item key="app_id" >以 app_id 来识别机器人应用</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
 ...
 - 如果修改者是用户，则与查询参数中的user_id_type 相同；取值为`open_id` `user_id` `union_id` 其中之一，不同 ID 的说明参见 [用户相关的 ID 概念](/document/home/user-identity-introduction/introduction)
- 如果修改者是机器人，为机器人应用的 `app_id`，详情参见  [获取应用身份访问凭证](/document/ukTMukTMukTM/ukDNz4SO0MjL5QzM/g)
...
<md-enum-item key="union_id" >以 union_id 来识别用户</md-enum-item>
<md-enum-item key="open_id" >以 open_id 来识别用户</md-enum-item>
<md-enum-item key="app_id" >以 app_id 来识别应用</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
