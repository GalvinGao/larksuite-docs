---
document_id: '6965400907875155974'
directory_id: '6907567269107761154'
title: 批量新增部门
full_path: /ukTMukTMukTM/uMDOwUjLzgDM14yM4ATN
breadcrumb:
- Server API
...
updated_at: 2022-03-11T11:45:05Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uMDOwUjLzgDM14yM4ATN
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/contact/v2/department/batch_add</md-td>
    </md-tr>
    <md-tr>
...
msg | 对返回码的文本描述。
data | -
&emsp;∟task_id | 生成的异步任务 ID，参见 [查询批量任务执行状态](/document/ukTMukTMukTM/uUDOwUjL1gDM14SN4ATN) 接口。
### 响应体示例
```json
{
    "code": 0,
