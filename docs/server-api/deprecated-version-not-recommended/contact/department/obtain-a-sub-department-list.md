...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/contact/v1/department/simple/list?open_department_id=od-2efe30807a10608754862a63b108828f&page_size=10&fetch_child=true<br> https://open.larksuite.com/open-apis/contact/v1/department/simple/list?department_id=TT-1234&page_size=10&fetch_child=true |
| HTTP Method | GET |
