...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/contact/v1/department/user/detail/list?open_department_id=od-846fa088e3dcac5d0ce0b4f6b4cde899&page_size=10&fetch_child=true<br>https://open.larksuite.com/open-apis/contact/v1/department/user/detail/list?department_id=TT-1234&page_size=10&fetch_child=true</md-td>
    </md-tr>
    <md-tr>
