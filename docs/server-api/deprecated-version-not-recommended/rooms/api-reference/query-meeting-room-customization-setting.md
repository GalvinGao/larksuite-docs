---
document_id: '7073451579924267014'
directory_id: '6907567269107843074'
title: 获取会议室个性化配置
full_path: /ukTMukTMukTM/uIjM5UjLyITO14iMykTN/query-meeting-room-customization-setting
breadcrumb:
- Server API
- Deprecated Version (Not Recommended)
- Rooms
- API Reference
- Query Meeting Room Customization Setting
document_type: GuideDocumentType
updated_at: 2023-06-16T07:35:17Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uIjM5UjLyITO14iMykTN/query-meeting-room-customization-setting
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/meeting_room/room/customization</md-td>
    </md-tr>
    <md-tr>
