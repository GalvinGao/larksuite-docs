---
document_id: '6967261316286660613'
directory_id: '6907567266537013249'
title: 发送图片消息
full_path: /ukTMukTMukTM/uIDMxEjLyATMx4iMwETM
breadcrumb:
- Server API
...
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uIDMxEjLyATMx4iMwETM
---
...
msg_type | string | 必填 | 消息类型，此处固定填 “image”||image|
content | string | 必填 | 消息内容 |-|-|
&emsp;∟image_key | string | 必填 | image_key 可以通过[图片上传接口](/document/ukTMukTMukTM/uEDO04SM4QjLxgDN)获得 ||1a0c4cb9-c680-4371-924c-ddb5f2750c3d|
