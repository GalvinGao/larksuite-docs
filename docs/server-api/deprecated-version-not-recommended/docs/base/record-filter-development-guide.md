---
document_id: '7073819570391334917'
directory_id: '7524627067896528902'
title: 记录筛选的指南
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/filter
breadcrumb:
- Server API
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/filter
---
...
:::html
<md-alert type="tip">
该文档为历史版本。要查看对应最新版本文档，参考[记录过滤参数填写指南](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/record-filter-guide)。
</md-alert>
:::

在[列出记录](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/list)中可以通过查询参数 filter 去筛选出你需要的 records。
