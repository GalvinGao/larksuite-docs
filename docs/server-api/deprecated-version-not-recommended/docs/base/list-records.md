---
document_id: '7073819570391072773'
directory_id: '7524627067896528902'
title: 列出记录
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/list
breadcrumb:
- Server API
...
updated_at: 2025-07-16T07:28:09Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/list
---
...
::: note
该接口为历史接口，已不推荐使用。你可使用[查询记录](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/search)替代。
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	多维表格数据表的唯一标识符 [table_id 参数说明](/document/uAjLw4CM/ukTMukTMukTM/bitable/notification#735fe883)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	视图的唯一标识符，获取指定视图下的记录[view_id 参数说明](/document/uAjLw4CM/ukTMukTMukTM/bitable/notification#8121eebe)
...
详细请参考[筛选条件支持的公式](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/filter)
...
2.目前可以返回多行文本中 URL 类型为多维表格链接、Lark doc、Lark sheet的URL类型以及@人员的数据结构。
