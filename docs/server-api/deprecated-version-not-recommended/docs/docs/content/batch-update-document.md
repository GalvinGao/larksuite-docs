---
document_id: '6967331173081022469'
directory_id: '7154288300269879302'
title: 编辑旧版文档内容
full_path: /ukTMukTMukTM/uYDM2YjL2AjN24iNwYjN
breadcrumb:
- Server API
...
updated_at: 2023-09-22T08:05:25Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uYDM2YjL2AjN24iNwYjN
---
...
- [创建块](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block-children/create)
- [更新块](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/patch)
- [批量更新块](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/batch_update)
- [删除块](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block-children/batch_delete)
:::
...
| 参数| 类型| 必须 | 说明| 
| ------ | ------------ | ---- | -----|
|docToken|string|是|文件的 token，获取方式见[如何获取云文档资源相关 token](/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)|
| Revision      | int          | 是   | 文档的指定版本，文档新创建后版本号是0，[获取方式](/document/ukTMukTMukTM/uUDM2YjL1AjN24SNwYjN)，要求>=0，post body json 字段 |
...
| 字段    | 类型   | 说明                                                         |
| ------- | ------ | ------------------------------------------------------------ |
| payload | string | [文档数据结构概述](/document/ukTMukTMukTM/uAzM5YjLwMTO24CMzkjN) Title结构体序列化 string |
...
| 字段     | 类型   | 说明                                                         |
| -------- | ------ | ------------------------------------------------------------ |
| payload  | string | [文档数据结构概述](/document/ukTMukTMukTM/uAzM5YjLwMTO24CMzkjN) Body结构体序列化string |
...
| 字段     | 类型   | 说明                                                         |
| -------- | ------ | ------------------------------------------------------------ |
| payload  | string |传入符合[文档数据结构](/document/ukTMukTMukTM/ukDM2YjL5AjN24SOwYjN)的字符串 |
| location | object | 插入位置                                                     |
...
| 字段     | 类型   | 说明                                                         |
| -------- | ------ | ------------------------------------------------------------ |
| tableId  | string | 表格 id, 详见 [文档数据结构概述](/document/ukTMukTMukTM/uAzM5YjLwMTO24CMzkjN) Table 结构体定义 |
...
| 字段        | 类型   | 说明                                                         |
| ----------- | ------ | ------------------------------------------------------------ |
| tableId     | string | 表格id, 详见 [文档数据结构概述 ](/document/ukTMukTMukTM/uAzM5YjLwMTO24CMzkjN)Table 结构体定义 |
...
| 字段          | 类型   | 说明                                                         |
| ------------- | ------ | ------------------------------------------------------------ |
| tableId       | string | 表格id, 详见 [文档数据结构概述](/document/ukTMukTMukTM/uAzM5YjLwMTO24CMzkjN) Table结构体定义 |
...
| 字段         | 类型   | 说明                                                         |
| ------------ | ------ | ------------------------------------------------------------ |
| tableId      | string | 表格 id, 详见 [文档数据结构概述](/document/ukTMukTMukTM/uAzM5YjLwMTO24CMzkjN) Table结构体定义 |
...
|字段|类型|必须|说明|
|---|---|---|---|
|payload|string |是|详见[文档数据结构参考](/document/ukTMukTMukTM/ukDM2YjL5AjN24SOwYjN)<br>UpdateParagraphStyleRequest 子命令使用 ParagraphStyle 结构体序列化 string|
|range|Range|是|修改范围|
