---
document_id: '6967331173082103813'
directory_id: '7154288300269895686'
title: 准备接入文档 API
full_path: /ukTMukTMukTM/ugzNzUjL4czM14CO3MTN/guide/getting-start
breadcrumb:
- Server API
- Deprecated Version (Not Recommended)
- Docs
- Docs
- Getting Started with Docs API
document_type: GuideDocumentType
updated_at: 2023-09-22T08:04:53Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/ugzNzUjL4czM14CO3MTN/guide/getting-start
---
...
如果在请求接口时，应用不具备对应的权限，则会返回错误。详见：[应用权限](/document/ukTMukTMukTM/uQjN3QjL0YzN04CN2cDN)。
