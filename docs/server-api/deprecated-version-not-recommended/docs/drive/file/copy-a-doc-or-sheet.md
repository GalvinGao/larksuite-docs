...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| <md-text type="field-name" >fileToken</md-text> | <md-text type="field-type" >string</md-text> | 需要复制的源文件或文档的 token, 获取方式见 [概述](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/files/guide/introduction) |
