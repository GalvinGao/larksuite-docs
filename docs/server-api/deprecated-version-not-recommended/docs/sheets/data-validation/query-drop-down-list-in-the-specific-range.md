---
document_id: '7538736582375997446'
directory_id: '7538357428568670214'
title: 查询下拉列表设置
full_path: /uAjLw4CM/ukTMukTMukTM/historic-version/docs/sheets/datavalidation/query-datavalidation
breadcrumb:
- Server API
...
- sheets
- Data Validation
- Query Drop-down List in the Specific Range
document_type: GuideDocumentType
updated_at: 2025-08-19T04:56:06Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/historic-version/docs/sheets/datavalidation/query-datavalidation
---

# ~~查询下拉列表设置~~

**注意：该接口于 2025 年 9 月 20 号起不可用，请使用最新接口[查询下拉列表设置](/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/datavalidation/query-datavalidation)**。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/sheets/v2/spreadsheets/:spreadsheetToken/dataValidation/:sheetId/:dataValidationId</md-td>
    </md-tr>
    <md-tr>
...
|dataValidationId|int|是|sheet中下拉列表的唯一标示id|
...
###  cURL 请求示例
  ```
  curl --location --request PUT 'https://open.larksuite.com/open-apis/sheets/v2/spreadsheets/shtcngNygNfuqhxTBf588jwgWbJ/dataValidation/BzY8T5/1' \
...
|&emsp;∟dataValidation|||| 
|&emsp;&emsp;∟dataValidationId|int|是|唯一标示id|
