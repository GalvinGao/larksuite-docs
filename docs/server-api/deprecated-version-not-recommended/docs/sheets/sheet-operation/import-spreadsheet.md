---
document_id: '6967331158356000774'
directory_id: '7072190414392197126'
title: 导入表格
full_path: /ukTMukTMukTM/uATO2YjLwkjN24CM5YjN
breadcrumb:
- Server API
...
updated_at: 2022-03-11T12:24:24Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uATO2YjLwkjN24CM5YjN
---

# 导入表格
>  为了更好地提升该接口的安全性，我们对其进行了升级，请尽快迁移至[新版本](/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/import_task/import-user-guide)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/sheets/v2/import</md-td>
    </md-tr>
    <md-tr>
...
| 参数   |类型| 说明                                             |
| ------ |-----| ------------------------------------------------ |
| ticket |string| 与导入文件一一对应的凭证，用于查询文件导入的进度，详见[查询导入结果的接口](/document/ukTMukTMukTM/uETO2YjLxkjN24SM5YjN)  |
### 响应体示例
