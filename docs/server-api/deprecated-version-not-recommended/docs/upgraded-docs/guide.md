---
document_id: '7104193248416612358'
directory_id: '7281529226195779590'
title: 接入指南
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/guide
breadcrumb:
- Server API
...
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/guide
---
...
|undefined|未支持 Block|
> Block 类型枚举值定义：[点击查看 BlockType](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/data-structure/block#e8ce4e8e)。
## 限制
...
> 2. Block 类型枚举值定义：[点击查看 BlockType](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/data-structure/block#e8ce4e8e)。
## 查询文档基本信息
