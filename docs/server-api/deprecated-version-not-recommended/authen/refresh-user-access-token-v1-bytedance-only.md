---
document_id: '7520163088822861830'
directory_id: '7345445193132883974'
title: 刷新 user_access_token（v1 版本，仅字节）
full_path: /uAjLw4CM/ukTMukTMukTM/historic-version/authen/refresh-user_access_token-bytedance
breadcrumb:
- Server API
- Deprecated Version (Not Recommended)
- authen
- Refresh user_access_token (v1, ByteDance only)
document_type: GuideDocumentType
updated_at: 2025-06-26T07:54:01Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/historic-version/authen/refresh-user_access_token-bytedance
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/authen/v1/refresh_access_token</md-td>
    </md-tr>
    <md-tr>
