---
document_id: '7520163088822894598'
directory_id: '7345445193132883974'
title: 获取 user_access_token（v1 版本，仅字节）
full_path: /uAjLw4CM/ukTMukTMukTM/historic-version/authen/obtain-user_access_token-bytedance
breadcrumb:
- Server API
- Deprecated Version (Not Recommended)
- authen
- Obtain user_access_token (v1, ByteDance only)
document_type: GuideDocumentType
updated_at: 2025-06-26T07:53:57Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/historic-version/authen/obtain-user_access_token-bytedance
---
...
根据[登录预授权码](/document/ukTMukTMukTM/ukzN4UjL5cDO14SO3gTN) code 获取 `user_access_token`。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=authen&version=v1&resource=access_token&method=create)
...
:::html
<md-alert type="tip">
本接口用于网页应用免登录应用场景，小程序应用获取 user_access_token 的方法，请参考小程序应用提供的 [code2session](/document/uYjL24iN/ukjM04SOyQjL5IDN) 接口。
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/authen/v1/access_token</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	登录预授权码，调用[获取登录预授权码](/document/ukTMukTMukTM/ukzN4UjL5cDO14SO3gTN)接口获取
