---
document_id: '7347618112508182533'
directory_id: '7345445193132883974'
title: 刷新 user_access_token
full_path: /uAjLw4CM/ukTMukTMukTM/reference/authen-v1/oidc-refresh_access_token/create
breadcrumb:
- Server API
...
updated_at: 2025-06-26T07:53:40Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/authen-v1/oidc-refresh_access_token/create
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/authen/v1/oidc/refresh_access_token</md-td>
    </md-tr>
    <md-tr>
...
你可以调用[获取 user_access_token](/document/uAjLw4CM/ukTMukTMukTM/reference/authen-v1/oidc-access_token/create)重新获取 user_access_token 和 refresh_token。</md-td>
</md-tr>
