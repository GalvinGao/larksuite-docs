---
document_id: '7543849381893967281'
directory_id: '7530974965350825990'
title: 批量获取部门信息
full_path: /uAjLw4CM/ukTMukTMukTM/directory-v1/department/mget
breadcrumb:
- Server API
- Organization
- Department management
- Batch get department info
document_type: ReferenceDocumentType
updated_at: 2025-08-29T03:48:19Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/directory-v1/department/mget
---
...
- 本接口支持tenant_access_token和user_access_token。
  ...
  - 使用user_access_token时，默认为管理员用户，将校验管理员管理范围。当用户有多个管理员身份均可查看部门信息时，管理员管理范围取最大集。管理员权限可查看帮助中心文档： [管理员创建管理员角色及分配权限](https://www.larksuite.com/hc/zh-CN/articles/360043595213)
- 为增强Lark组织架构 OpenAPI 的灵活性，于 **2024 年 10 月 21 日**对该 API 接口做出了更新升级，升级内容包括：优化查询已删除部门信息的返回数据结构。
