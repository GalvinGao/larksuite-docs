---
document_id: '7543849381893541297'
directory_id: '7530974965350825990'
title: 搜索部门
full_path: /uAjLw4CM/ukTMukTMukTM/directory-v1/department/search
breadcrumb:
- Server API
- Organization
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/directory-v1/department/search
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="directory:department:search" desc="搜索部门" support_app_types="custom,isv" tags="">搜索部门</md-perm> |
...
[了解更多：字段枚举说明](/document/uAjLw4CM/ukTMukTMukTM/directory-v1/field-enumeration)
