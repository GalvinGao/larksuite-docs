---
document_id: '7543849381893639601'
directory_id: '7530974965350825990'
title: 获取部门列表
full_path: /uAjLw4CM/ukTMukTMukTM/directory-v1/department/filter
breadcrumb:
- Server API
- Organization
...
updated_at: 2025-08-29T03:48:23Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/directory-v1/department/filter
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="directory:department:list" desc="调用 API 获取部门列表" support_app_types="custom,isv" tags="">调用 API 获取部门列表</md-perm> |
