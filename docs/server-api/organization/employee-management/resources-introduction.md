---
document_id: '7543849381893655985'
directory_id: '7530974965350875142'
title: 资源介绍
full_path: /uAjLw4CM/ukTMukTMukTM/directory-v1/employee/resources-introduction
breadcrumb:
- Server API
- Organization
- Employee management
...
updated_at: 2025-08-29T03:47:20Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/directory-v1/employee/resources-introduction
---

# 资源定义
员工指Lark企业内身份为「Employee」的成员，等同于通讯录OpenAPI中的「User」。

员工在Lark的身份标识包括`employee_id`、`open_id` 和 `union_id`，其中`employee_id`的值等同于通讯录中的 `user_id`，其余两个也和通讯录的User的值相同。有关员工各类ID的详细介绍，参考 [用户身份概述](/document/home/user-identity-introduction/introduction)。
...
- 通过 [批量获取员工列表](/document/uAjLw4CM/ukTMukTMukTM/directory-v1/employee/filter) 的接口，通过手机号或邮箱查询员工ID。
