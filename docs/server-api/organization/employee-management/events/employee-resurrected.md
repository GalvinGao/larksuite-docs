---
document_id: '7543849381893885361'
directory_id: '7530974965350842374'
title: 离职恢复在职
full_path: /uAjLw4CM/ukTMukTMukTM/directory-v1/employee/events/resurrect
breadcrumb:
- Server API
- Organization
- Employee management
- Events
- Employee resurrected
document_type: ReferenceDocumentType
updated_at: 2025-08-29T03:47:58Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/directory-v1/employee/events/resurrect
---
...
## 注意事项
该事件有部分字段权限要求，你可以参考相应的参数描述获取参数所需的权限。只有当应用开通了相应的字段权限后，才可以成功接收到完整的事件体数据。申请权限的具体操作，参见[申请 API 权限](/document/ukTMukTMukTM/uQjN3QjL0YzN04CN2cDN)。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=directory&version=v1&resource=employee&event=resurrect)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>directory.employee.resurrect_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	用户的open_id,ID类型参见[用户身份概述](/document/home/user-identity-introduction/introduction)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	直属上级的用户open_id，了解用户 ID 可参见[用户身份概述](/document/home/user-identity-introduction/introduction)。
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	虚线上级的用户open_id，了解用户 ID 可参见[用户身份概述](/document/home/user-identity-introduction/introduction)。
...
func main() {
	...
	eventHandler := dispatcher.NewEventDispatcher("", "").
		OnP2EmployeeResurrectV1(func(ctx context.Context, event *larkdirectory.P2EmployeeResurrectV1) error {
			fmt.Printf("[ OnP2EmployeeResurrectV1 access ], data: %s\n", larkcore.Prettify(event))
			return nil
		})
...
def do_p2_directory_employee_resurrect_v1(data: lark.directory.v1.P2DirectoryEmployeeResurrectV1) -> None:
    print(f'[ do_p2_directory_employee_resurrect_v1 access ], data: {lark.JSON.marshal(data, indent=4)}')

# 注册事件 Register event
event_handler = lark.EventDispatcherHandler.builder("", "") \
    .register_p2_directory_employee_resurrect_v1(do_p2_directory_employee_resurrect_v1) \
    .build()
...
import com.lark.oapi.service.directory.v1.model.P2EmployeeResurrectV1;
...
public class Sample {
    ...
    private static final EventDispatcher EVENT_HANDLER = EventDispatcher.newBuilder("", "")
            .onP2EmployeeResurrectV1(new DirectoryService.P2EmployeeResurrectV1Handler() {
                @Override
                public void handle(P2EmployeeResurrectV1 event) throws Exception {
                    System.out.printf("[ onP2EmployeeResurrectV1 access ], data: %s\n", Jsons.DEFAULT.toJson(event.getEvent()));
                }
            })
            .build();
...
wsClient.start({
    ...
    eventDispatcher: new Lark.EventDispatcher({}).register({
        'directory.employee.resurrect_v1': async (data) => {
            console.log(data);
        }
    })
});
