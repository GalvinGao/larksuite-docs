---
document_id: '7543849381893983665'
directory_id: '7530974965350875142'
title: 更新在职员工为待离职
full_path: /uAjLw4CM/ukTMukTMukTM/directory-v1/employee/to_be_resigned
breadcrumb:
- Server API
- Organization
- Employee management
- Update un-resigned employees to be resigned
document_type: ReferenceDocumentType
updated_at: 2025-08-29T03:47:41Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/directory-v1/employee/to_be_resigned
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="directory:employee.to_be_resigned:write" desc="更新待离职员工" support_app_types="custom" tags="">更新待离职员工</md-perm> |
