---
document_id: '6999168249243369478'
directory_id: '7262980135904346117'
title: 自建应用获取 tenant_access_token
full_path: /ukTMukTMukTM/ukDNz4SO0MjL5QzM/auth-v3/auth/tenant_access_token_internal
breadcrumb:
- Server API
...
source_url: https://open.larksuite.com/document/ukTMukTMukTM/ukDNz4SO0MjL5QzM/auth-v3/auth/tenant_access_token_internal
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/auth/v3/tenant_access_token/internal</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
	...
	<md-td>
      应用唯一标识，创建应用后获得。有关`app_id` 的详细介绍。请参考[通用参数](/document/ukTMukTMukTM/uYTM5UjL2ETO14iNxkTN/terminology)介绍
...
<md-tr>
	...
	<md-td>
      应用秘钥，创建应用后获得。有关 `app_secret` 的详细介绍，请参考[通用参数](/document/ukTMukTMukTM/uYTM5UjL2ETO14iNxkTN/terminology)介绍
