...
| <md-text type="field-name" >tenant_access_token</md-text> | <md-text type="field-type" >string</md-text> | 租户访问凭证 |
| <md-text type="field-name" >expire</md-text> | <md-text type="field-type" >int</md-text> | `tenant_access_token` 的过期时间，单位为秒 |
