---
document_id: '7275609259126292486'
directory_id: '7273782524454715397'
title: 获取用户信息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/authen-v1/user_info/get
breadcrumb:
- Server API
...
updated_at: 2025-06-09T08:53:24Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/authen-v1/user_info/get
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/authen/v1/user_info</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>提供的 `user_access_token` 无效，请使用有效的 `user_access_token`。相关文档：[获取 user_access_token](/document/uAjLw4CM/ukTMukTMukTM/authentication-management/access-token/get-user-access-token)。</md-td>
</md-tr>
