...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="passport:session_mask:readonly" desc="获取用户登录信息（mask）" support_app_types="custom" tags="">获取用户登录信息（mask）</md-perm> |
