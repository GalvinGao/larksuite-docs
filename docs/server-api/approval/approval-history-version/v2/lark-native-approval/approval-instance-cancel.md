---
document_id: '6967331158355181574'
directory_id: '7122028361538797574'
title: 审批实例撤回
full_path: /ukTMukTMukTM/uYDNyUjL2QjM14iN0ITN
breadcrumb:
- Server API
- Approval
...
updated_at: 2022-07-20T09:39:12Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uYDNyUjL2QjM14iN0ITN
---

# 审批实例撤回
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/cancel)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://www.larksuite.com/approval/openapi/v2/instance/cancel</md-td>
    </md-tr>
    <md-tr>
