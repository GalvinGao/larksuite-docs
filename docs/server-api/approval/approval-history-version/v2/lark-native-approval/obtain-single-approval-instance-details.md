---
document_id: '6967331158356066310'
directory_id: '7122028361538797574'
title: 获取单个审批实例详情
full_path: /ukTMukTMukTM/uEDNyUjLxQjM14SM0ITN
breadcrumb:
- Server API
- Approval
...
- Obtain Single Approval Instance Details
document_type: GuideDocumentType
updated_at: 2024-01-16T13:16:02Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uEDNyUjLxQjM14SM0ITN
---

# 获取单个审批实例详情
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/get)
</md-alert>
:::
通过审批实例 Instance Code  获取审批实例详情。Instance Code 由 [批量获取审批实例](/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/list) 接口获取。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://www.larksuite.com/approval/openapi/v2/instance/get</md-td>
    </md-tr>
    <md-tr>
