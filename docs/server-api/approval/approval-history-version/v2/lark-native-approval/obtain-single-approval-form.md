---
document_id: '6967331158355443718'
directory_id: '7122028361538797574'
title: 查看审批定义
full_path: /ukTMukTMukTM/uADNyUjLwQjM14CM0ITN
breadcrumb:
- Server API
- Approval
...
- Obtain Single Approval Form
document_type: GuideDocumentType
updated_at: 2022-07-20T09:39:00Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uADNyUjLwQjM14CM0ITN
---

# 查看审批定义
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/get)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://www.larksuite.com/approval/openapi/v2/approval/get</md-td>
    </md-tr>
    <md-tr>
