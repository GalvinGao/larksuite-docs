---
document_id: '6967331173081382917'
directory_id: '7122028361538797574'
title: 批量获取审批实例ID
full_path: /ukTMukTMukTM/uQDOyUjL0gjM14CN4ITN
breadcrumb:
- Server API
- Approval
...
- Batch Obtain Approval Instance IDs
document_type: GuideDocumentType
updated_at: 2022-07-20T09:39:08Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uQDOyUjL0gjM14CN4ITN
---

# 批量获取审批实例
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/list)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://www.larksuite.com/approval/openapi/v2/instance/list</md-td>
    </md-tr>
    <md-tr>
