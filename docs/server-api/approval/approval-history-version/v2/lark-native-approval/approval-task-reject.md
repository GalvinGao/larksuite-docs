---
document_id: '6967331158355656710'
directory_id: '7122028361538797574'
title: 审批任务拒绝
full_path: /ukTMukTMukTM/uQDNyUjL0QjM14CN0ITN
breadcrumb:
- Server API
- Approval
...
updated_at: 2022-07-20T09:39:17Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uQDNyUjL0QjM14CN0ITN
---

# 审批任务拒绝
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/reject)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://www.larksuite.com/approval/openapi/v2/instance/reject</md-td>
    </md-tr>
    <md-tr>
