---
document_id: '6967331173082169349'
directory_id: '7122028361538895878'
title: 创建审批定义
full_path: /ukTMukTMukTM/uUzNyYjL1cjM24SN3IjN
breadcrumb:
- Server API
- Approval
...
updated_at: 2024-01-16T13:16:05Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUzNyYjL1cjM24SN3IjN
---

# 创建审批定义
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/create)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://www.larksuite.com/approval/openapi/v2/approval/create</md-td>
    </md-tr>
    <md-tr>
...
[控件支持设置默认值 open api 说明文档](https://bytedance.larkoffice.com/docx/doxcndQPK28SEzQTWyeTajWKO2d)
...
case2: 联动外部数据源单选/多选：[【关联外部选项说明】](/document/ukTMukTMukTM/uADM4QjLwADO04CMwgDN)
```
{
    "id":"",
    "name":"",
...
![图片名称](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/5bb25389e4d480e45335ab363d45e2e6_bTjx4RQOE7.png?height=564&lazyload=true&width=564)
### 响应体示例
