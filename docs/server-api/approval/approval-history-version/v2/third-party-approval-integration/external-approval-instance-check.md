---
document_id: '6967331158356328454'
directory_id: '7122028361538912262'
title: 三方审批实例校验
full_path: /ukTMukTMukTM/uUDNyYjL1QjM24SN0IjN
breadcrumb:
- Server API
- Approval
...
- External Approval Instance Check
document_type: GuideDocumentType
updated_at: 2022-07-20T09:39:27Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDNyYjL1QjM24SN0IjN
---

# 三方审批实例校验
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/external_instance/check)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://www.larksuite.com/approval/openapi/v3/external/instance/check</md-td>
    </md-tr>
    <md-tr>
