---
document_id: '6967331158356295686'
directory_id: '7122028361538928646'
title: 实例列表查询
full_path: /ukTMukTMukTM/uQjMxYjL0ITM24CNyEjN
breadcrumb:
- Server API
- Approval
...
updated_at: 2022-07-20T09:39:34Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uQjMxYjL0ITM24CNyEjN
---

# 实例列表查询
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/query)
</md-alert>
:::
