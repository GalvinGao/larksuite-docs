---
document_id: '7026247042947334150'
directory_id: '7186908899420782597'
title: 出差审批
full_path: /ukTMukTMukTM/uIDO24iM4YjLygjN/event/business-trip
breadcrumb:
- Server API
- Approval
- Approval Events
...
updated_at: 2023-02-15T03:03:54Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uIDO24iM4YjLygjN/event/business-trip
---
...
func main() {
	...
	eventHandler := dispatcher.NewEventDispatcher("", "").
		OnCustomizedEvent("trip_approval", func(ctx context.Context, event *larkevent.EventReq) error {
...
event_handler = lark.EventDispatcherHandler.builder("", "") \
    .register_p1_customized_event("trip_approval", do_customized_event) \
    .build()
...
public class Sample {
    ...
    private static final EventDispatcher EVENT_HANDLER = EventDispatcher.newBuilder("", "")
            .onCustomizedEvent("trip_approval", new CustomEventHandler() {
                @Override
