---
document_id: '7026247042947661830'
directory_id: '7186908899420782597'
title: 请假审批
full_path: /ukTMukTMukTM/uIDO24iM4YjLygjN/event/leave
breadcrumb:
- Server API
- Approval
- Approval Events
...
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uIDO24iM4YjLygjN/event/leave
---
...
```json
{
     ...
     "event": {
         ...
         "origin_instance_code":"xxxx" // 销假单关联的原始单据
         "start_time": 1564590532,  // 审批发起时间
         "end_time": 1564590532, // 审批结束时间
         "leave_feeding_arrive_late": 0, //上班晚到（哺乳假相关）
         "leave_feeding_leave_early": 0, //下班早走（哺乳假相关）
         "leave_feeding_rest_daily": 0, //每日休息（哺乳假相关）
