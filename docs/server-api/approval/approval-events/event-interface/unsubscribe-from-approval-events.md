---
document_id: '7122386910857625606'
directory_id: '7186908899420848133'
title: 取消订阅审批事件
full_path: /uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/unsubscribe
breadcrumb:
- Server API
- Approval
- Approval Events
...
updated_at: 2023-02-15T03:03:48Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/unsubscribe
---

# 取消订阅审批事件

取消订阅 approval_code 后，无法再收到该审批定义对应实例的事件通知{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=approval&method=unsubscribe)
