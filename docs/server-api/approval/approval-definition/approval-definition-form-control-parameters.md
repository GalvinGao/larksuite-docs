---
document_id: '7560600383257791924'
directory_id: '7122028361538945030'
title: 审批定义表单控件参数
full_path: /uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/approval-definition-form-control-parameters
breadcrumb:
- Server API
- Approval
- Approval definition
...
updated_at: 2025-10-13T07:10:57Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/approval-definition-form-control-parameters
---

# 审批定义表单控件参数

在[创建审批定义](/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/create)、[查看指定审批定义](/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/get)接口内，需要使用 form 参数，即审批定义的表单控件 JSON 数据。本文汇总了各表单控件 JSON 数据中的参数说明，供你参考。

## 审批定义 API 不支持的控件

审批定义 API 未完全支持调用所有的审批表单控件，不支持的控件如下表所示。如果你必须使用 API 不支持的控件，则需前往[Lark审批管理后台](https://www.larksuite.com/approval/admin/approvalList?devMode=on)进进行操作。
...
### 请假控件组
![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/fd675da7bfe8f7f36b2937a0310647c3_r3ARmNVcXa.png?height=1632&lazyload=true&width=2194)
...
关联加班规则时，无加班类型
![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/55af2e2a472e491a1565b741c3746de8_0tfT2m3vPV.png?height=1040&lazyload=true&width=2180)

未关联加班规则时可设置加班类型以及关联的假期类型
![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/1897098a1b21d23aec626a9d3ab02954_yfOYKSlwJo.png?height=1346&lazyload=true&width=2186)
...
### 外出控件组
设置外出类型
![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/e9f5dc7e447c378ab2ccf00e2b8f9073_QDCMEHSeBX.png?height=1184&lazyload=true&width=2182)
未设置外出类型
![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/0717c9b74ef51a597c749e782767bc70_Zo4DWvjfGw.png?height=1106&lazyload=true&width=2198)
