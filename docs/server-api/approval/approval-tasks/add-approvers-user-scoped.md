---
document_id: '7651477917848882615'
directory_id: '7072711453267181573'
title: 审批任务加签（用户级）
full_path: /uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/add_sign
breadcrumb:
- Server API
- Approval
- Approval tasks
- Add approvers(user-scoped)
document_type: ReferenceDocumentType
updated_at: 2026-06-15T04:55:53Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/add_sign
---

# 加签审批任务

通过调用该接口在当前节点增加审批人{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=task&method=add_sign)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/approval/v4/tasks/add_sign</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="approval:task:write" desc="处理审批任务" support_app_types="custom,isv" tags="">处理审批任务</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >add_sign_user_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >add_sign_type</md-text>
	</md-dt-td>
	<md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >前加签</md-enum-item>
<md-enum-item key="2" >后加签</md-enum-item>
<md-enum-item key="3" >并加签</md-enum-item>
</md-enum>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >approval_method</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >或签</md-enum-item>
<md-enum-item key="2" >会签</md-enum-item>
<md-enum-item key="3" >依次审批</md-enum-item>
</md-enum>
...
<md-tr>
  ...
  <md-td>参数错误。检查各项枚举值是否在范围内</md-td>
</md-tr>
