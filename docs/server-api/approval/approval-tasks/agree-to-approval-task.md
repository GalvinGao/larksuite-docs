---
document_id: '7122386910857494534'
directory_id: '7072711453267181573'
title: 同意审批任务
full_path: /uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/approve
breadcrumb:
- Server API
- Approval
- Approval tasks
- Agree to approval task
document_type: ReferenceDocumentType
updated_at: 2023-01-31T12:16:45Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/approve
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/approval/v4/tasks/approve</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	json 数组，控件值（如果缺少控件，会影响后续分支条件流转）
