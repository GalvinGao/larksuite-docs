---
document_id: '7651477917848833463'
directory_id: '7072711453267181573'
title: 查询审批任务列表
full_path: /uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/list
breadcrumb:
- Server API
- Approval
- Approval tasks
...
updated_at: 2026-06-15T04:55:29Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/list
---

# 获取审批任务列表

通过设置任务分组、审批定义 Code（审批流程的唯一标识）等，查询任务列表。任务分组包括待办审批、已办审批等{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=task&method=list)
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/approval/v4/tasks |
| HTTP Method | GET |
| 接口频率限制 | [1000 次/分钟、50 次/秒](/document/ukTMukTMukTM/uUzN04SN3QjL1cDN) |
| 支持的应用类型 | <md-app-support types="custom,isv"></md-app-support> |
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="approval:task:read" desc="获取任务基本信息" support_app_types="custom,isv" tags="">获取任务基本信息</md-perm> |
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >uat_task\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	任务列表
	</md-dt-td>
...
<md-enum-item key="3" >已发起</md-enum-item>
<md-enum-item key="17" >未读知会</md-enum-item>
<md-enum-item key="18" >已读知会</md-enum-item>
</md-enum>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >summaries</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >pair\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	摘要
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >support_api_operate</md-text>
	</md-dt-td>
	<md-dt-td>
