---
document_id: '7122386910857445382'
directory_id: '7122028361538961414'
title: 清空评论
full_path: /uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance-comment/remove
breadcrumb:
- Server API
- Approval
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance-comment/remove
---

# 清空评论

删除某审批实例下的全部评论与评论回复。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=instance.comment&method=remove)
