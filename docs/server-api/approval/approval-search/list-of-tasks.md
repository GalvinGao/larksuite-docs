---
document_id: '7122386910857658374'
directory_id: '7122028361538977798'
title: 查询任务列表
full_path: /uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/search
breadcrumb:
- Server API
- Approval
- Approval search
...
updated_at: 2023-02-20T07:40:19Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/search
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/approval/v4/tasks/search</md-td>
    </md-tr>
    <md-tr>
...
<md-enum-item key="TRANSFERRED" >转交</md-enum-item>
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >按update_time倒排</md-enum-item>
<md-enum-item key="1" >按update_time正排</md-enum-item>
<md-enum-item key="2" >按start_time倒排</md-enum-item>
<md-enum-item key="3" >按start_time正排</md-enum-item>
</md-enum>
...
<md-enum-item key="pending" >审批中</md-enum-item>
<md-enum-item key="recall" >撤回</md-enum-item>
