---
document_id: '7651477917848898999'
directory_id: '7122028361539026950'
title: 获取单个审批实例详情（用户级）
full_path: /uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/detail
breadcrumb:
- Server API
- Approval
- Approval instances
- Obtain details of an approval instance (user-scoped)
document_type: ReferenceDocumentType
updated_at: 2026-06-15T04:55:19Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/detail
---

# 获取单个审批实例详情

通过审批实例 Code 获取指定审批实例的详细信息，包括审批实例的名称、创建时间、发起审批的用户、状态以及任务列表等信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=instance&method=detail)
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/approval/v4/instances/detail |
| HTTP Method | GET |
| 接口频率限制 | [1000 次/分钟、50 次/秒](/document/ukTMukTMukTM/uUzN04SN3QjL1cDN) |
| 支持的应用类型 | <md-app-support types="custom,isv"></md-app-support> |
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="approval:instance:read" desc="获取审批实例详情" support_app_types="custom,isv" tags="">获取审批实例详情</md-perm> |
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >uat_instance_task\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	审批任务列表
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >uat_instance_comment\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	评论列表
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >operation_records</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >uat_instance_timeline\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	审批动态
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >current_nodes</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >uat_current_node\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	当前审批节点
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >uat_task_user\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	当前节点审批人
	</md-dt-td>
