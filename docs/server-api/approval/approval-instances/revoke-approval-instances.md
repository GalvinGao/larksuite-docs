---
document_id: '7122386910857478150'
directory_id: '7122028361539026950'
title: 撤回审批实例
full_path: /uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/cancel
breadcrumb:
- Server API
- Approval
- Approval instances
- Revoke approval instances
document_type: ReferenceDocumentType
updated_at: 2023-01-31T12:16:38Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/cancel
---

# 撤回审批实例

对于状态为“审批中”的单个审批实例进行撤销操作，撤销后审批流程结束。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=instance&method=cancel)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/approval/v4/instances/cancel</md-td>
    </md-tr>
    <md-tr>
