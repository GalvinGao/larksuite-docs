---
document_id: '7651477917848767927'
directory_id: '7122028361539026950'
title: 查询用户的已发起审批列表
full_path: /uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/initiated
breadcrumb:
- Server API
- Approval
- Approval instances
- Query the user's list of initiated approvals
document_type: ReferenceDocumentType
updated_at: 2026-06-15T04:55:24Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/initiated
---

# 获取用户已发起审批列表

以用户身份获取用户已发起的审批列表，与Lark中审批->审批中心->已发起一致{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=instance&method=initiated)
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/approval/v4/instances/initiated |
| HTTP Method | GET |
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >uat_instance\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	任务列表
	</md-dt-td>
