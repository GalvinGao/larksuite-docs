---
document_id: '7122386910857641990'
directory_id: '7122028361539026950'
title: 抄送审批实例
full_path: /uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/cc
breadcrumb:
- Server API
- Approval
- Approval instances
- Notify someone of approval instances
document_type: ReferenceDocumentType
updated_at: 2023-01-31T12:16:38Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/cc
---

# 抄送审批实例

通过接口可以将当前审批实例抄送给其他人。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=instance&method=cc)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/approval/v4/instances/cc</md-td>
    </md-tr>
    <md-tr>
