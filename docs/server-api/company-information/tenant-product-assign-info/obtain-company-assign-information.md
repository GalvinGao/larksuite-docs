...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="tenant:tenant.product_assign_info:read" desc="查询租户下的席位信息" support_app_types="custom,isv" tags="">查询租户下的席位信息</md-perm> |
