---
document_id: '7202134458371227654'
directory_id: '7202134415571468294'
title: 获取妙记统计数据
full_path: /uAjLw4CM/ukTMukTMukTM/minutes-v1/minute-statistics/get
breadcrumb:
- Server API
- Minutes
- Minutes statistics
...
updated_at: 2025-06-16T03:29:10Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/minutes-v1/minute-statistics/get
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="minutes:minutes" desc="查看、创建、编辑及管理妙记文件" support_app_types="custom,isv" tags="">查看、创建、编辑及管理妙记文件</md-perm><br><md-perm name="minutes:minutes:readonly" desc="查看妙记文件" support_app_types="custom,isv" tags="">查看妙记文件</md-perm><br><md-perm name="minutes:minutes.statistics:read" desc="获取妙记的统计信息" support_app_types="custom" tags="">获取妙记的统计信息</md-perm> |
