---
document_id: '7132687771718025221'
directory_id: '7072190414392459270'
title: 获取知识空间信息
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space/get
breadcrumb:
- Server API
- Docs
- Wiki
...
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space/get
---
...
- 私有空间：仅对知识空间管理员、成员可见，需要手动添加管理员、成员。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=wiki&version=v2&resource=space&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/wiki/v2/spaces/:space_id</md-td>
    </md-tr>
    <md-tr>
