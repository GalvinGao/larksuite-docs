---
document_id: '7132687771718090757'
directory_id: '7072190414392311814'
title: 获取节点信息
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space/get_node
breadcrumb:
- Server API
- Docs
- Wiki
...
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space/get_node
---

# 获取节点信息

获取节点信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=wiki&version=v2&resource=space&method=get_node)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/wiki/v2/spaces/get_node</md-td>
    </md-tr>
    <md-tr>
