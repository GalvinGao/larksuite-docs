---
document_id: '7132687771717992453'
directory_id: '7072190414392311814'
title: 创建节点副本
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-node/copy
breadcrumb:
- Server API
- Docs
- Wiki
...
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-node/copy
---

# 创建节点副本

此接口用于创建节点副本到指定地点。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=wiki&version=v2&resource=space.node&method=copy)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/wiki/v2/spaces/:space_id/nodes/:node_token/copy</md-td>
    </md-tr>
    <md-tr>
...
<md-code-json>
{
    "target_parent_token": "wikcnKQ1k3pcuo5uSK4t8Vabcef",
