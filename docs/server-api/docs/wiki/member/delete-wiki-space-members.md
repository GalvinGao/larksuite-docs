---
document_id: '7132687771717959685'
directory_id: '7072190414392442886'
title: 删除知识空间成员
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-member/delete
breadcrumb:
- Server API
- Docs
- Wiki
- member
- Delete Wiki space members
document_type: ReferenceDocumentType
updated_at: 2022-08-17T03:51:24Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-member/delete
---
...
- 个人知识空间 （type为person）为个人管理的知识空间，不支持删除管理员。但可以删除成员。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=wiki&version=v2&resource=space.member&method=delete)
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/wiki/v2/spaces/:space_id/members/:member_id |
| HTTP Method | DELETE |
