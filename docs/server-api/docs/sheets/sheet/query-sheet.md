---
document_id: '7344925300319141894'
directory_id: '7072290825036939270'
title: 查询工作表
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/get
breadcrumb:
- Server API
- Docs
- Sheets
...
updated_at: 2024-03-11T04:16:29Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/get
---

# 查询工作表

该接口用于通过工作表ID查询工作表属性信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=sheets&version=v3&resource=spreadsheet.sheet&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/sheets/v3/spreadsheets/:spreadsheet_token/sheets/:sheet_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	表格的token，获取方式见[如何获取云文档资源相关 token](/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN)

**示例值**："xxxxxxxxxxxxxxxxx"
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	工作表的id，获取方式见[获取工作表](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/query)
...
### 请求示例
```bash
curl --location --request GET 'https://open.larksuite.com/open-apis/sheets/v3/spreadsheets/shtcnmBA*****yGehy8/sheets/0354d1' \
...
<md-dt-tr level="2">
	...
	工作表类型
- `sheet`：工作表
- `bitable`：多维表格，[多维表格概述](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/bitable-overview)
...
<md-tr>
  ...
  <md-td>服务内部错误，[详询客服](https://applink.larksuite.com/client/helpdesk/open?id=6626260912531570952)</md-td>
</md-tr>
