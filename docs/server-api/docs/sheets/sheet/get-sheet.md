---
document_id: '7344925300319125510'
directory_id: '7072290825036939270'
title: 获取工作表
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/query
breadcrumb:
- Server API
- Docs
- Sheets
...
updated_at: 2024-03-11T04:16:28Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/query
---

# 获取工作表

该接口用于获取电子表格下所有工作表及其属性。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=sheets&version=v3&resource=spreadsheet.sheet&method=query)
...
| 500 | 1315210 | Server Error | 服务内部错误，[详询客服](https://applink.larksuite.com/client/helpdesk/open?id=6626260912531570952) |
