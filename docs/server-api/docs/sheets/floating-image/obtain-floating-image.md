---
document_id: '7073817463670587398'
directory_id: '7072290825036890118'
title: 获取浮动图片
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-float_image/get
breadcrumb:
- Server API
- Docs
- Sheets
- Floating image
- Obtain Floating Image
document_type: ReferenceDocumentType
updated_at: 2022-09-29T10:54:58Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-float_image/get
---

# 获取浮动图片

根据 float_image_id 获取对应浮动图片的信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=sheets&version=v3&resource=spreadsheet.sheet.float_image&method=get)
...
```
curl --location --request GET 'https://open.larksuite.com/open-apis/sheets/v3/spreadsheets/shtbchuIXPxjaYxsZzQxBqPxxxxx/sheets/ea131a/float_images/ye06SS14p' \
...
| 500 | 1315202 | Server Error | 服务内部错误，详询客服 |
