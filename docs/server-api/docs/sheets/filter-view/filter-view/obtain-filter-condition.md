---
document_id: '7073817463670833158'
directory_id: '7072290825037004806'
title: 获取筛选条件
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view-condition/get
breadcrumb:
- Server API
- Docs
- Sheets
...
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view-condition/get
---

# 获取筛选条件

获取筛选视图某列的筛选条件信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=sheets&version=v3&resource=spreadsheet.sheet.filter_view.condition&method=get)
...
:::html
<md-alert type="tip">
筛选条件含义参考 [筛选视图的筛选条件指南](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view-condition/filter-view-condition-user-guide)
</md-alert>
:::
