---
document_id: '7073817463670718470'
directory_id: '7072290825036972038'
title: 查询筛选视图
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view/query
breadcrumb:
- Server API
- Docs
- Sheets
...
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view/query
---

# 查询筛选视图

查询子表内所有的筛选视图基本信息，包括 id、name 和 range{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=sheets&version=v3&resource=spreadsheet.sheet.filter_view&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/sheets/v3/spreadsheets/:spreadsheet_token/sheets/:sheet_id/filter_views/query</md-td>
    </md-tr>
    <md-tr>
