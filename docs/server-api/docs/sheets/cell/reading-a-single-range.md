---
document_id: '6967331173081464837'
directory_id: '6956134701804355590'
title: 读取单个范围
full_path: /ukTMukTMukTM/ugTMzUjL4EzM14COxMTN
breadcrumb:
- Server API
- Docs
- Sheets
...
updated_at: 2022-03-11T12:23:14Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/ugTMzUjL4EzM14COxMTN
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/sheets/v2/spreadsheets/:spreadsheetToken/values/:range </md-td>
    </md-tr>
    <md-tr>
...
|参数|类型|必须|说明|
|--|-----|--|----|
|spreadsheetToken|string|是| spreadsheet 的 token，详见电子表格[概述](/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/overview)|
| range                | string | 是   | 查询范围，包含 sheetId 与单元格范围两部分，详见[在线表格开发指南](/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/overview) | 
...
| dateTimeRenderOption | string | 否   | dateTimeRenderOption=FormattedString 计算并对时间日期按照其格式进行格式化，但不会对数字进行格式化，返回格式化后的字符串。详见[电子表格常见问题](/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/guide/sheets-faq) |
...
|spreadsheetToken|string | spreadsheet 的 token，详见电子表格[概述](/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/overview)|
|valueRange||值与范围|
