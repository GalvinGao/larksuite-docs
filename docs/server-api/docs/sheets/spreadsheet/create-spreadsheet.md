---
document_id: '7073817463670652934'
directory_id: '7072290825036955654'
title: 创建表格
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet/create
breadcrumb:
- Server API
- Docs
- Sheets
...
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet/create
---

# 创建表格

使用该接口可以在指定的目录下创建在线表格。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=sheets&version=v3&resource=spreadsheet&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/sheets/v3/spreadsheets</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	文件夹token，获取方式见[概述](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/files/guide/introduction)
