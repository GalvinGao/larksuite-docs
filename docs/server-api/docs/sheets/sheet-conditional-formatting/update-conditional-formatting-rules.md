---
document_id: '6967331173081661445'
directory_id: '6931268519897120795'
title: 更新条件格式
full_path: /ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/conditionformat/condition-format-update
breadcrumb:
- Server API
- Docs
- Sheets
...
updated_at: 2022-03-11T12:22:30Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/conditionformat/condition-format-update
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/sheets/v2/spreadsheets/:spreadsheetToken/condition_formats/batch_update</md-td>
    </md-tr>
    <md-tr>
...
| 参数                            |类型|必需| 说明                                       |
| ----------------------------- |-----|----| ---------------------------------------- |
|sheet_condition_formats||是|表格的条件格式信息|
| &emsp;∟sheet_id                      |string|是| sheet的id                                 |
| &emsp;∟condition_format              ||是| 一个条件格式的详细信息                              |
| &emsp;&emsp;∟cf_id                  |string|是| 需要更新的条件格式id，会校验id是否存在                    |
...
| &emsp;&emsp;∟attrs                  || 是| rule_type对应的具体属性信息，详见 [条件格式指南](/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/conditionformat/condition-format-guide) |
...
###  cURL 请求示例
```
curl --location --request POST 'https://open.larksuite.com/open-apis/sheets/v2/spreadsheets/shtcngNygNfuqhxTBf588jwgWbJ/condition_formats/batch_update' \
...
| &emsp;∟cf_id    |string| 更新的条件格式id                    |
| &emsp;∟res_code |int| 条件格式更新状态码，0表示成功，非0表示失败       |
| &emsp;∟res_msg  |string| 条件格式更新返回的状态信息，空表示成功，不空表示失败原因 |
