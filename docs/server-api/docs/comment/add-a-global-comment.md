---
document_id: '7031483915610390533'
directory_id: '6916344277300674561'
title: 添加全文评论
full_path: /uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment/create
breadcrumb:
- Server API
- Docs
- Comment
...
updated_at: 2024-03-13T03:53:05Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment/create
---
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/drive/v1/files/:file_token/comments |
| HTTP Method | POST |
...
**示例值**："https://example.larksuite.com/docs/doccnHh7U87HOFpii5u5Gabcef"
	</md-dt-td>
</md-dt-tr>
