---
document_id: '7643718224995388852'
directory_id: '7491887374051377158'
title: 创建节点
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/board-v1/whiteboard-node/create
breadcrumb:
- Server API
- Docs
- Board
...
updated_at: 2026-05-25T08:16:23Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/board-v1/whiteboard-node/create
---
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	图片 token，通过云文档下的素材上传接口 [上传素材](/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/media/upload_all) 上传图片后返回的 token
...
<md-tr>
  ...
  <md-td>找不到记录。whiteboard_id 不存在，请检查传入的whiteboard_id是否正确；或通过云文档下的文档接口[获取文档所有块](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/list)确认该画板是否存在</md-td>
</md-tr>
