...
| 400 | 2890003 | record missing | 找不到记录。whiteboard_id 不存在，请检查传入的whiteboard_id是否正确；或通过云文档下的文档接口[获取文档所有块](/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/list)确认该画板是否存在 |
