---
document_id: '7242158539798888454'
directory_id: '7239713799464452102'
title: 删除文档版本
full_path: /uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-version/delete
breadcrumb:
- Server API
- Docs
- Space
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-version/delete
---

# 删除文档版本

删除文档版本。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=file.version&method=delete)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	版本文档token，如何获取文档Token可以参考[如何获取云文档相关token](/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
