---
document_id: '7242158539798921222'
directory_id: '7239713799464452102'
title: 获取文档版本列表
full_path: /uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-version/list
breadcrumb:
- Server API
- Docs
- Space
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-version/list
---

# 获取文档版本列表

获取文档所有版本。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=file.version&method=list)
