---
document_id: '7651837792632786359'
directory_id: '7651836358944116150'
title: 添加评论、回复通知事件
full_path: /uAjLw4CM/ukTMukTMukTM/reference/drive-v1/notice/events/comment_add
breadcrumb:
- Server API
- Docs
- Space
- Event
- User cloud document event
- Comment event
document_type: ReferenceDocumentType
updated_at: 2026-06-16T08:52:55Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/notice/events/comment_add
---
...
:::html
<md-alert type="tip">
了解事件订阅的使用场景和配置流程，参考[事件订阅概述](/document/ukTMukTMukTM/uUTNz4SN1MjL1UzM)。
</md-alert>
:::

## 说明

- 用户身份订阅需要先调[订阅用户云文档事件](/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/user/subscription)接口，应用身份无需调用。

- 该事件通知逻辑和文档中评论通知逻辑一致，即用户在Lark APP中能收到该通知才能收到对应的事件通知。
...
| 权限要求<br><md-tooltip type="info">订阅该事件所需的权限，开启其中任意一项权限即可订阅</md-tooltip> | <md-perm name="docs:document.comment:read" desc="获取云文档中的评论" support_app_types="custom,isv" tags="">获取云文档中的评论</md-perm> |
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >notice_meta</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >notice</md-text>
	</md-dt-td>
	<md-dt-td>
	通知元信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >notice_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="add_comment" >添加评论</md-enum-item>
<md-enum-item key="add_reply" >添加回复</md-enum-item>
</md-enum>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >is_mentioned</md-text>
	</md-dt-td>
	<md-dt-td>
