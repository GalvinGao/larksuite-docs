---
document_id: '7597653420037066165'
directory_id: '7148629329634656262'
title: 文件夹下文件创建
full_path: /uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file/events/created_in_folder
breadcrumb:
- Server API
- Docs
- Space
...
updated_at: 2026-01-21T08:18:13Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file/events/created_in_folder
---
...
| 权限要求<br><md-tooltip type="info">订阅该事件所需的权限，开启其中任意一项权限即可订阅</md-tooltip> | <md-perm name="space:document.event:read" desc="订阅文件夹下的文件相关事件" support_app_types="custom,isv" tags="">订阅文件夹下的文件相关事件</md-perm> |
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	文件夹 Token。获取方式见[文件夹概述](/document/ukTMukTMukTM/ugTNzUjL4UzM14CO1MTN/folder-overview)
