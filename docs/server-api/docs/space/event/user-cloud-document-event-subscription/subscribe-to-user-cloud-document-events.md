---
document_id: '7651837792632802743'
directory_id: '7651481849587355061'
title: 订阅用户云文档事件
full_path: /uAjLw4CM/ukTMukTMukTM/reference/drive-v1/user/subscription
breadcrumb:
- Server API
- Docs
- Space
...
- Subscribe to user cloud document events
document_type: ReferenceDocumentType
updated_at: 2026-06-16T08:52:44Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/user/subscription
---

# 订阅用户云文档事件

订阅用户云文档的各类通知事件，调用后目前可获取接收者视角的云文档评论、回复添加事件。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=user&method=subscription)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/drive/v1/user/subscription</md-td>
    </md-tr>
    <md-tr>
