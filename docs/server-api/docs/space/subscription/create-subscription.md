---
document_id: '7073817463670816774'
directory_id: '7072190414392475654'
title: 创建订阅
full_path: /uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-subscription/create
breadcrumb:
- Server API
- Docs
- Space
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-subscription/create
---
...
| <md-text type="field-name" >subscription_type</md-text> | <md-text type="field-type" >string</md-text> | 是 | 订阅类型<br>**示例值**："comment_update"<br>**可选值有**：<br>- `comment_update`：评论更新 |
...
| &emsp;<span style="color: #8F959E">∟</span>&nbsp;<md-text type="field-name" >subscription</md-text> | <md-text type="field-type" >file.subscription</md-text> | 本次增加的文档订阅信息 |
