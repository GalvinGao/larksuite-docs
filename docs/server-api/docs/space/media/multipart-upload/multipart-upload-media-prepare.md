---
document_id: '7028022131297140741'
directory_id: '7026914612429045765'
title: 分片上传素材（预上传）
full_path: /uAjLw4CM/ukTMukTMukTM/reference/drive-v1/media/upload_prepare
breadcrumb:
- Server API
- Docs
- Space
- Media
- Multipart Upload
- Multipart Upload Media (Prepare)
document_type: ReferenceDocumentType
updated_at: 2022-03-13T13:40:22Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/media/upload_prepare
---

# 

{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=media&method=upload_prepare)
