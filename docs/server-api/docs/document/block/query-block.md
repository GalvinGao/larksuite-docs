---
document_id: '7104193248416710662'
directory_id: '7072949713020534789'
title: 获取块
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/get
breadcrumb:
- Server API
- Docs
- Document
...
updated_at: 2023-12-27T03:39:30Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/get
---

# 获取块

获取指定块的富文本内容。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=docx&version=v1&resource=document.block&method=get)
