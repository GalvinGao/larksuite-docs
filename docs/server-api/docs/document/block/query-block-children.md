---
document_id: '7104193248416727046'
directory_id: '7072949713020534789'
title: 获取所有子块
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block-children/get
breadcrumb:
- Server API
- Docs
- Document
...
updated_at: 2023-12-27T03:39:38Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block-children/get
---

# 获取所有子块

给定一个指定版本的文档，并指定需要操作的块，分页遍历其所有子块富文本内容 。如果不指定版本，则会默认查询最新版本。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=docx&version=v1&resource=document.block.children&method=get)
                    ...
                    "elements": [
                        {
                            "text_run": {
                                ...
                                "text_element_style": {
                                    "link": {
                                        "url": "https%3A%2F%2Fexample.larksuite.com%2Fdrive%2Fhome%2F"
                                    }
                                }
                            }
                        }
