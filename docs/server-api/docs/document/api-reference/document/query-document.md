---
document_id: '7104193248416628742'
directory_id: '7072949713020567557'
title: 获取文档基本信息
full_path: /ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document/get
breadcrumb:
- Server API
- Docs
- Document
...
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document/get
---

# 获取文档基本信息

获取文档最新版本号、标题等{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=docx&version=v1&resource=document&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/docx/v1/documents/:document_id</md-td>
    </md-tr>
    <md-tr>
