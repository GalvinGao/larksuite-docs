---
document_id: '7031483915610537989'
directory_id: '7031445675032182789'
title: 更新协作者权限
full_path: /uAjLw4CM/ukTMukTMukTM/reference/drive-v1/permission-member/update
breadcrumb:
- Server API
- Docs
- Permission
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/permission-member/update
---

# 更新协作者权限

该接口用于根据 filetoken 更新文档协作者的权限。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=permission.member&method=update)
...
:::html
<md-alert type="warn">
该接口要求文档协作者已存在，如还未对文档协作者授权请先调用[「增加权限」 ](/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/permission-member/create)接口进行授权。
</md-alert>
:::
...
| <md-text type="field-name" >member_id</md-text> | <md-text type="field-type" >string</md-text> | 权限成员的ID，与`member_type`相对应<br>**示例值**："ou_7dab8a3d3cdcc9da365777c7ad535d62" |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| <md-text type="field-name" >need_notification</md-text> | <md-text type="field-type" >boolean</md-text> | 否 | 更新权限后是否通知对方<br>**注意：** 使用`tenant_access_token`访问不支持该参数<br>**示例值**：false<br>**默认值**：`false` |
...
| &emsp;<span style="color: #8F959E">∟</span>&nbsp;<md-text type="field-name" >member</md-text> | <md-text type="field-type" >member</md-text> | 本次更新权限的用户信息 |
