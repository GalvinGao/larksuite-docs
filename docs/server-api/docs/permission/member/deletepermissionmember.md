...
| <md-text type="field-name" >member_type</md-text> | <md-text type="field-type" >string</md-text> | 是 | 权限成员类型，放于query参数中，如：`?member_type=openid`<br>**示例值**："openid"<br>**可选值有**：<br>- `email`：邮箱地址<br>- `openid`：[开放平台ID](/document/home/user-identity-introduction/how-to-get)<br>- `openchat`：[开放平台群组](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-id-description)<br>- `opendepartmentid`：[开放平台部门ID](/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/field-overview)<br>- `userid`：[用户自定义ID](/document/home/user-identity-introduction/how-to-get) |
