---
document_id: '7450311922111021068'
directory_id: '7449007939756933126'
title: 更新自动化流程状态
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-workflow/update
breadcrumb:
- Server API
- Docs
- Base
...
updated_at: 2026-02-12T02:49:29Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-workflow/update
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/workflows/:workflow_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	自动化工作流 ID，通过[列出自动化流程](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-workflow/list)接口获取。
...
<md-tr>
  ...
  <md-td>序列化错误，请联系[技术支持](https://applink.larksuite.com/TLJpeNdW)
