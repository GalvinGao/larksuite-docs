---
document_id: '7600977756066729396'
directory_id: '7120048623526150149'
title: 升级表单
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-form/upgrade
breadcrumb:
- Server API
- Docs
- Base
...
updated_at: 2026-03-03T11:46:13Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-form/upgrade
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/tables/:table_id/forms/:form_id/upgrade</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>view_id 错误，请检查view_id是否正确，获取方式参考[列出视图](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-view/list)接口或多维表格URL</md-td>
</md-tr>
