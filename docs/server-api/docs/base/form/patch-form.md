---
document_id: '7124599384189730822'
directory_id: '7120048623526150149'
title: 更新表单元数据
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-form/patch
breadcrumb:
- Server API
- Docs
- Base
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-form/patch
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/tables/:table_id/forms/:form_id</md-td>
    </md-tr>
    <md-tr>
