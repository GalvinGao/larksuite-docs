---
document_id: '7073819570391171077'
directory_id: '7072190414392360966'
title: 删除多条记录
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/batch_delete
breadcrumb:
- Server API
- Docs
- Base
...
updated_at: 2026-03-12T13:49:16Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/batch_delete
---

# 删除多条记录

删除多维表格数据表中现有的多条记录，单次调用中最多删除 500 条记录。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table.record&method=batch_delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/batch_delete</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	删除的多条记录 ID 列表。通过[查询记录](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/search)接口获取。
