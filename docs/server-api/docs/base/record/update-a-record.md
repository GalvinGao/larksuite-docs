...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/:record_id</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>1254304</md-td>
  <md-td>Permission denied.</md-td>
  <md-td>权限不足。请检查多维表格是否开启了高级权限，如果开启高级权限，调用身份需要有多维表格的可管理权限。详情参考[如何为应用或用户开通文档权限](/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#16c6475a)</md-td>
</md-tr>
