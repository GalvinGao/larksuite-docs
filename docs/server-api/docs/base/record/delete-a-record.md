---
document_id: '7073819570391351301'
directory_id: '7072190414392360966'
title: 删除记录
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/delete
breadcrumb:
- Server API
- Docs
- Base
...
updated_at: 2026-03-12T13:49:10Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/delete
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="base:record:delete" desc="删除记录" support_app_types="custom,isv" tags="">删除记录</md-perm><br><md-perm name="bitable:app" desc="查看、评论、编辑和管理多维表格" support_app_types="custom,isv" tags="">查看、评论、编辑和管理多维表格</md-perm> |
