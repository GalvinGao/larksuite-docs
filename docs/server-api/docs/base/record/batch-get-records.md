---
document_id: '7515359911656898572'
directory_id: '7072190414392360966'
title: 批量获取记录
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/batch_get
breadcrumb:
- Server API
- Docs
- Base
...
updated_at: 2026-03-12T13:49:15Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/batch_get
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/batch_get</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	记录 ID 列表。调用[查询记录](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/search)获取。
...
了解更多，参考[如何为应用或用户开通云文档权限](/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#16c6475a)。</md-td>
</md-tr>
