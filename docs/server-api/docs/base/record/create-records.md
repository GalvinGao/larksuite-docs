---
document_id: '7073819570391154693'
directory_id: '7072190414392360966'
title: 新增多条记录
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/batch_create
breadcrumb:
- Server API
- Docs
- Base
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/batch_create
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/batch_create</md-td>
    </md-tr>
    <md-tr>
