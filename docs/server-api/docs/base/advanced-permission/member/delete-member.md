---
document_id: '7130175416736432134'
directory_id: '7120048623526117381'
title: 删除协作者
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role-member/delete
breadcrumb:
- Server API
- Docs
- Base
...
updated_at: 2025-07-28T02:01:59Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role-member/delete
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/roles/:role_id/members/:member_id</md-td>
    </md-tr>
    <md-tr>
