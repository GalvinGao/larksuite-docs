---
document_id: '7130175416736481286'
directory_id: '7120048623526117381'
title: 批量新增协作者
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role-member/batch_create
breadcrumb:
- Server API
- Docs
- Base
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role-member/batch_create
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/roles/:role_id/members/batch_create</md-td>
    </md-tr>
    <md-tr>
