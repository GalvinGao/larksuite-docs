---
document_id: '7130175416736497670'
directory_id: '7120048623526117381'
title: 列出协作者
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role-member/list
breadcrumb:
- Server API
- Docs
- Base
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role-member/list
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/roles/:role_id/members</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>role_id 不存在。role_id 是多维表格高级权限中自定义角色的唯一标识，以 `rol` 开头。可通过[列出自定义角色](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role/list)接口获取。</md-td>
</md-tr>
...
- member_id 填写是否正确。不同类型的 ID 获取方式不同：
  ...
  - open_id：参考[如何获取不同的用户 ID](/document/home/user-identity-introduction/open-id)

  - union_id：参考[如何获取不同的用户 ID](/document/home/user-identity-introduction/open-id)

  - user_id：参考[如何获取不同的用户 ID](/document/home/user-identity-introduction/open-id)

  - chat_id：参考[群 ID 说明](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-id-description)

  - department_id：调用前，请确保应用有部门的可见性，参考[配置应用可用范围](/document/home/introduction-to-scope-and-authorization/availability)。获取 department_id 方式参考[部门资源介绍](/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/field-overview)
  
   - open_department_id：调用前，请确保应用有部门的可见性，参考[配置应用可用范围](/document/home/introduction-to-scope-and-authorization/availability)。获取 open_department_id 方式参考[部门资源介绍](/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/field-overview)</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1254200</md-td>
  <md-td>Something went wrong. Please contact technical support at https://applink.larksuite.com/client/helpdesk/open?id=6626260912531570952</md-td>
