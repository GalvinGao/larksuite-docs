---
document_id: '7130175416736382982'
directory_id: '7120048623526133765'
title: 新增自定义角色
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role/create
breadcrumb:
- Server API
- Docs
- Base
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role/create
---

# 新增自定义角色

新增自定义角色{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.role&method=create)
...
| 403 | 1254304 | Only Available For Business and Enterprise Editions | 仅企业版和旗舰版Lark支持行列权限 |
