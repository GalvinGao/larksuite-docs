---
document_id: '7073819570391056389'
directory_id: '7072190414392377350'
title: 列出视图
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-view/list
breadcrumb:
- Server API
- Docs
- Base
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-view/list
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/tables/:table_id/views</md-td>
    </md-tr>
    <md-tr>
