---
document_id: '7239978910498242566'
directory_id: '7072190414392377350'
title: 更新视图
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-view/patch
breadcrumb:
- Server API
- Docs
- Base
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-view/patch
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/tables/:table_id/views/:view_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	用于筛选的字段的 ID。可通过[列出字段](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-field/list)接口获取
