---
document_id: '7073819570391203845'
directory_id: '7072190414392377350'
title: 删除视图
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-view/delete
breadcrumb:
- Server API
- Docs
- Base
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-view/delete
---

# 删除视图

删除多维表格数据表中的指定视图。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table.view&method=delete)
