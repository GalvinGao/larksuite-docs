---
document_id: '7120120933545050118'
directory_id: '7072190414392295430'
title: 更新多维表格元数据
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app/update
breadcrumb:
- Server API
- Docs
- Base
...
updated_at: 2026-03-12T13:48:53Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app/update
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="base:app:update" desc="更新多维表格" support_app_types="custom,isv" tags="">更新多维表格</md-perm><br><md-perm name="bitable:app" desc="查看、评论、编辑和管理多维表格" support_app_types="custom,isv" tags="">查看、评论、编辑和管理多维表格</md-perm> |
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	目标多维表格的 App token。该接口仅支持存储在云空间文件夹中的多维表格，即 URL 以 **larksuite.com/base** 开头的多维表格形态。该类多维表格的 `app_token` 是 base 之后的字符串
