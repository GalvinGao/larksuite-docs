---
document_id: '7073819570391285765'
directory_id: '7072190414392295430'
title: 获取多维表格元数据
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app/get
breadcrumb:
- Server API
- Docs
- Base
...
updated_at: 2026-03-12T13:48:52Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app/get
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	多维表格的公式字段类型。可结合[字段相关 API](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-field/create)使用。
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	文档高级权限版本。可结合[自定义角色 API](/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role/create)使用。
