---
document_id: '7073819570391105541'
directory_id: '7072190414392393734'
title: 删除一个数据表
full_path: /uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table/delete
breadcrumb:
- Server API
- Docs
- Base
...
updated_at: 2026-03-12T13:48:59Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table/delete
---

# 删除一个数据表

删除一个数据表，如果多维表格中只剩最后一张数据表，则不允许被删除。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table&method=delete)
