---
document_id: '7256621408749682694'
directory_id: '7253088311760617478'
title: 添加任务成员
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/task/add_members
breadcrumb:
- Server API
- Tasks
- Task
...
updated_at: 2023-11-09T09:19:30Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/add_members
---
...
* 关于member的格式，详见[功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“ 如何表示任务和清单的成员？”章节。
...
:::html
<md-alert type="tip">
添加任务成员需要任务的可编辑权限。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/task/v2/tasks/:task_guid/add_members</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	要添加的members列表，单请求支持最大50个成员（去重后)。关于member的格式，详见[功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“ 如何表示任务和清单的成员？”章节。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	幂等token，如果提供则实现幂等行为。详见[功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“ 幂等调用 ”章节。
...
<md-tr>
  ...
  <md-td>检查调用身份是否有任务的可编辑权限。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。</md-td>
</md-tr>
