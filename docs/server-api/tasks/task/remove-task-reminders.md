---
document_id: '7256621408749797382'
directory_id: '7253088311760617478'
title: 移除任务提醒
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_reminders
breadcrumb:
- Server API
- Tasks
- Task
...
updated_at: 2023-11-09T09:19:58Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_reminders
---
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/task/v2/tasks/:task_guid/remove_reminders |
| HTTP Method | POST |
...
| 403 | 1470403 | 缺少任务编辑权限。 | 检查调用身份是否有任务的编辑权限。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。 |
