---
document_id: '7645249759822024119'
directory_id: '7253088311760617478'
title: 列取与我相关的任务
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/task_v2/list_related_task
breadcrumb:
- Server API
- Tasks
- Task
- List My Related Tasks
document_type: ReferenceDocumentType
updated_at: 2026-05-29T09:57:41Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task_v2/list_related_task
---

# 列取与我相关的任务

获取任务中心 我负责的、我关注的、我创建的、我分配的任务列表，按任务的更新时间升序排序{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=task_v2&method=list_related_task)
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/task/v2/task_v2/list_related_task |
| HTTP Method | GET |
| 接口频率限制 | [50 次/秒](/document/ukTMukTMukTM/uUzN04SN3QjL1cDN) |
| 支持的应用类型 | <md-app-support types="custom,isv"></md-app-support> |
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="task:task:read" desc="查看任务信息" support_app_types="custom,isv" tags="">查看任务信息</md-perm><br><md-perm name="task:task:write" desc="查看、创建、更新、删除任务" support_app_types="custom,isv" tags="">查看、创建、更新、删除任务</md-perm> |
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >agent_task_status</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >agent_task_progress</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >text_deliveries</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >attachment_deliveries</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >attachment\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >next_task_guid</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
| 500 | 1470500 | Internal server error. | 请重试调用。如持续失败，请联系[支持人员](https://applink.larksuite.com/TLJpeNdW)进行反馈。 |
