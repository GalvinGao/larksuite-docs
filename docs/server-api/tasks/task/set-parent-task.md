---
document_id: '7645249759822007735'
directory_id: '7253088311760617478'
title: 设置父任务
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/task/set_ancestor_task
breadcrumb:
- Server API
- Tasks
- Task
...
updated_at: 2026-06-01T09:26:24Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/set_ancestor_task
---

# 设置父任务

管理任务的父子关系，支持设置任务的父任务，或者将任务转为独立任务。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=task&method=set_ancestor_task)
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >ancestor_guid</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
