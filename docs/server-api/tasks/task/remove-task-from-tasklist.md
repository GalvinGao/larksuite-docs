---
document_id: '7256621408749584390'
directory_id: '7253088311760617478'
title: 任务移出清单
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_tasklist
breadcrumb:
- Server API
- Tasks
- Task
...
updated_at: 2023-11-09T09:19:50Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_tasklist
---
...
:::html
<md-alert type="tip">
需要清单的可编辑权限。详情见[清单功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/task/v2/tasks/:task_guid/remove_tasklist</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>检查调用身份是否有清单的可编辑权限。详情见[清单功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。</md-td>
</md-tr>
