---
document_id: '7256621408749961222'
directory_id: '7253088311760617478'
title: 获取任务详情
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/task/get
breadcrumb:
- Server API
- Tasks
- Task
...
updated_at: 2023-11-09T09:19:19Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/get
---
...
:::html
<md-alert type="tip">
获取任务详情需要调用身份拥有对任务的可读取权限。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。
</md-alert>
:::
...
| 403 | 1470403 | 缺少对任务的访问权限。 | 检查调用身份是否有权限访问任务数据。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。 |
