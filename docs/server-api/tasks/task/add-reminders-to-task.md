...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/task/v2/tasks/:task_guid/add_reminders</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>需要先调用[移除任务提醒](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_reminders)接口移除原有提醒。再调用本接口添加提醒。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>检查调用身份是否拥有任务编辑权限。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。</md-td>
</md-tr>
