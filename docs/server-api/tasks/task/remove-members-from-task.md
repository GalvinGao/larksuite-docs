---
document_id: '7256621408749993990'
directory_id: '7253088311760617478'
title: 移除任务成员
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_members
breadcrumb:
- Server API
- Tasks
- Task
...
updated_at: 2023-11-09T09:19:34Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_members
---
...
:::html
<md-alert type="tip">
移除任务成员需要任务的编辑权限。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/task/v2/tasks/:task_guid/remove_members</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>确认调用身份拥有任务的编辑权限。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。</md-td>
</md-tr>
