---
document_id: '7256621408749780998'
directory_id: '7253088311760617478'
title: 任务加入清单
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/task/add_tasklist
breadcrumb:
- Server API
- Tasks
- Task
...
updated_at: 2023-11-09T09:19:46Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/add_tasklist
---
...
:::html
<md-alert type="tip">
需要调用身份同时拥有任务的编辑权限和清单的编辑权限。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节和[清单功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。
</md-alert>
:::
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/task/v2/tasks/:task_guid/add_tasklist |
| HTTP Method | POST |
...
| 403 | 1470403 | 缺少将任务加入清单的权限。 | 检查调用身份是否同时拥有任务和清单的编辑权限。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节和[清单功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。 |
