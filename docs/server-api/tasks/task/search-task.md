---
document_id: '7643736991488445878'
directory_id: '7253088311760617478'
title: 搜索任务
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/task/search
breadcrumb:
- Server API
- Tasks
- Task
...
updated_at: 2026-06-01T09:26:19Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/search
---

# 搜索任务

通过任务关键词搜索任务的信息，包括任务名称、任务链接、任务ID、任务描述{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=task&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/task/v2/tasks/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >task_search_filter</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >assignee_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >is_completed</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >due_time</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >task_search_meta</md-text>
	</md-dt-td>
	<md-dt-td>
	任务元信息
	</md-dt-td>
