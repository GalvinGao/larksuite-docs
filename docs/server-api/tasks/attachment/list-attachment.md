---
document_id: '7298981006978498566'
directory_id: '7296056091455537158'
title: 列取附件
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/attachment/list
breadcrumb:
- Server API
- Tasks
- attachment
...
updated_at: 2023-11-09T09:21:45Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/attachment/list
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="task:attachment:read" desc="查看任务附件" support_app_types="custom,isv" tags="">查看任务附件</md-perm><br><md-perm name="task:attachment:write" desc="查看、创建、删除任务附件" support_app_types="custom,isv" tags="">查看、创建、删除任务附件</md-perm> |
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	附件归属资源的id，配合resource_type使用。例如希望获取任务的附件，需要设置 resource_type为task， resource_id为任务GUID。任务GUID的获取方式可以参考[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)。
