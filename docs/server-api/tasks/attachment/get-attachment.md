---
document_id: '7298981006978433030'
directory_id: '7296056091455537158'
title: 获取附件
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/attachment/get
breadcrumb:
- Server API
- Tasks
- attachment
...
updated_at: 2023-11-09T09:21:49Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/attachment/get
---
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	获取详情的附件GUID。可以通过创建[上传附件](/document/uAjLw4CM/ukTMukTMukTM/task-v2/attachment/upload)接口创建, 或者通过[列取附件](/document/uAjLw4CM/ukTMukTMukTM/task-v2/attachment/list)接口查询得到。
