---
document_id: '7298981006978482182'
directory_id: '7296056091455537158'
title: 上传附件
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/attachment/upload
breadcrumb:
- Server API
- Tasks
- attachment
...
updated_at: 2023-11-09T09:21:41Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/attachment/upload
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/task/v2/attachments/upload</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	附件要归属资源的id。例如，要给任务添加附件，这里要填入任务GUID。任务GUID可以通过[任务相关接口](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)获得。
