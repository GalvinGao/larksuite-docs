...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/task/v2/comments/:comment_id</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>更新评论需要评论归属任务的读取权限，并且只能更新自己发出的评论。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。</md-td>
</md-tr>
