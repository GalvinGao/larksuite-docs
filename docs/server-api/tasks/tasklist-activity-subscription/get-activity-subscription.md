---
document_id: '7289367845715509254'
directory_id: '7288622728222900229'
title: 获取动态订阅
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/tasklist-activity_subscription/get
breadcrumb:
- Server API
- Tasks
...
updated_at: 2023-11-09T09:20:58Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist-activity_subscription/get
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="task:tasklist:read" desc="查看任务清单" support_app_types="custom,isv" tags="">查看任务清单</md-perm><br><md-perm name="task:tasklist:write" desc="查看、创建、更新、删除任务清单" support_app_types="custom,isv" tags="">查看、创建、更新、删除任务清单</md-perm> |
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	清单GUID。可以通过[创建清单](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/create)，或者通过[获取清单列表](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/list)接口查询得到。
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	订阅GUID。可以通过[创建动态订阅](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist-activity_subscription/create)接口创建，或者通过[列取动态订阅](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist-activity_subscription/list)查询得到。
