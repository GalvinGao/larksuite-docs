---
document_id: '7289367845715492870'
directory_id: '7288622728222900229'
title: 更新动态订阅
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/tasklist-activity_subscription/patch
breadcrumb:
- Server API
- Tasks
...
updated_at: 2023-11-09T09:21:06Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist-activity_subscription/patch
---
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	要更新的动态订阅GUID。可以通过[创建动态订阅](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist-activity_subscription/create)接口创建，或者通过[列取动态订阅](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist-activity_subscription/list)查询得到。
