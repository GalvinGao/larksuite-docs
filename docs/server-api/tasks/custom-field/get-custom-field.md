---
document_id: '7277487675920908294'
directory_id: '7277448822627106822'
title: 获取自定义字段
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/custom_field/get
breadcrumb:
- Server API
- Tasks
- Custom Field
...
updated_at: 2023-11-09T09:22:33Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/custom_field/get
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="task:custom_field:read" desc="查看自定义字段信息" support_app_types="custom,isv" tags="">查看自定义字段信息</md-perm><br><md-perm name="task:custom_field:write" desc="查看、创建、更新自定义字段" support_app_types="custom,isv" tags="">查看、创建、更新自定义字段</md-perm> |
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	自定义字段GUID。可以通过[创建自定义字段](/document/uAjLw4CM/ukTMukTMukTM/task-v2/custom_field/create)接口创建, 或者通过[列取自定义字段](/document/uAjLw4CM/ukTMukTMukTM/task-v2/custom_field/list)接口查询得到。
