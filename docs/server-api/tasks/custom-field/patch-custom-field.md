---
document_id: '7277487675920990214'
directory_id: '7277448822627106822'
title: 更新自定义字段
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/custom_field/patch
breadcrumb:
- Server API
- Tasks
- Custom Field
...
updated_at: 2023-11-09T09:22:37Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/custom_field/patch
---
...
如希望只更新单个选项，或者希望单独设置某个选项的is_hidden，本接口无法支持，但可以使用[更新自定义字段选项](/document/uAjLw4CM/ukTMukTMukTM/task-v2/custom_field-option/patch)接口实现。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=custom_field&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/task/v2/custom_fields/:custom_field_guid</md-td>
    </md-tr>
    <md-tr>
