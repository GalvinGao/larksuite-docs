---
document_id: '7264784369456873477'
directory_id: '7263291232825589766'
title: 更新自定义分组
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/section/patch
breadcrumb:
- Server API
- Tasks
- Section
...
updated_at: 2023-11-09T09:22:09Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/section/patch
---
...
更新时，将`update_fields`字段中填写所有要修改的字段名，同时在`section`字段中填写要修改的字段的新值即可。调用约定详情见[功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“ 关于资源的更新”章节。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/task/v2/sections/:section_guid</md-td>
    </md-tr>
    <md-tr>
