---
document_id: '7264784369456906245'
directory_id: '7263291232825589766'
title: 获取自定义分组任务列表
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/section/tasks
breadcrumb:
- Server API
- Tasks
- Section
...
updated_at: 2023-11-09T09:22:21Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/section/tasks
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="task:section:read" desc="查看自定义分组" support_app_types="custom,isv" tags="">查看自定义分组</md-perm><br><md-perm name="task:section:write" desc="查看、创建、更新、删除自定义分组" support_app_types="custom,isv" tags="">查看、创建、更新、删除自定义分组</md-perm> |
