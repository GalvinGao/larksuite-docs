---
document_id: '7256621408750010374'
directory_id: '7253088311760666630'
title: 获取清单详情
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/get
breadcrumb:
- Server API
- Tasks
- Tasklist
...
updated_at: 2023-11-09T09:20:26Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/get
---
...
:::html
<md-alert type="tip">
需要清单的读取权限。详情见[清单功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。
</md-alert>
:::
...
| 403 | 1470403 | 缺少清单读取权限。 | 检查调用身份是否有清单的读取权限。详情见[清单功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。 |
