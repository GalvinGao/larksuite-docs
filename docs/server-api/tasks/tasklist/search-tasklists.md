---
document_id: '7643736991488462262'
directory_id: '7253088311760666630'
title: 搜索清单
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/search
breadcrumb:
- Server API
- Tasks
- Tasklist
...
updated_at: 2026-06-01T09:26:29Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/search
---

# 搜索清单

通过清单关键词搜索清单的信息，包括清单名称、清单ID、清单链接、清单描述{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=tasklist&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/task/v2/tasklists/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >tasklist_search_filter</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	清单的创建时间，start_time应该小于end_time
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >tasklist_search_item\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	items
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >tasklist_search_meta</md-text>
	</md-dt-td>
	<md-dt-td>
	任务清单元信息
	</md-dt-td>
        ...
        "items": [
            {
                ...
                "meta_data": {
                    "app_link": "https://applink.larksuite.com/client/todo/detail?guid=ed03112a-0a25-451e-8453-ba1d80cc1b7e",
