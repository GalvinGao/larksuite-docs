---
document_id: '7256621408749813766'
directory_id: '7253088311760666630'
title: 更新清单
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/patch
breadcrumb:
- Server API
- Tasks
- Tasklist
...
updated_at: 2023-11-09T09:20:30Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/patch
---
...
更新清单时，将`update_fields`字段中填写所有要修改的清单字段名，同时在`tasklist`字段中填写要修改的字段的新值即可。更新调用规范详见[功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“ 关于资源的更新”章节。
...
* 如要增删清单中的任务，可以使用[任务加入清单](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/add_tasklist)和[任务移出清单]( /document/uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_tasklist)接口。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=tasklist&method=patch)
...
详情见[清单功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。
</md-alert>
:::
...
| 403 | 1470403 | 缺少清单编辑权限。如果是更新了清单所有者，则缺少清单所有者权限。详情见[清单功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。 | 检查调用身份是否有清单的权限执行更新。 |
