---
document_id: '7256621408749830150'
directory_id: '7253088311760666630'
title: 获取清单任务列表
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/tasks
breadcrumb:
- Server API
- Tasks
- Tasklist
...
updated_at: 2023-11-09T09:20:46Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/tasks
---
...
本接口支持简单的按照任务的完成状态或者任务的创建时间范围过滤。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=tasklist&method=tasks)

:::html
<md-alert type="tip">
需要清单读取权限。详情见[清单功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。
</md-alert>
:::
...
| 403 | 1470403 | 缺少清单的读取权限。 | 检查调用身份是否有清单的读取权限。详见[清单是如何鉴权的？](/document/uAjLw4CM/ukTMukTMukTM/task-v2/faq) |
