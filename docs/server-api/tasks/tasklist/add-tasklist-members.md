---
document_id: '7256621408749928454'
directory_id: '7253088311760666630'
title: 添加清单成员
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/add_members
breadcrumb:
- Server API
- Tasks
- Tasklist
...
updated_at: 2023-11-09T09:20:38Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/add_members
---

# 添加清单成员

向一个清单添加1个或多个协作成员。成员信息通过设置`members`字段实现。关于member的格式，详见[功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“ 如何表示任务和清单的成员？”章节。
...
本接口不能用来设置清单所有者，如要设置，可以使用[更新清单](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/patch)接口。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=tasklist&method=add_members)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	要添加的成员列表。关于member的格式，详见[功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“ 如何表示任务和清单的成员？”章节。
...
| 403 | 1470403 | 缺少清单的编辑权限。 | 检查调用身份是否有清单的编辑权限。详情见[清单功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。 |
