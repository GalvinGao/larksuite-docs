---
document_id: '7256621408749912070'
directory_id: '7253088311760650246'
title: 创建子任务
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/task-subtask/create
breadcrumb:
- Server API
- Tasks
- Subtask
...
updated_at: 2023-11-09T09:20:10Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task-subtask/create
---
...
接口功能除了额外需要输入父任务的GUID之外，和[创建任务](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/create)接口功能完全一致。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=task.subtask&method=create)

:::html
<md-alert type="tip">
创建子任务需要拥有父任务的编辑权限。详见[任务是如何鉴权的？](/document/uAjLw4CM/ukTMukTMukTM/task-v2/faq)

如果将新任务加入清单，则需要清单的可编辑权限。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/task/v2/tasks/:task_guid/subtasks</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	任务关联的第三方平台来源信息。详见[如何使用Origin?](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	如果设置，则该任务为“重复任务”。该字段表示了重复任务的重复规则。详见[功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“如何使用重复任务？”章节。
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	任务自定义完成规则。详见[功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“如何使用自定义完成？”章节。
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  ...
  <md-td>检查调用身份是否有父任务的可编辑权限。详情见[任务功能概述](/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。</md-td>
</md-tr>
