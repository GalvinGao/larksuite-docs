---
document_id: '7256621408749535238'
directory_id: '7253088311760650246'
title: 获取任务的子任务列表
full_path: /uAjLw4CM/ukTMukTMukTM/task-v2/task-subtask/list
breadcrumb:
- Server API
- Tasks
- Subtask
...
updated_at: 2023-11-09T09:20:14Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task-subtask/list
---
...
:::html
<md-alert type="tip">
需要父任务的读取权限。详见[任务是如何鉴权的？](/document/uAjLw4CM/ukTMukTMukTM/task-v2/faq)
</md-alert>
:::
...
| 403 | 1470403 | 缺少父任务的读取权限。 | 检查调用身份是否有父任务的读取权限。详见：[任务是如何鉴权的？](/document/uAjLw4CM/ukTMukTMukTM/task-v2/faq) |
