---
document_id: '7496871390063493132'
directory_id: '7494547571672678406'
title: 更新收信规则
full_path: /uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-rule/update
breadcrumb:
- Server API
- Email
- Auto Filter
...
updated_at: 2025-04-28T11:38:52Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-rule/update
---
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/mail/v1/user_mailboxes/:user_mailbox_id/rules/:rule_id |
| HTTP Method | PUT |
| 接口频率限制 | [5 次/秒](/document/ukTMukTMukTM/uUzN04SN3QjL1cDN) |
| 支持的应用类型 | <md-app-support types="custom"></md-app-support> |
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="mail:user_mailbox.rule:write" desc="查看、创建、更新、删除收信规则" support_app_types="custom" tags="">查看、创建、更新、删除收信规则</md-perm> |
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	规则 id，获取方式见 [列出收信规则](/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-rule/list)
