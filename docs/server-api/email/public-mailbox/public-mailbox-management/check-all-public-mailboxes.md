---
document_id: '6995381161988145157'
directory_id: '6992456212534034438'
title: 查询所有公共邮箱
full_path: /uAjLw4CM/ukTMukTMukTM/reference/mail-v1/public_mailbox/list
breadcrumb:
- Server API
- Email
- Public Mailbox
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/public_mailbox/list
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="mail:public_mailbox" desc="查询、创建、修改公共邮箱" support_app_types="custom" tags="">查询、创建、修改公共邮箱</md-perm><br><md-perm name="mail:public_mailbox:readonly" desc="查询公共邮箱" support_app_types="custom" tags="">查询公共邮箱</md-perm> |
| 字段权限要求 | <md-alert type="tip" icon="none"><br>该接口返回体中存在下列敏感字段，仅当开启对应的权限后才会返回；如果无需获取这些字段，则不建议申请<br></md-alert><br><md-perm name="contact:user.employee_id:readonly" desc="获取用户 user ID" support_app_types="custom" tags="">获取用户 user ID</md-perm><br><md-perm name="mail:public_mailbox.public_mailbox_geo" desc="查看公共邮箱数据驻留地" support_app_types="custom" tags="">查看公共邮箱数据驻留地</md-perm> |
