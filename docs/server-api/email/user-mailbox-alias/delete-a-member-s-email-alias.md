---
document_id: '7146126791814774790'
directory_id: '7145371477523611653'
title: 删除用户邮箱别名
full_path: /uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-alias/delete
breadcrumb:
- Server API
- Email
- User Mailbox
...
updated_at: 2025-04-28T11:37:55Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-alias/delete
---
...
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip> | <md-perm name="mail:user_mailbox" desc="查询、创建、修改和删除用户的企业邮箱" support_app_types="custom" tags="">查询、创建、修改和删除用户的企业邮箱</md-perm> |
