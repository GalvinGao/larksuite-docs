...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/mail/v1/user_mailboxes/:user_mailbox_id/drafts/:draft_id |
| HTTP Method | GET |
...
| 500 | 1236019 | internal server error | 服务端异常（1236019 internal server error）。请稍后重试；若问题持续存在，请携带 request id 通过官方技术支持 https://applink.larksuite.com/TLJpeNdW 联系接口负责人。 |
