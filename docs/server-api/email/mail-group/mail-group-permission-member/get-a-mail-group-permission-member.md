---
document_id: '6995381161988030469'
directory_id: '6992456212534001670'
title: 获取邮件组权限成员
full_path: /uAjLw4CM/ukTMukTMukTM/reference/mail-v1/mailgroup-permission_member/get
breadcrumb:
- Server API
- Email
- Mail Group
- Mail Group Permission Member
- Get A Mail Group Permission Member
document_type: ReferenceDocumentType
updated_at: 2025-04-28T11:39:01Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/mailgroup-permission_member/get
---
...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/mail/v1/mailgroups/:mailgroup_id/permission_members/:permission_member_id |
| HTTP Method | GET |
| 接口频率限制 | [特殊频控](/document/ukTMukTMukTM/uUzN04SN3QjL1cDN) |
| 支持的应用类型 | <md-app-support types="custom"></md-app-support> |
| 权限要求<br><md-tooltip type="info">调用该 API 所需的权限。开启其中任意一项权限即可调用</md-tooltip><br><div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div> | <md-perm name="mail:mailgroup" desc="查询、创建、修改、删除邮件组" support_app_types="custom" tags="">查询、创建、修改、删除邮件组</md-perm><br><md-perm name="mail:mailgroup:readonly" desc="查询邮件组" support_app_types="custom" tags="">查询邮件组</md-perm> |
