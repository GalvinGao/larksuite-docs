---
document_id: '7651479274432204214'
directory_id: '7647748462545980853'
title: 多实体搜索
full_path: /uAjLw4CM/ukTMukTMukTM/reference/mail-v1/multi_entity/search
breadcrumb:
- Server API
- Email
- Multi-entity
...
updated_at: 2026-06-15T04:57:29Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/multi_entity/search
---

# 多实体搜索

多实体搜索，适用于写信联系人搜索{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=mail&version=v1&resource=multi_entity&method=search)
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >multi_entity_search_item\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	返回的实体详情
	</md-dt-td>
