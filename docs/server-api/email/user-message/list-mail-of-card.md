---
document_id: '7459358680350654470'
directory_id: '7307234311433109510'
title: 获取邮件卡片的邮件列表
full_path: /uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-message/get_by_card
breadcrumb:
- Server API
- Email
- User Message
...
updated_at: 2025-04-28T11:38:15Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-message/get_by_card
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/mail/v1/user_mailboxes/:user_mailbox_id/messages/get_by_card</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	邮件卡片ID，可通过[接收消息](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/events/receive)事件的推送获取
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	邮件卡片OwnerID，可通过[接收消息]( /document/server-docs/im-v1/message/events/receive)事件的推送获取（与`user_id_type`无关）
