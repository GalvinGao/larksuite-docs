...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/mail/v1/user_mailboxes/:user_mailbox_id/profile</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1230002</md-td>
  <md-td>user does not have email</md-td>
  <md-td>该用户没有企业邮箱地址。请更换已绑定企业邮箱的用户调用，或传入已绑定企业邮箱的用户 ID 后重新请求。</md-td>
</md-tr>
