...
| 基本 |  |
| --- | --- |
| HTTP URL | https://open.larksuite.com/open-apis/mail/v1/user_mailboxes/:user_mailbox_id/search |
| HTTP Method | POST |
...
| 400 | 1231040 | search service error, see logs for details. | 搜索服务异常，请携带 request_id/log_id 联系Lark技术支持协助排查：https://applink.larksuite.com/TLJpeNdW |
