---
document_id: '7520565167073476614'
directory_id: '7520163178001596422'
title: 创建卡片实体
full_path: /uAjLw4CM/ukTMukTMukTM/cardkit-v1/card/create
breadcrumb:
- Server API
- Lark Card
- Card
...
updated_at: 2025-06-27T09:55:51Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/cardkit-v1/card/create
---

# 创建卡片实体

基于卡片 JSON 代码，创建卡片实体。用于后续通过卡片实体 ID（card_id）发送卡片、更新卡片等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=cardkit&version=v1&resource=card&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/cardkit/v1/cards</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	创建的卡片实体 ID。后续可通过[发送消息](/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/create)接口传入卡片实体 ID 发送卡片。
	</md-dt-td>
</md-dt-tr>
...
<md-table>
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>该接口仅支持 JSON 2.0 结构。详情参考[卡片 JSON 2.0 结构](/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-structure)。</md-td>
    </md-tr>
    <md-tr>
      <md-td>400</md-td>
      <md-td>200220</md-td>
