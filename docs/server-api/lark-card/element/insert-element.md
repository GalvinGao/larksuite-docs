---
document_id: '7520565507029041164'
directory_id: '7520163178001629190'
title: 新增组件
full_path: /uAjLw4CM/ukTMukTMukTM/cardkit-v1/card-element/create
breadcrumb:
- Server API
- Lark Card
- Element
...
updated_at: 2025-06-27T09:56:07Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/cardkit-v1/card-element/create
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/cardkit/v1/cards/:card_id/elements</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	要新增组件的卡片实体 ID。通过[创建卡片实体](/document/uAjLw4CM/ukTMukTMukTM/cardkit-v1/card/create)获取
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	添加的组件列表。以下示例值未转义，使用时请注意将其转为 JSON 序列化后的字符串。

**示例值**："[{\"tag\":\"button\",\"element_id\":\"button_1\",\"text\":{\"tag\":\"plain_text\",\"content\":\"查看更多\"},\"type\":\"default\",\"width\":\"default\",\"size\":\"medium\",\"behaviors\":[{\"type\":\"open_url\",\"default_url\":\"https://open.larksuite.com/?lang=zh-CN\",\"pc_url\":\"\",\"ios_url\":\"\",\"android_url\":\"\"}]}]"
...
<md-code-json>
{
    ...
    "sequence": 1,
    "elements": "[{\"tag\":\"button\",\"element_id\":\"button_1\",\"text\":{\"tag\":\"plain_text\",\"content\":\"查看更多\"},\"type\":\"default\",\"width\":\"default\",\"size\":\"medium\",\"behaviors\":[{\"type\":\"open_url\",\"default_url\":\"https://open.larksuite.com/?lang=zh-CN\",\"pc_url\":\"\",\"ios_url\":\"\",\"android_url\":\"\"}]}]"
}
</md-code-json>
:::
...
<md-table>
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>卡片流式更新模式因超时自动关闭。你可调用[更新卡片配置](/document/uAjLw4CM/ukTMukTMukTM/cardkit-v1/card/settings) 将 `streaming_mode` 字段值设置为 `true`。              </md-td>
    </md-tr>
    ...
    <md-tr>
      ...
      <md-td>服务内部错误。请稍后重试。仍然出现可联系[技术支持](https://applink.larksuite.com/TLJpeNdW)。</md-td>
    </md-tr>
