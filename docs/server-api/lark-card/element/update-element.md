---
document_id: '7520565507028828172'
directory_id: '7520163178001629190'
title: 更新组件
full_path: /uAjLw4CM/ukTMukTMukTM/cardkit-v1/card-element/update
breadcrumb:
- Server API
- Lark Card
- Element
...
updated_at: 2025-06-27T09:56:11Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/cardkit-v1/card-element/update
---
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	新的组件的完整的 JSON 数据。以下示例值未转义，使用时请注意将其转为 JSON 序列化后的字符串。
