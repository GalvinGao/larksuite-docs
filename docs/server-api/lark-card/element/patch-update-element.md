---
document_id: '7520565167073492998'
directory_id: '7520163178001629190'
title: 更新组件属性
full_path: /uAjLw4CM/ukTMukTMukTM/cardkit-v1/card-element/patch
breadcrumb:
- Server API
- Lark Card
- Element
...
updated_at: 2025-06-27T09:56:15Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/cardkit-v1/card-element/patch
---
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	组件的新的配置项字段。传入 `element_id` 参数后，原组件的 ID 将更新。不支持修改 `tag` 参数。 
