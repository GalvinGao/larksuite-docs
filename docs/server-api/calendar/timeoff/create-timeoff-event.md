---
document_id: '6966503468250480645'
directory_id: '6965452230078889990'
title: 创建请假日程
full_path: /uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/timeoff_event/create
breadcrumb:
- Server API
- Calendar
- Timeoff
...
updated_at: 2025-01-14T06:48:36Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/timeoff_event/create
---
...
:::html
<md-alert type="tip">
使用应用身份调用该接口，需要确保应用开启了[机器人能力](/document/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/trouble-shooting/how-to-enable-bot-ability)。
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/calendar/v4/timeoff_events</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	用户 ID。ID 类型需要与 user_id_type 的值保持一致。关于用户 ID 可参见[用户相关的 ID 概念](/document/home/user-identity-introduction/introduction)。
...
**示例值**："若删除此日程，Lark中相应的“请假”标签将自动消失，而请假系统中的休假申请不会被撤销。"
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	用户 ID。关于用户 ID 可参见[用户相关的 ID 概念](/document/home/user-identity-introduction/introduction)。
	</md-dt-td>
</md-dt-tr>
