---
document_id: '6967251478324199430'
directory_id: '7456715520965967884'
title: 查询会议室日程主题和会议详情
full_path: /ukTMukTMukTM/uIjM5UjLyITO14iMykTN/
breadcrumb:
- Server API
- Calendar
- Meeting room event
...
updated_at: 2025-01-14T06:15:02Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uIjM5UjLyITO14iMykTN/
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/meeting_room/summary/batch_get</md-td>
    </md-tr>
    <md-tr>
...
| ∟∟summary   | string|日程主题。  |
| ∟∟vchat	  |	vhcat|视频会议信息。		|
| ∟∟∟vc_type| string | 视频会议类型。 <br> **可选值有：**<br> - `vc`：Lark视频会议。取该类型时，vchat 内的其他字段均无效。<br> - `third_party`：第三方链接视频会议。取该类型时，仅生效 vchat 内的 icon_type、description、meeting_url 字段。<br> - `no_meeting`：无视频会议。取该类型时，vchat 内的其他字段均无效。<br>- `lark_live`：Lark直播。该值用于客户端，只读参数。<br>- `unknown`：未知类型。该值用于客户端做兼容使用，只读参数。|
| ∟∟∟icon_type| string | 第三方视频会议 icon 类型。<br> **可选值有：** <br>- `vc`：Lark视频会议 icon<br>- `live`：直播视频会议 icon <br>-  `default`：默认 icon|
