---
document_id: '7073451579924299782'
directory_id: '7456715520965967884'
title: 回复会议室日程实例
full_path: /ukTMukTMukTM/uYzN4UjL2cDO14iN3gTN
breadcrumb:
- Server API
- Calendar
- Meeting room event
- Reply meeting room event instance
document_type: GuideDocumentType
updated_at: 2025-01-14T06:15:11Z
source_url: https://open.larksuite.com/document/ukTMukTMukTM/uYzN4UjL2cDO14iN3gTN
---
...
:::note
**说明**：你可以先调用[查询会议室忙闲](/document/ukTMukTMukTM/uIDOyUjLygjM14iM4ITN)接口，获取指定会议室的某一日程的 uid、original_time 信息，然后再调用本接口回复会议室日程。<BR>
