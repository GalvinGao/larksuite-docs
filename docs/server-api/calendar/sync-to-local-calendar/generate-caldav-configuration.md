---
document_id: '6966503468458655749'
directory_id: '6965452230078955526'
title: 生成 CalDAV 配置
full_path: /uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/setting/generate_caldav_conf
breadcrumb:
- Server API
- Calendar
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/setting/generate_caldav_conf
---

# 生成 CalDAV 配置

调用该接口为当前用户生成一个 CalDAV 账号密码，用于将Lark日历信息同步到本地设备日历。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=setting&method=generate_caldav_conf)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/calendar/v4/settings/generate_caldav_conf</md-td>
    </md-tr>
    <md-tr>
