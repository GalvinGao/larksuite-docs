---
document_id: '6966503468458573829'
directory_id: '6965452230078988294'
title: 删除访问控制
full_path: /uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-acl/delete
breadcrumb:
- Server API
- Calendar
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-acl/delete
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/calendar/v4/calendars/:calendar_id/acls/:acl_id</md-td>
    </md-tr>
    <md-tr>
...
为日历创建访问控制时会返回访问控制 ID。你也可以调用[获取访问控制列表](/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-acl/list)接口，获取指定日历内的访问控制信息。
