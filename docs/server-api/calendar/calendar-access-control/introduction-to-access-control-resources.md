...
**获取方式**：[获取访问控制列表](/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-acl/list)
...
**可选值有**：
- `user`：用户，用户资源定义可参见 [用户 User 资源概述](/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/field-overview)。
...
<md-tr>
        ...
        <md-td>
用户 ID。当 `type=user` 时，必须设置该参数值。关于用户 ID 的更多介绍可参见[用户相关的 ID 概念](/document/home/user-identity-introduction/introduction)。<br>
