---
document_id: '7075602249348005894'
directory_id: '7044512459843092485'
title: Exchange 资源介绍
full_path: /uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/exchange_binding/introduction
breadcrumb:
- Server API
- Calendar
...
updated_at: 2025-01-14T06:48:46Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/exchange_binding/introduction
---

# Exchange 资源介绍

日历 API 提供了 Exchange 账户和Lark账户绑定、解绑以及状态查询的能力，你可以使用 API 将你的 Exchange 日历同步到Lark日历来使用。当 Exchange 账户绑定了Lark账户后，Lark账户会异步同步 Exchange 日历到Lark日历，同步期间你可以实时查询日历的同步状态。
