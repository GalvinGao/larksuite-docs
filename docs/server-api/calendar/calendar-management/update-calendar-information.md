---
document_id: '6966503468458704901'
directory_id: '6965452230078922758'
title: 更新日历信息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/patch
breadcrumb:
- Server API
- Calendar
- Calendar management
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/patch
---
...
- 如果当前身份不具有日历的 owner 访问权限，则只能更新对当前身份生效的 color、summary_alias。你可以调用[查询日历信息](/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/get)接口，查看当前身份对日历的访问权限。
- 会议室日历不支持设置备注。
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/calendar/v4/calendars/:calendar_id</md-td>
    </md-tr>
    <md-tr>
