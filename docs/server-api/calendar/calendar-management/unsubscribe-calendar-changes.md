---
document_id: '7156039415051010053'
directory_id: '6965452230078922758'
title: 取消订阅日历变更事件
full_path: /uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/unsubscription
breadcrumb:
- Server API
- Calendar
- Calendar management
- Unsubscribe Calendar Changes
document_type: ReferenceDocumentType
updated_at: 2025-01-14T02:35:06Z
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/unsubscription
---

# 取消订阅日历变更事件

调用该接口为当前用户身份取消订阅[日历变更事件](/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/events/changed)。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=calendar&method=unsubscription)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/calendar/v4/calendars/unsubscription</md-td>
    </md-tr>
    <md-tr>
