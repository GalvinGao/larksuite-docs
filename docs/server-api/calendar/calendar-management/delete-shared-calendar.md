---
document_id: '6966503468458672133'
directory_id: '6965452230078922758'
title: 删除共享日历
full_path: /uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/delete
breadcrumb:
- Server API
- Calendar
- Calendar management
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/delete
---
...
- 当前身份必须对日历有 owner 权限才可以删除。你可以调用[查询日历信息](/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/get)接口，通过响应字段 role 查看当前身份对日历的权限。
</md-alert>
:::
