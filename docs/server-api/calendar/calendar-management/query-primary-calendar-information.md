---
document_id: '7073444363199922181'
directory_id: '6965452230078922758'
title: 查询主日历信息
full_path: /uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/primary
breadcrumb:
- Server API
- Calendar
- Calendar management
...
source_url: https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/primary
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.larksuite.com/open-apis/calendar/v4/calendars/primary</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	日历 ID。你可以通过该 ID 查询、更新主日历信息。更多信息可参见[日历 ID 字段说明](/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/introduction)。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	日历创建者的 User ID。了解用户不同类型的 ID，可参见[用户身份概述](/document/home/user-identity-introduction/introduction)。
	</md-dt-td>
</md-dt-tr>
